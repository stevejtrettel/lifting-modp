...
import cement from "/js/assets/cement.jpeg"
...
let cementNormals = new TextureLoader().load(cement);
...
for(let i=0; i<data.length;i++){
    ...
    let sph = torus.getPoint(pt,0xffffff,0.03,false);
    ...
    // sph.material.color.setHSL(0.57+0.04*Math.random(),	0.7, 0.05+0.1*Math.random());
    points.add(sph);
}
