...
const tauSquare = new Vector3(0,1);
const tauHex = new Vector3(1/2,Math.sqrt(3)/2);


let fd = new FD(tauHex);
let grp = new Group();
scene.add(grp);

grp.add(fd.getParallelogram(colors.glass));
let grid = fd.getGridlines(15,colors.red,0.005,false);
