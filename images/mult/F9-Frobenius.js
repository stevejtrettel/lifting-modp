...
//SINGLETONS 1 and -1
let pos1 = new Mesh(sphGeom,pMat);
...
for(let i=0; i<100; i++){
    ...
    pts.push(new Vector3(1.35+0.2*Math.sin(t),0,0.2*Math.cos(t)));
}
let c = new CatmullRomCurve3(pts);
let tube = new TubeGeometry(c,128,0.02,8,true);
let curve = new Mesh(tube,pMat);
scene.add(curve);
...
let neg1 = new Mesh(sphGeom,pMat);
...
for(let i=0; i<100; i++){
    let t = 2.*Math.PI*i/100;
    pts0.push(new Vector3(-1.35+0.2*Math.sin(t),0,0.2*Math.cos(t)));
}
let c0 = new CatmullRomCurve3(pts0);
let tube0 = new TubeGeometry(c0,128,0.02,8,true);
let curve0 = new Mesh(tube0,pMat);
scene.add(curve0);
...
let o11 = new Mesh(sphGeom,pMat);
o11.position.set(0,0,1);
o1.add(o11);

let o12 = new Mesh(sphGeom,pMat);
...
let curve1 = new Mesh(tube1,pMat);
o1.add(curve1);
...
let o21 = new Mesh(sphGeom,pMat);
o21.position.set(1,0,1);
o2.add(o21);

let o22 = new Mesh(sphGeom,pMat);
...
for(let i=18; i<83; i++){
    let t = Math.PI*i/100;
    pts2.push(new Vector3(Math.cos(t),0,0.35*Math.sin(t)+1));
}
let c2 = new CatmullRomCurve3(pts2);
let tube2 = new TubeGeometry(c2,128,0.02);
let curve2 = new Mesh(tube2,pMat);
o2.add(curve2);
...
let o31 = new Mesh(sphGeom,pMat);
o31.position.set(-1,0,-1);
o3.add(o31);

let o32 = new Mesh(sphGeom,pMat);
...
for(let i=18; i<83; i++){
    let t = Math.PI*i/100;
    pts3.push(new Vector3(Math.cos(t),0,-0.35*Math.sin(t)-1));
}
let c3 = new CatmullRomCurve3(pts3);
let tube3 = new TubeGeometry(c3,128,0.02);
let curve3 = new Mesh(tube3,pMat);
o3.add(curve3);
