...
`].filter(Us).join(`
`)),a=Xo(a),a=Ec(a,e),a=wc(a,e),o=Xo(o),o=Ec(o,e),o=wc(o,e),a=Ac(a),o=Ac(o),e.isRawShaderMaterial!==!0&&(x=`#version 300 es
...
`;class $v extends Ml{constructor(){super({blending:Ke,uniforms:{resolution:{value:new ft}},vertexShader:`
			...
			`})}}function x1(i,t=Math.random()){for(let e=i.length-1;e>0;e--){const n=Math.floor(t()*(e+1)),s=i[e];i[e]=i[n],i[n]=s}return i}class y1{constructor(t,e,n=Math.random){const s=t**e,r=new Uint16Array(s);let a=s;for(let o=0;o<s;o++)r[o]=o;this.samples=new Float32Array(e),this.strataCount=t,this.reset=function(){for(let o=0;o<s;o++)r[o]=o;a=0},this.reshuffle=function(){a=0},this.next=function(){const{samples:o}=this;a>=r.length&&(x1(r,n),this.reshuffle());let l=r[a++];for(let u=0;u<e;u++)o[u]=(l%t+n())/t,l=Math.floor(l/t);return o}}}class M1{constructor(t,e,n=Math.random){let s=0;for(const l of e)s+=l;const r=new Float32Array(s),a=[];let o=0;for(const l of e){const u=new y1(t,l,n);u.samples=new Float32Array(r.buffer,o,u.samples.length),o+=u.samples.length*4,a.push(u)}this.samples=r,this.strataCount=t,this.next=function(){for(const l of a)l.next();return r},this.reshuffle=function(){for(const l of a)l.reshuffle()},this.reset=function(){for(const l of a)l.reset()}}}class b1{constructor(t=0){this.m=2147483648,this.a=1103515245,this.c=12345,this.seed=t}nextInt(){return this.seed=(this.a*this.seed+this.c)%this.m,this.seed}nextFloat(){return this.nextInt()/(this.m-1)}}class S1 extends ln{constructor(t=1,e=1,n=8){super(new Float32Array(1),1,1,Zt,ne),this.minFilter=Bt,this.magFilter=Bt,this.strata=n,this.sampler=null,this.generator=new b1,this.stableNoise=!1,this.random=()=>this.stableNoise?this.generator.nextFloat():Math.random(),this.init(t,e,n)}init(t=this.image.height,e=this.image.width,n=this.strata){const{image:s}=this;if(s.width===e&&s.height===t&&this.sampler!==null)return;const r=new Array(t*e).fill(4),a=new M1(n,r,this.random);s.width=e,s.height=t,s.data=a.samples,this.sampler=a,this.dispose(),this.next()}next(){this.sampler.next(),this.needsUpdate=!0}reset(){this.sampler.reset(),this.generator.seed=0}}function T1(i,t=Math.random){for(let e=i.length-1;e>0;e--){const n=~~((t()-1e-6)*e),s=i[e];i[e]=i[n],i[n]=s}}function E1(i,t){i.fill(0);for(let e=0;e<t;e++)i[e]=1}class au{constructor(t){this.count=0,this.size=-1,this.sigma=-1,this.radius=-1,this.lookupTable=null,this.score=null,this.binaryPattern=null,this.resize(t),this.setSigma(1.5)}findVoid(){const{score:t,binaryPattern:e}=this;let n=1/0,s=-1;for(let r=0,a=e.length;r<a;r++){if(e[r]!==0)continue;const o=t[r];o<n&&(n=o,s=r)}return s}findCluster(){const{score:t,binaryPattern:e}=this;let n=-1/0,s=-1;for(let r=0,a=e.length;r<a;r++){if(e[r]!==1)continue;const o=t[r];o>n&&(n=o,s=r)}return s}setSigma(t){if(t===this.sigma)return;const e=~~(Math.sqrt(10*2*t**2)+1),n=2*e+1,s=new Float32Array(n*n),r=t*t;for(let a=-e;a<=e;a++)for(let o=-e;o<=e;o++){const l=(e+o)*n+a+e,u=a*a+o*o;s[l]=Math.E**(-u/(2*r))}this.lookupTable=s,this.sigma=t,this.radius=e}resize(t){this.size!==t&&(this.size=t,this.score=new Float32Array(t*t),this.binaryPattern=new Uint8Array(t*t))}invert(){const{binaryPattern:t,score:e,size:n}=this;e.fill(0);for(let s=0,r=t.length;s<r;s++)if(t[s]===0){const a=~~(s/n),o=s-a*n;this.updateScore(o,a,1),t[s]=1}else t[s]=0}updateScore(t,e,n){const{size:s,score:r,lookupTable:a}=this,o=this.radius,l=2*o+1;for(let u=-o;u<=o;u++)for(let h=-o;h<=o;h++){const f=(o+h)*l+u+o,c=a[f];let m=t+u;m=m<0?s+m:m%s;let g=e+h;g=g<0?s+g:g%s;const _=g*s+m;r[_]+=n*c}}addPointIndex(t){this.binaryPattern[t]=1;const e=this.size,n=~~(t/e),s=t-n*e;this.updateScore(s,n,1),this.count++}removePointIndex(t){this.binaryPattern[t]=0;const e=this.size,n=~~(t/e),s=t-n*e;this.updateScore(s,n,-1),this.count--}copy(t){this.resize(t.size),this.score.set(t.score),this.binaryPattern.set(t.binaryPattern),this.setSigma(t.sigma),this.count=t.count}}class w1{constructor(){this.random=Math.random,this.sigma=1.5,this.size=64,this.majorityPointsRatio=.1,this.samples=new au(1),this.savedSamples=new au(1)}generate(){const{samples:t,savedSamples:e,sigma:n,majorityPointsRatio:s,size:r}=this;t.resize(r),t.setSigma(n);const a=Math.floor(r*r*s),o=t.binaryPattern;E1(o,a),T1(o,this.random);for(let f=0,c=o.length;f<c;f++)o[f]===1&&t.addPointIndex(f);for(;;){const f=t.findCluster();t.removePointIndex(f);const c=t.findVoid();if(f===c){t.addPointIndex(f);break}t.addPointIndex(c)}const l=new Uint32Array(r*r);e.copy(t);let u;for(u=t.count-1;u>=0;){const f=t.findCluster();t.removePointIndex(f),l[f]=u,u--}const h=r*r;for(u=e.count;u<h/2;){const f=e.findVoid();e.addPointIndex(f),l[f]=u,u++}for(e.invert();u<h;){const f=e.findCluster();e.removePointIndex(f),l[f]=u,u++}return{data:l,maxValue:h}}}function A1(i){return i>=3?4:i}function R1(i){switch(i){case 1:return ds;case 2:return Qr;default:return Zt}}class C1 extends ln{constructor(t=64,e=1){super(new Float32Array(4),1,1,Zt,ne),this.minFilter=Bt,this.magFilter=Bt,this.size=t,this.channels=e,this.update()}update(){const t=this.channels,e=this.size,n=new w1;n.channels=t,n.size=e;const s=A1(t),r=R1(s);(this.image.width!==e||r!==this.format)&&(this.image.width=e,this.image.height=e,this.image.data=new Float32Array(e**2*s),this.format=r,this.dispose());const a=this.image.data;for(let o=0,l=t;o<l;o++){const u=n.generate(),h=u.data,f=u.maxValue;for(let c=0,m=h.length;c<m;c++){const g=h[c]/f;a[c*s+o]=g}}this.needsUpdate=!0}}const P1=`
...
`;class ex extends Ml{onBeforeRender(){this.setDefine("FEATURE_DOF",this.physicalCamera.bokehSize===0?0:1),this.setDefine("FEATURE_BACKGROUND_MAP",this.backgroundMap?1:0),this.setDefine("FEATURE_FOG",this.materials.features.isUsed("FOG")?1:0)}constructor(t){super({transparent:!0,depthWrite:!1,defines:{FEATURE_MIS:1,FEATURE_RUSSIAN_ROULETTE:1,FEATURE_DOF:1,FEATURE_BACKGROUND_MAP:0,FEATURE_FOG:1,RANDOM_TYPE:2,CAMERA_TYPE:0,DEBUG_MODE:0,ATTR_NORMAL:0,ATTR_TANGENT:1,ATTR_UV:2,ATTR_COLOR:3},uniforms:{resolution:{value:new ft},opacity:{value:1},bounces:{value:10},transmissiveBounces:{value:10},filterGlossyFactor:{value:0},physicalCamera:{value:new Zv},cameraWorldMatrix:{value:new Ut},invProjectionMatrix:{value:new Ut},bvh:{value:new _v},attributesArray:{value:new c1},materialIndexAttribute:{value:new rh},materials:{value:new m1},textures:{value:new ru().texture},lights:{value:new o1},iesProfiles:{value:new ru(360,180,{type:Fe,wrapS:Ne,wrapT:Ne}).texture},environmentIntensity:{value:1},environmentRotation:{value:new Ut},envMapInfo:{value:new t1},backgroundBlur:{value:0},backgroundMap:{value:null},backgroundAlpha:{value:1},backgroundIntensity:{value:1},backgroundRotation:{value:new Ut},seed:{value:0},sobolTexture:{value:null},stratifiedTexture:{value:new S1},stratifiedOffsetTexture:{value:new C1(64,1)}},vertexShader:`
			...
			`}),this.setValues(t)}}class rx extends un{constructor(){super({uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:`
				varying vec2 vUv;
				void main() {
				...
				}`}),this.depthWrite=!1,this.depthTest=!1}}class fu{constructor(t){this._renderer=t,this._quad=new vs(new rx)}generate(t,e=null,n=null){if(!t.isCubeTexture)throw new Error("CubeToEquirectMaterial: Source can only be cube textures.");const s=t.images[0],r=this._renderer,a=this._quad;e===null&&(e=4*s.height),n===null&&(n=2*s.height);const o=new Ze(e,n,{type:ne,colorSpace:s.colorSpace}),l=s.height,u=Math.log2(l)-2,h=1/l,f=1/(3*Math.max(Math.pow(2,u),7*16));a.material.defines.CUBEUV_MAX_MIP=`${u}.0`,a.material.defines.CUBEUV_TEXEL_WIDTH=f,a.material.defines.CUBEUV_TEXEL_HEIGHT=h,a.material.uniforms.envMap.value=t,a.material.uniforms.flipEnvMap.value=t.isRenderTargetTexture?1:-1,a.material.needsUpdate=!0;const c=r.getRenderTarget(),m=r.autoClear;r.autoClear=!0,r.setRenderTarget(o),a.render(r),r.setRenderTarget(c),r.autoClear=m;const g=new Uint16Array(e*n*4),_=new Float32Array(e*n*4);r.readRenderTargetPixels(o,0,0,e,n,_),o.dispose();for(let p=0,x=_.length;p<x;p++)g[p]=Fn.toHalfFloat(_[p]);const d=new ln(g,e,n,Zt,Fe);return d.minFilter=tf,d.magFilter=fe,d.wrapS=vn,d.wrapT=vn,d.mapping=Hs,d.needsUpdate=!0,d}dispose(){this._quad.dispose()}}function ax(i){return i.extensions.get("EXT_float_blend")}const ji=new ft;class ox{get multipleImportanceSampling(){return!!this._pathTracer.material.defines.FEATURE_MIS}set multipleImportanceSampling(t){this._pathTracer.material.setDefine("FEATURE_MIS",t?1:0)}get transmissiveBounces(){return this._pathTracer.material.transmissiveBounces}set transmissiveBounces(t){this._pathTracer.material.transmissiveBounces=t}get bounces(){return this._pathTracer.material.bounces}set bounces(t){this._pathTracer.material.bounces=t}get filterGlossyFactor(){return this._pathTracer.material.filterGlossyFactor}set filterGlossyFactor(t){this._pathTracer.material.filterGlossyFactor=t}get samples(){return this._pathTracer.samples}get target(){return this._pathTracer.target}get tiles(){return this._pathTracer.tiles}get stableNoise(){return this._pathTracer.stableNoise}set stableNoise(t){this._pathTracer.stableNoise=t}get isCompiling(){return!!this._pathTracer.isCompiling}constructor(t){this._renderer=t,this._generator=new Hv,this._pathTracer=new cu(t),this._queueReset=!1,this._clock=new gd,this._compilePromise=null,this._lowResPathTracer=new cu(t),this._lowResPathTracer.tiles.set(1,1),this._quad=new vs(new sx({map:null,transparent:!0,blending:Ke,premultipliedAlpha:t.getContextAttributes().premultipliedAlpha})),this._materials=null,this._previousEnvironment=null,this._previousBackground=null,this._internalBackground=null,this.renderDelay=100,this.minSamples=5,this.fadeDuration=500,this.enablePathTracing=!0,this.pausePathTracing=!1,this.dynamicLowRes=!1,this.lowResScale=.25,this.renderScale=1,this.synchronizeRenderSize=!0,this.rasterizeScene=!0,this.renderToCanvas=!0,this.textureSize=new ft(1024,1024),this.rasterizeSceneCallback=(e,n)=>{this._renderer.render(e,n)},this.renderToCanvasCallback=(e,n,s)=>{const r=n.autoClear;n.autoClear=!1,s.render(n),n.autoClear=r},this.setScene(new ku,new Le)}setBVHWorker(t){this._generator.setBVHWorker(t)}setScene(t,e,n={}){t.updateMatrixWorld(!0),e.updateMatrixWorld();const s=this._generator;if(s.setObjects(t),this._buildAsync)return s.generateAsync(n.onProgress).then(r=>this._updateFromResults(t,e,r));{const r=s.generate();return this._updateFromResults(t,e,r)}}setSceneAsync(...t){this._buildAsync=!0;const e=this.setScene(...t);return this._buildAsync=!1,e}setCamera(t){this.camera=t,this.updateCamera()}updateCamera(){const t=this.camera;t.updateMatrixWorld(),this._pathTracer.setCamera(t),this._lowResPathTracer.setCamera(t),this.reset()}updateMaterials(){const t=this._pathTracer.material,e=this._renderer,n=this._materials,s=this.textureSize,r=f1(n);t.textures.setTextures(e,r,s.x,s.y),t.materials.updateFrom(n,r),this.reset()}updateLights(){const t=this.scene,e=this._renderer,n=this._pathTracer.material,s=d1(t),r=h1(s);n.lights.updateFrom(s,r),n.iesProfiles.setTextures(e,r),this.reset()}updateEnvironment(){const t=this.scene,e=this._pathTracer.material;if(this._internalBackground&&(this._internalBackground.dispose(),this._internalBackground=null),e.backgroundBlur=t.backgroundBlurriness,e.backgroundIntensity=t.backgroundIntensity??1,e.backgroundRotation.makeRotationFromEuler(t.backgroundRotation).invert(),t.background===null)e.backgroundMap=null,e.backgroundAlpha=0;else if(t.background.isColor){this._colorBackground=this._colorBackground||new dh(16);const n=this._colorBackground;n.topColor.equals(t.background)||(n.topColor.set(t.background),n.bottomColor.set(t.background),n.update()),e.backgroundMap=n,e.backgroundAlpha=1}else if(t.background.isCubeTexture){if(t.background!==this._previousBackground){const n=new fu(this._renderer).generate(t.background);this._internalBackground=n,e.backgroundMap=n,e.backgroundAlpha=1}}else e.backgroundMap=t.background,e.backgroundAlpha=1;if(e.environmentIntensity=t.environmentIntensity??1,e.environmentRotation.makeRotationFromEuler(t.environmentRotation).invert(),this._previousEnvironment!==t.environment)if(t.environment!==null)if(t.environment.isCubeTexture){const n=new fu(this._renderer).generate(t.environment);e.envMapInfo.updateFrom(n)}else e.envMapInfo.updateFrom(t.environment);else e.environmentIntensity=0;this._previousEnvironment=t.environment,this._previousBackground=t.background,this.reset()}_updateFromResults(t,e,n){const{materials:s,geometry:r,bvh:a,bvhChanged:o}=n;this._materials=s;const u=this._pathTracer.material;return o&&(u.bvh.updateFrom(a),u.attributesArray.updateFrom(r.attributes.normal,r.attributes.tangent,r.attributes.uv,r.attributes.color),u.materialIndexAttribute.updateFrom(r.attributes.materialIndex)),this._previousScene=t,this.scene=t,this.camera=e,this.updateCamera(),this.updateMaterials(),this.updateEnvironment(),this.updateLights(),n}renderSample(){const t=this._lowResPathTracer,e=this._pathTracer,n=this._renderer,s=this._clock,r=this._quad;this._updateScale(),this._queueReset&&(e.reset(),t.reset(),this._queueReset=!1,r.material.opacity=0,s.start());const a=s.getDelta()*1e3,o=s.getElapsedTime()*1e3;if(!this.pausePathTracing&&this.enablePathTracing&&this.renderDelay<=o&&!this.isCompiling&&e.update(),e.alpha=e.material.backgroundAlpha!==1||!ax(n),t.alpha=e.alpha,this.renderToCanvas){const l=this._renderer,u=this.minSamples;if(o>=this.renderDelay&&this.samples>=this.minSamples&&(this.fadeDuration!==0?r.material.opacity=Math.min(r.material.opacity+a/this.fadeDuration,1):r.material.opacity=1),!this.enablePathTracing||this.samples<u||r.material.opacity<1){if(this.dynamicLowRes&&!this.isCompiling){t.samples<1&&(t.material=e.material,t.update());const h=r.material.opacity;r.material.opacity=1-r.material.opacity,r.material.map=t.target.texture,r.render(l),r.material.opacity=h}(!this.dynamicLowRes&&this.rasterizeScene||this.dynamicLowRes&&this.isCompiling)&&this.rasterizeSceneCallback(this.scene,this.camera)}this.enablePathTracing&&r.material.opacity>0&&(r.material.opacity<1&&(r.material.blending=this.dynamicLowRes?so:Zn),r.material.map=e.target.texture,this.renderToCanvasCallback(e.target,l,r),r.material.blending=Ke)}}reset(){this._queueReset=!0,this._pathTracer.samples=0}dispose(){this._renderQuad.dispose(),this._renderQuad.material.dispose(),this._pathTracer.dispose()}_updateScale(){if(this.synchronizeRenderSize){this._renderer.getDrawingBufferSize(ji);const t=Math.floor(this.renderScale*ji.x),e=Math.floor(this.renderScale*ji.y);if(this._pathTracer.getSize(ji),ji.x!==t||ji.y!==e){const n=this.lowResScale;this._pathTracer.setSize(t,e),this._lowResPathTracer.setSize(Math.floor(t*n),Math.floor(e*n))}}}}class lx extends pd{constructor(...t){super(...t),this.iesMap=null,this.radius=0}copy(t,e){return super.copy(t,e),this.iesMap=t.iesMap,this.radius=t.radius,this}}/**
 * lil-gui
 * https://lil-gui.georgealways.com
 * @version 0.17.0
 * @author George Michael Brower
 * @license MIT
 */class Sn{constructor(t,e,n,s,r="div"){this.parent=t,this.object=e,this.property=n,this._disabled=!1,this._hidden=!1,this.initialValue=this.getValue(),this.domElement=document.createElement("div"),this.domElement.classList.add("controller"),this.domElement.classList.add(s),this.$name=document.createElement("div"),this.$name.classList.add("name"),Sn.nextNameID=Sn.nextNameID||0,this.$name.id="lil-gui-name-"+ ++Sn.nextNameID,this.$widget=document.createElement(r),this.$widget.classList.add("widget"),this.$disable=this.$widget,this.domElement.appendChild(this.$name),this.domElement.appendChild(this.$widget),this.parent.children.push(this),this.parent.controllers.push(this),this.parent.$children.appendChild(this.domElement),this._listenCallback=this._listenCallback.bind(this),this.name(n)}name(t){return this._name=t,this.$name.innerHTML=t,this}onChange(t){return this._onChange=t,this}_callOnChange(){this.parent._callOnChange(this),this._onChange!==void 0&&this._onChange.call(this,this.getValue()),this._changed=!0}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(){this._changed&&(this.parent._callOnFinishChange(this),this._onFinishChange!==void 0&&this._onFinishChange.call(this,this.getValue())),this._changed=!1}reset(){return this.setValue(this.initialValue),this._callOnFinishChange(),this}enable(t=!0){return this.disable(!t)}disable(t=!0){return t===this._disabled||(this._disabled=t,this.domElement.classList.toggle("disabled",t),this.$disable.toggleAttribute("disabled",t)),this}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}options(t){const e=this.parent.add(this.object,this.property,t);return e.name(this._name),this.destroy(),e}min(t){return this}max(t){return this}step(t){return this}decimals(t){return this}listen(t=!0){return this._listening=t,this._listenCallbackID!==void 0&&(cancelAnimationFrame(this._listenCallbackID),this._listenCallbackID=void 0),this._listening&&this._listenCallback(),this}_listenCallback(){this._listenCallbackID=requestAnimationFrame(this._listenCallback);const t=this.save();t!==this._listenPrevValue&&this.updateDisplay(),this._listenPrevValue=t}getValue(){return this.object[this.property]}setValue(t){return this.object[this.property]=t,this._callOnChange(),this.updateDisplay(),this}updateDisplay(){return this}load(t){return this.setValue(t),this._callOnFinishChange(),this}save(){return this.getValue()}destroy(){this.listen(!1),this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.controllers.splice(this.parent.controllers.indexOf(this),1),this.parent.$children.removeChild(this.domElement)}}class cx extends Sn{constructor(t,e,n){super(t,e,n,"boolean","label"),this.$input=document.createElement("input"),this.$input.setAttribute("type","checkbox"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$input.addEventListener("change",()=>{this.setValue(this.$input.checked),this._callOnFinishChange()}),this.$disable=this.$input,this.updateDisplay()}updateDisplay(){return this.$input.checked=this.getValue(),this}}function il(i){let t,e;return(t=i.match(/(#|0x)?([a-f0-9]{6})/i))?e=t[2]:(t=i.match(/rgb\(\s*(\d*)\s*,\s*(\d*)\s*,\s*(\d*)\s*\)/))?e=parseInt(t[1]).toString(16).padStart(2,0)+parseInt(t[2]).toString(16).padStart(2,0)+parseInt(t[3]).toString(16).padStart(2,0):(t=i.match(/^#?([a-f0-9])([a-f0-9])([a-f0-9])$/i))&&(e=t[1]+t[1]+t[2]+t[2]+t[3]+t[3]),!!e&&"#"+e}const ux={isPrimitive:!0,match:i=>typeof i=="string",fromHexString:il,toHexString:il},Vs={isPrimitive:!0,match:i=>typeof i=="number",fromHexString:i=>parseInt(i.substring(1),16),toHexString:i=>"#"+i.toString(16).padStart(6,0)},hx={isPrimitive:!1,match:Array.isArray,fromHexString(i,t,e=1){const n=Vs.fromHexString(i);t[0]=(n>>16&255)/255*e,t[1]=(n>>8&255)/255*e,t[2]=(255&n)/255*e},toHexString:([i,t,e],n=1)=>Vs.toHexString(i*(n=255/n)<<16^t*n<<8^e*n<<0)},fx={isPrimitive:!1,match:i=>Object(i)===i,fromHexString(i,t,e=1){const n=Vs.fromHexString(i);t.r=(n>>16&255)/255*e,t.g=(n>>8&255)/255*e,t.b=(255&n)/255*e},toHexString:({r:i,g:t,b:e},n=1)=>Vs.toHexString(i*(n=255/n)<<16^t*n<<8^e*n<<0)},dx=[ux,Vs,hx,fx];class px extends Sn{constructor(t,e,n,s){var r;super(t,e,n,"color"),this.$input=document.createElement("input"),this.$input.setAttribute("type","color"),this.$input.setAttribute("tabindex",-1),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$text=document.createElement("input"),this.$text.setAttribute("type","text"),this.$text.setAttribute("spellcheck","false"),this.$text.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$display.appendChild(this.$input),this.$widget.appendChild(this.$display),this.$widget.appendChild(this.$text),this._format=(r=this.initialValue,dx.find(a=>a.match(r))),this._rgbScale=s,this._initialValueHexString=this.save(),this._textFocused=!1,this.$input.addEventListener("input",()=>{this._setValueFromHexString(this.$input.value)}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$text.addEventListener("input",()=>{const a=il(this.$text.value);a&&this._setValueFromHexString(a)}),this.$text.addEventListener("focus",()=>{this._textFocused=!0,this.$text.select()}),this.$text.addEventListener("blur",()=>{this._textFocused=!1,this.updateDisplay(),this._callOnFinishChange()}),this.$disable=this.$text,this.updateDisplay()}reset(){return this._setValueFromHexString(this._initialValueHexString),this}_setValueFromHexString(t){if(this._format.isPrimitive){const e=this._format.fromHexString(t);this.setValue(e)}else this._format.fromHexString(t,this.getValue(),this._rgbScale),this._callOnChange(),this.updateDisplay()}save(){return this._format.toHexString(this.getValue(),this._rgbScale)}load(t){return this._setValueFromHexString(t),this._callOnFinishChange(),this}updateDisplay(){return this.$input.value=this._format.toHexString(this.getValue(),this._rgbScale),this._textFocused||(this.$text.value=this.$input.value.substring(1)),this.$display.style.backgroundColor=this.$input.value,this}}class io extends Sn{constructor(t,e,n){super(t,e,n,"function"),this.$button=document.createElement("button"),this.$button.appendChild(this.$name),this.$widget.appendChild(this.$button),this.$button.addEventListener("click",s=>{s.preventDefault(),this.getValue().call(this.object)}),this.$button.addEventListener("touchstart",()=>{},{passive:!0}),this.$disable=this.$button}}class mx extends Sn{constructor(t,e,n,s,r,a){super(t,e,n,"number"),this._initInput(),this.min(s),this.max(r);const o=a!==void 0;this.step(o?a:this._getImplicitStep(),o),this.updateDisplay()}decimals(t){return this._decimals=t,this.updateDisplay(),this}min(t){return this._min=t,this._onUpdateMinMax(),this}max(t){return this._max=t,this._onUpdateMinMax(),this}step(t,e=!0){return this._step=t,this._stepExplicit=e,this}updateDisplay(){const t=this.getValue();if(this._hasSlider){let e=(t-this._min)/(this._max-this._min);e=Math.max(0,Math.min(e,1)),this.$fill.style.width=100*e+"%"}return this._inputFocused||(this.$input.value=this._decimals===void 0?t:t.toFixed(this._decimals)),this}_initInput(){this.$input=document.createElement("input"),this.$input.setAttribute("type","number"),this.$input.setAttribute("step","any"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$disable=this.$input;const t=h=>{const f=parseFloat(this.$input.value);isNaN(f)||(this._snapClampSetValue(f+h),this.$input.value=this.getValue())};let e,n,s,r,a,o=!1;const l=h=>{if(o){const f=h.clientX-e,c=h.clientY-n;Math.abs(c)>5?(h.preventDefault(),this.$input.blur(),o=!1,this._setDraggingStyle(!0,"vertical")):Math.abs(f)>5&&u()}if(!o){const f=h.clientY-s;a-=f*this._step*this._arrowKeyMultiplier(h),r+a>this._max?a=this._max-r:r+a<this._min&&(a=this._min-r),this._snapClampSetValue(r+a)}s=h.clientY},u=()=>{this._setDraggingStyle(!1,"vertical"),this._callOnFinishChange(),window.removeEventListener("mousemove",l),window.removeEventListener("mouseup",u)};this.$input.addEventListener("input",()=>{let h=parseFloat(this.$input.value);isNaN(h)||(this._stepExplicit&&(h=this._snap(h)),this.setValue(this._clamp(h)))}),this.$input.addEventListener("keydown",h=>{h.code==="Enter"&&this.$input.blur(),h.code==="ArrowUp"&&(h.preventDefault(),t(this._step*this._arrowKeyMultiplier(h))),h.code==="ArrowDown"&&(h.preventDefault(),t(this._step*this._arrowKeyMultiplier(h)*-1))}),this.$input.addEventListener("wheel",h=>{this._inputFocused&&(h.preventDefault(),t(this._step*this._normalizeMouseWheel(h)))},{passive:!1}),this.$input.addEventListener("mousedown",h=>{e=h.clientX,n=s=h.clientY,o=!0,r=this.getValue(),a=0,window.addEventListener("mousemove",l),window.addEventListener("mouseup",u)}),this.$input.addEventListener("focus",()=>{this._inputFocused=!0}),this.$input.addEventListener("blur",()=>{this._inputFocused=!1,this.updateDisplay(),this._callOnFinishChange()})}_initSlider(){this._hasSlider=!0,this.$slider=document.createElement("div"),this.$slider.classList.add("slider"),this.$fill=document.createElement("div"),this.$fill.classList.add("fill"),this.$slider.appendChild(this.$fill),this.$widget.insertBefore(this.$slider,this.$input),this.domElement.classList.add("hasSlider");const t=c=>{const m=this.$slider.getBoundingClientRect();let g=(_=c,d=m.left,p=m.right,x=this._min,y=this._max,(_-d)/(p-d)*(y-x)+x);var _,d,p,x,y;this._snapClampSetValue(g)},e=c=>{t(c.clientX)},n=()=>{this._callOnFinishChange(),this._setDraggingStyle(!1),window.removeEventListener("mousemove",e),window.removeEventListener("mouseup",n)};let s,r,a=!1;const o=c=>{c.preventDefault(),this._setDraggingStyle(!0),t(c.touches[0].clientX),a=!1},l=c=>{if(a){const m=c.touches[0].clientX-s,g=c.touches[0].clientY-r;Math.abs(m)>Math.abs(g)?o(c):(window.removeEventListener("touchmove",l),window.removeEventListener("touchend",u))}else c.preventDefault(),t(c.touches[0].clientX)},u=()=>{this._callOnFinishChange(),this._setDraggingStyle(!1),window.removeEventListener("touchmove",l),window.removeEventListener("touchend",u)},h=this._callOnFinishChange.bind(this);let f;this.$slider.addEventListener("mousedown",c=>{this._setDraggingStyle(!0),t(c.clientX),window.addEventListener("mousemove",e),window.addEventListener("mouseup",n)}),this.$slider.addEventListener("touchstart",c=>{c.touches.length>1||(this._hasScrollBar?(s=c.touches[0].clientX,r=c.touches[0].clientY,a=!0):o(c),window.addEventListener("touchmove",l,{passive:!1}),window.addEventListener("touchend",u))},{passive:!1}),this.$slider.addEventListener("wheel",c=>{if(Math.abs(c.deltaX)<Math.abs(c.deltaY)&&this._hasScrollBar)return;c.preventDefault();const m=this._normalizeMouseWheel(c)*this._step;this._snapClampSetValue(this.getValue()+m),this.$input.value=this.getValue(),clearTimeout(f),f=setTimeout(h,400)},{passive:!1})}_setDraggingStyle(t,e="horizontal"){this.$slider&&this.$slider.classList.toggle("active",t),document.body.classList.toggle("lil-gui-dragging",t),document.body.classList.toggle("lil-gui-"+e,t)}_getImplicitStep(){return this._hasMin&&this._hasMax?(this._max-this._min)/1e3:.1}_onUpdateMinMax(){!this._hasSlider&&this._hasMin&&this._hasMax&&(this._stepExplicit||this.step(this._getImplicitStep(),!1),this._initSlider(),this.updateDisplay())}_normalizeMouseWheel(t){let{deltaX:e,deltaY:n}=t;return Math.floor(t.deltaY)!==t.deltaY&&t.wheelDelta&&(e=0,n=-t.wheelDelta/120,n*=this._stepExplicit?1:10),e+-n}_arrowKeyMultiplier(t){let e=this._stepExplicit?1:10;return t.shiftKey?e*=10:t.altKey&&(e/=10),e}_snap(t){const e=Math.round(t/this._step)*this._step;return parseFloat(e.toPrecision(15))}_clamp(t){return t<this._min&&(t=this._min),t>this._max&&(t=this._max),t}_snapClampSetValue(t){this.setValue(this._clamp(this._snap(t)))}get _hasScrollBar(){const t=this.parent.root.$children;return t.scrollHeight>t.clientHeight}get _hasMin(){return this._min!==void 0}get _hasMax(){return this._max!==void 0}}class gx extends Sn{constructor(t,e,n,s){super(t,e,n,"option"),this.$select=document.createElement("select"),this.$select.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this._values=Array.isArray(s)?s:Object.values(s),this._names=Array.isArray(s)?s:Object.keys(s),this._names.forEach(r=>{const a=document.createElement("option");a.innerHTML=r,this.$select.appendChild(a)}),this.$select.addEventListener("change",()=>{this.setValue(this._values[this.$select.selectedIndex]),this._callOnFinishChange()}),this.$select.addEventListener("focus",()=>{this.$display.classList.add("focus")}),this.$select.addEventListener("blur",()=>{this.$display.classList.remove("focus")}),this.$widget.appendChild(this.$select),this.$widget.appendChild(this.$display),this.$disable=this.$select,this.updateDisplay()}updateDisplay(){const t=this.getValue(),e=this._values.indexOf(t);return this.$select.selectedIndex=e,this.$display.innerHTML=e===-1?t:this._names[e],this}}class _x extends Sn{constructor(t,e,n){super(t,e,n,"string"),this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$input.addEventListener("input",()=>{this.setValue(this.$input.value)}),this.$input.addEventListener("keydown",s=>{s.code==="Enter"&&this.$input.blur()}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$widget.appendChild(this.$input),this.$disable=this.$input,this.updateDisplay()}updateDisplay(){return this.$input.value=this.getValue(),this}}let du=!1;class Sl{constructor({parent:t,autoPlace:e=t===void 0,container:n,width:s,title:r="Controls",injectStyles:a=!0,touchStyles:o=!0}={}){if(this.parent=t,this.root=t?t.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",l=>{l.code!=="Enter"&&l.code!=="Space"||(l.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(r),o&&this.domElement.classList.add("allow-touch-styles"),this.parent)return this.parent.children.push(this),this.parent.folders.push(this),void this.parent.$children.appendChild(this.domElement);this.domElement.classList.add("root"),!du&&a&&(function(l){const u=document.createElement("style");u.innerHTML=l;const h=document.querySelector("head link[rel=stylesheet], head style");h?document.head.insertBefore(u,h):document.head.appendChild(u)}('.lil-gui{--background-color:#1f1f1f;--text-color:#ebebeb;--title-background-color:#111;--title-text-color:#ebebeb;--widget-color:#424242;--hover-color:#4f4f4f;--focus-color:#595959;--number-color:#2cc9ff;--string-color:#a2db3c;--font-size:11px;--input-font-size:11px;--font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Arial,sans-serif;--font-family-mono:Menlo,Monaco,Consolas,"Droid Sans Mono",monospace;--padding:4px;--spacing:4px;--widget-height:20px;--name-width:45%;--slider-knob-width:2px;--slider-input-width:27%;--color-input-width:27%;--slider-input-min-width:45px;--color-input-min-width:45px;--folder-indent:7px;--widget-padding:0 0 0 3px;--widget-border-radius:2px;--checkbox-size:calc(var(--widget-height)*0.75);--scrollbar-width:5px;background-color:var(--background-color);color:var(--text-color);font-family:var(--font-family);font-size:var(--font-size);font-style:normal;font-weight:400;line-height:1;text-align:left;touch-action:manipulation;user-select:none;-webkit-user-select:none}.lil-gui,.lil-gui *{box-sizing:border-box;margin:0;padding:0}.lil-gui.root{display:flex;flex-direction:column;width:var(--width,245px)}.lil-gui.root>.title{background:var(--title-background-color);color:var(--title-text-color)}.lil-gui.root>.children{overflow-x:hidden;overflow-y:auto}.lil-gui.root>.children::-webkit-scrollbar{background:var(--background-color);height:var(--scrollbar-width);width:var(--scrollbar-width)}.lil-gui.root>.children::-webkit-scrollbar-thumb{background:var(--focus-color);border-radius:var(--scrollbar-width)}.lil-gui.force-touch-styles{--widget-height:28px;--padding:6px;--spacing:6px;--font-size:13px;--input-font-size:16px;--folder-indent:10px;--scrollbar-width:7px;--slider-input-min-width:50px;--color-input-min-width:65px}.lil-gui.autoPlace{max-height:100%;position:fixed;right:15px;top:0;z-index:1001}.lil-gui .controller{align-items:center;display:flex;margin:var(--spacing) 0;padding:0 var(--padding)}.lil-gui .controller.disabled{opacity:.5}.lil-gui .controller.disabled,.lil-gui .controller.disabled *{pointer-events:none!important}.lil-gui .controller>.name{flex-shrink:0;line-height:var(--widget-height);min-width:var(--name-width);padding-right:var(--spacing);white-space:pre}.lil-gui .controller .widget{align-items:center;display:flex;min-height:var(--widget-height);position:relative;width:100%}.lil-gui .controller.string input{color:var(--string-color)}.lil-gui .controller.boolean .widget{cursor:pointer}.lil-gui .controller.color .display{border-radius:var(--widget-border-radius);height:var(--widget-height);position:relative;width:100%}.lil-gui .controller.color input[type=color]{cursor:pointer;height:100%;opacity:0;width:100%}.lil-gui .controller.color input[type=text]{flex-shrink:0;font-family:var(--font-family-mono);margin-left:var(--spacing);min-width:var(--color-input-min-width);width:var(--color-input-width)}.lil-gui .controller.option select{max-width:100%;opacity:0;position:absolute;width:100%}.lil-gui .controller.option .display{background:var(--widget-color);border-radius:var(--widget-border-radius);height:var(--widget-height);line-height:var(--widget-height);max-width:100%;overflow:hidden;padding-left:.55em;padding-right:1.75em;pointer-events:none;position:relative;word-break:break-all}.lil-gui .controller.option .display.active{background:var(--focus-color)}.lil-gui .controller.option .display:after{bottom:0;content:"↕";font-family:lil-gui;padding-right:.375em;position:absolute;right:0;top:0}.lil-gui .controller.option .widget,.lil-gui .controller.option select{cursor:pointer}.lil-gui .controller.number input{color:var(--number-color)}.lil-gui .controller.number.hasSlider input{flex-shrink:0;margin-left:var(--spacing);min-width:var(--slider-input-min-width);width:var(--slider-input-width)}.lil-gui .controller.number .slider{background-color:var(--widget-color);border-radius:var(--widget-border-radius);cursor:ew-resize;height:var(--widget-height);overflow:hidden;padding-right:var(--slider-knob-width);touch-action:pan-y;width:100%}.lil-gui .controller.number .slider.active{background-color:var(--focus-color)}.lil-gui .controller.number .slider.active .fill{opacity:.95}.lil-gui .controller.number .fill{border-right:var(--slider-knob-width) solid var(--number-color);box-sizing:content-box;height:100%}.lil-gui-dragging .lil-gui{--hover-color:var(--widget-color)}.lil-gui-dragging *{cursor:ew-resize!important}.lil-gui-dragging.lil-gui-vertical *{cursor:ns-resize!important}.lil-gui .title{--title-height:calc(var(--widget-height) + var(--spacing)*1.25);-webkit-tap-highlight-color:transparent;text-decoration-skip:objects;cursor:pointer;font-weight:600;height:var(--title-height);line-height:calc(var(--title-height) - 4px);outline:none;padding:0 var(--padding)}.lil-gui .title:before{content:"▾";display:inline-block;font-family:lil-gui;padding-right:2px}.lil-gui .title:active{background:var(--title-background-color);opacity:.75}.lil-gui.root>.title:focus{text-decoration:none!important}.lil-gui.closed>.title:before{content:"▸"}.lil-gui.closed>.children{opacity:0;transform:translateY(-7px)}.lil-gui.closed:not(.transition)>.children{display:none}.lil-gui.transition>.children{overflow:hidden;pointer-events:none;transition-duration:.3s;transition-property:height,opacity,transform;transition-timing-function:cubic-bezier(.2,.6,.35,1)}.lil-gui .children:empty:before{content:"Empty";display:block;font-style:italic;height:var(--widget-height);line-height:var(--widget-height);margin:var(--spacing) 0;opacity:.5;padding:0 var(--padding)}.lil-gui.root>.children>.lil-gui>.title{border-width:0;border-bottom:1px solid var(--widget-color);border-left:0 solid var(--widget-color);border-right:0 solid var(--widget-color);border-top:1px solid var(--widget-color);transition:border-color .3s}.lil-gui.root>.children>.lil-gui.closed>.title{border-bottom-color:transparent}.lil-gui+.controller{border-top:1px solid var(--widget-color);margin-top:0;padding-top:var(--spacing)}.lil-gui .lil-gui .lil-gui>.title{border:none}.lil-gui .lil-gui .lil-gui>.children{border:none;border-left:2px solid var(--widget-color);margin-left:var(--folder-indent)}.lil-gui .lil-gui .controller{border:none}.lil-gui input{-webkit-tap-highlight-color:transparent;background:var(--widget-color);border:0;border-radius:var(--widget-border-radius);color:var(--text-color);font-family:var(--font-family);font-size:var(--input-font-size);height:var(--widget-height);outline:none;width:100%}.lil-gui input:disabled{opacity:1}.lil-gui input[type=number],.lil-gui input[type=text]{padding:var(--widget-padding)}.lil-gui input[type=number]:focus,.lil-gui input[type=text]:focus{background:var(--focus-color)}.lil-gui input::-webkit-inner-spin-button,.lil-gui input::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}.lil-gui input[type=number]{-moz-appearance:textfield}.lil-gui input[type=checkbox]{appearance:none;-webkit-appearance:none;border-radius:var(--widget-border-radius);cursor:pointer;height:var(--checkbox-size);text-align:center;width:var(--checkbox-size)}.lil-gui input[type=checkbox]:checked:before{content:"✓";font-family:lil-gui;font-size:var(--checkbox-size);line-height:var(--checkbox-size)}.lil-gui button{-webkit-tap-highlight-color:transparent;background:var(--widget-color);border:1px solid var(--widget-color);border-radius:var(--widget-border-radius);color:var(--text-color);cursor:pointer;font-family:var(--font-family);font-size:var(--font-size);height:var(--widget-height);line-height:calc(var(--widget-height) - 4px);outline:none;text-align:center;text-transform:none;width:100%}.lil-gui button:active{background:var(--focus-color)}@font-face{font-family:lil-gui;src:url("data:application/font-woff;charset=utf-8;base64,") format("woff")}@media (pointer:coarse){.lil-gui.allow-touch-styles{--widget-height:28px;--padding:6px;--spacing:6px;--font-size:13px;--input-font-size:16px;--folder-indent:10px;--scrollbar-width:7px;--slider-input-min-width:50px;--color-input-min-width:65px}}@media (hover:hover){.lil-gui .controller.color .display:hover:before{border:1px solid #fff9;border-radius:var(--widget-border-radius);bottom:0;content:" ";display:block;left:0;position:absolute;right:0;top:0}.lil-gui .controller.option .display.focus{background:var(--focus-color)}.lil-gui .controller.option .widget:hover .display{background:var(--hover-color)}.lil-gui .controller.number .slider:hover{background-color:var(--hover-color)}body:not(.lil-gui-dragging) .lil-gui .title:hover{background:var(--title-background-color);opacity:.85}.lil-gui .title:focus{text-decoration:underline var(--focus-color)}.lil-gui input:hover{background:var(--hover-color)}.lil-gui input:active{background:var(--focus-color)}.lil-gui input[type=checkbox]:focus{box-shadow:inset 0 0 0 1px var(--focus-color)}.lil-gui button:hover{background:var(--hover-color);border-color:var(--hover-color)}.lil-gui button:focus{border-color:var(--focus-color)}}'),du=!0),n?n.appendChild(this.domElement):e&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),s&&this.domElement.style.setProperty("--width",s+"px"),this.domElement.addEventListener("keydown",l=>l.stopPropagation()),this.domElement.addEventListener("keyup",l=>l.stopPropagation())}add(t,e,n,s,r){if(Object(n)===n)return new gx(this,t,e,n);const a=t[e];switch(typeof a){case"number":return new mx(this,t,e,n,s,r);case"boolean":return new cx(this,t,e);case"string":return new _x(this,t,e);case"function":return new io(this,t,e)}console.error(`gui.add failed
	property:`,e,`
	object:`,t,`
	value:`,a)}addColor(t,e,n=1){return new px(this,t,e,n)}addFolder(t){return new Sl({parent:this,title:t})}load(t,e=!0){return t.controllers&&this.controllers.forEach(n=>{n instanceof io||n._name in t.controllers&&n.load(t.controllers[n._name])}),e&&t.folders&&this.folders.forEach(n=>{n._title in t.folders&&n.load(t.folders[n._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof io)){if(n._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);e.controllers[n._name]=n.save()}}),t&&this.folders.forEach(n=>{if(n._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);e.folders[n._title]=n.save()}),e}open(t=!0){return this._closed=!t,this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._closed=!t,this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const n=r=>{r.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const s=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=s+"px"})}),this}title(t){return this._title=t,this.$title.innerHTML=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(e=>e.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}let pu=function(i,t,e){let n=Math.cos(i)*Math.sin(e),s=Math.sin(i)*Math.sin(e),r=Math.cos(t)*Math.cos(e),a=Math.sin(t)*Math.cos(e);return new Kt(n,r,-s,a)},mu=function(i){return new D(i.x,i.y,i.z).divideScalar(1-i.w)},Or=function(i=glassColor,t=!1){let e={color:i,clearcoat:1,roughness:.1,metalness:0};return t&&(e.transparent=!0,e.opacity=1,e.transmission=.5,e.ior=1.05,e.thickness=.2),new Vu(e)},gi={red:13908795,orange:12737323,yellow:15248426,green:4432699,blue:4360181,purple:8210109,pink:13584575,glass:13232895},vx={dark:998533,medium:3438819,light:6922746};class gu extends Se{constructor(t=(s,r,a)=>a.set(s,r,Math.cos(s)*Math.sin(r)),e=8,n=8){super(),this.type="ParametricGeometry",this.parameters={func:t,slices:e,stacks:n};const s=[],r=[],a=[],o=[],l=1e-5,u=new D,h=new D,f=new D,c=new D,m=new D,g=e+1;for(let _=0;_<=n;_++){const d=_/n;for(let p=0;p<=e;p++){const x=p/e;t(x,d,h),r.push(h.x,h.y,h.z),x-l>=0?(t(x-l,d,f),c.subVectors(h,f)):(t(x+l,d,f),c.subVectors(f,h)),d-l>=0?(t(x,d-l,f),m.subVectors(h,f)):(t(x,d+l,f),m.subVectors(f,h)),u.crossVectors(c,m).normalize(),a.push(u.x,u.y,u.z),o.push(x,d)}}for(let _=0;_<n;_++)for(let d=0;d<e;d++){const p=_*g+d,x=_*g+d+1,y=(_+1)*g+d+1,v=(_+1)*g+d;s.push(p,x,v),s.push(x,y,v)}this.setIndex(s),this.setAttribute("position",new ye(r,3)),this.setAttribute("normal",new ye(a,3)),this.setAttribute("uv",new ye(o,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}}const _u=new Go([new D(-1,-1,0),new D(-1,1,0),new D(1,1,0)]);class xx extends Se{constructor(t=_u,e=_u,n=64,s=8,r=!1){super(),this.type="TubeGeometry",this.parameters={path:t,tubularSegments:n,radii:e,radialSegments:s,closed:r};const a=t.computeFrenetFrames(n,r);this.tangents=a.tangents,this.normals=a.normals,this.binormals=a.binormals;const o=new D,l=new D,u=new ft;let h=new D,f;const c=[],m=[],g=[],_=[];d(),this.setIndex(_),this.setAttribute("position",new ye(c,3)),this.setAttribute("normal",new ye(m,3)),this.setAttribute("uv",new ye(g,2));function d(){for(let v=0;v<n;v++)p(v);p(r===!1?n:0),y(),x()}function p(v){h=t.getPointAt(v/n,h),f=e.getPointAt(v/n,f);const T=a.normals[v],A=a.binormals[v];for(let w=0;w<=s;w++){const P=w/s*Math.PI*2,b=Math.sin(P),M=-Math.cos(P);l.x=M*T.x+b*A.x,l.y=M*T.y+b*A.y,l.z=M*T.z+b*A.z,l.normalize(),m.push(l.x,l.y,l.z),o.x=h.x+f.x*l.x,o.y=h.y+f.x*l.y,o.z=h.z+f.x*l.z,c.push(o.x,o.y,o.z)}}function x(){for(let v=1;v<=n;v++)for(let T=1;T<=s;T++){const A=(s+1)*(v-1)+(T-1),w=(s+1)*v+(T-1),P=(s+1)*v+T,b=(s+1)*(v-1)+T;_.push(A,w,b),_.push(w,P,b)}}function y(){for(let v=0;v<=n;v++)for(let T=0;T<=s;T++)u.x=v/n,u.y=T/s,g.push(u.x,u.y)}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}}class yx{constructor(t,e){this.coordCurve=t,this.length=e.length,this.area=e.area,this.tau=e.tau,this.fromTauCoords=e.fromTauCoords,this.res=256;let n=function(o){let l=25e-5,u=Math.floor(o/l),h=0,f=0;for(let c=0;c<u;c++){let m=t(f),g=t(f+l),_=Math.sin(m.phi/2),d=g.theta-m.theta;h+=_*_*d,f+=l}return h},s=function(o){let l=0,u=0,h=3e3,f=2*Math.PI/h;for(let c=0;c<h;c++){let m=t(l),g=t(l+f),_=Math.sin(m.phi),d=g.theta-m.theta,p=g.phi-m.phi,x=_*_*d*d+p*p,y=Math.sqrt(x);if(u+=y,u>o)break;l+=f}return l},r=function(o){let l=new ft(e.area/2,e.length/2);for(;o.y>e.length/2;)o=o.sub(l);return o};this.toFundamentalDomain=r;let a=function(o){o=r(o);let l=o.x,u=o.y,h=s(2*u),f=t(h),c=f.phi,m=f.theta,g=n(h),_=pu(m+l-g,l-g,c/2);return mu(_)};this.isometricImage=a}getSurface(t=gi.glass,e=!1){let n=this.coordCurve,s=function(o,l,u){let h=2*Math.PI*o,f=2*Math.PI*l,c=n(f),m=c.phi,g=c.theta,_=pu(g+h,h,m/2),d=mu(_);u.set(d.x,d.y,d.z)},r=new gu(s,this.res,this.res),a=Or(t,e);return new Ae(r,a)}getSubSurface(t,e=gi.glass,n=!1){let s=this.isometricImage,r=function(l,u,h){let f=t(l,u),c=s(f);h.set(c.x,c.y,c.z)},a=new gu(r,512,512);a.computeVertexNormals();let o=Or(e,n);return o.side=sn,new Ae(a,o)}getLift(t,e=gi.red,n=.05,s=!1){let r=[],a=[];for(let f=0;f<this.res+1;f++){let c=f/this.res,m=t(c),g=this.isometricImage(m);r.push(g);let _=n*(1+g.lengthSq());a.push(new D(_,_,_))}console.log(r);let o=new Go(r),l=new Go(a),u=new xx(o,l,2*this.res,16,closed),h=Or(e,s);return new Ae(u,h)}getFiberAt(t,e=gi.blue,n=.025,s=!1){let a=new ft(this.area/2,this.length/2).multiplyScalar(t),o=new ft(2*Math.PI,0),l=function(u){return a.clone().add(o.clone().multiplyScalar(u))};return this.getLift(l,e,n,s)}getEdgeAt(t,e=gi.blue,n=.025,s=!1){let r=new ft(this.area/2,this.length/2),a=new ft(2*Math.PI,0).multiplyScalar(t),o=function(l){return a.clone().add(r.clone().multiplyScalar(l))};return this.getLift(o,e,n,s)}getGridlines(t,e=gi.blue,n=.025,s=!1){let r=new ts;for(let a=0;a<t+1;a++){let o=this.getFiberAt(a/t,e,n,s),l=this.getEdgeAt(a/t,e,n,s);r.add(o),r.add(l)}return r}getPoint(t,e=gi.red,n=.05,s=!1){let r=this.isometricImage(t),a=1+r.lengthSq(),o=new dl(n*a),l=Or(e,s),u=new Ae(o,l);return u.position.set(r.x,r.y,r.z),u}}const Tl=new ft(1/2,Math.sqrt(7)/2);let Mx=4*Math.PI*Tl.x,bx=4*Math.PI*Tl.y,Sx=function(i){let t=.1179,e=3.89,n=7;return{phi:Math.PI/2+t*e*Math.cos(n*i),theta:i+t*Math.sin(2*n*i)}},Tx=function(i){let t=i[0],e=i[1];return new ft(t,e).multiplyScalar(2*Math.PI)},Ex={area:Mx,length:bx,tau:Tl,fromTauCoords:Tx};const vu=[[-.0071202,.96494569],[.64952531,.90215096],[.69303797,.44374942],[.25553797,.93982779],[.34098101,1.26636039],[.26344936,.0146521],[-.1740506,.51073047],[.48259493,.44793574],[-.1131329,.92726885],[.54351265,.86447412],[-.4216772,1.29147829],[.14952531,.90215096],[.05300632,.01883841],[.23496835,1.22868355],[.11392405,.43537679],[.68512658,.04604946],[.77056962,.37258206],[.33306962,.86866043],[.37658227,.4102589],[.46202531,.7367915],[.4375,.82679728],[.52294303,1.15332988],[.00791139,.39769995],[.66455696,.33490522],[.22705696,.8309836],[.27056962,.37258206],[-.1669303,.86866043],[-.0814873,1.19519303],[-.1060126,1.28519881],[.45411392,.33909154],[.5585443,.29722839],[.64398734,.62376098],[.1210443,.79330676],[-.272943,.8309836],[-.1875,1.15751619],[-.2120253,1.24752197],[.46914556,1.09472146],[.34810126,.3014147],[-.045886,.33909154],[.03955696,.66562414],[.01503164,.75562992],[.10047468,1.08216252],[.67167721,.69283519],[-.4224683,1.25170829],[-.2935126,1.11983936],[.2420886,.26373786],[.89873417,.20094313],[.30300632,.68027624],[-.0664556,.6279473],[-.090981,.71795308],[-.0055379,1.04448568],[.12816455,1.15123672],[.53006329,.18838419],[.16060126,.13605524],[.13607594,.22606102],[.22151898,.55259362],[.79272151,.16326629],[-.1115506,1.00680884],[.54509493,.94401411],[.42405063,.15070735],[.03006329,.18838419],[.6431962,.58399099],[.11550632,.51491678],[-.3219936,1.01099516],[.77215189,.45212205],[.33465189,.94820043],[.31012658,1.03820621],[.87025316,.09209893],[.43908227,.90633727],[.97468354,.05023578],[.53718354,.54631415],[.00949367,.47723995],[.62262658,.87284675],[.66613924,.41444522],[.22863924,.91052359],[.10759493,.11721683],[.7642405,.05442209],[.86867088,.01255894],[.4556962,.41863153],[.43117088,.50863731],[.51661392,.83516991],[.12262658,.87284675],[.00158227,.07953999],[.1835443,1.28938513],[.65822784,.01674526],[.34968354,.38095469],[.41060126,.79749307],[-.0268987,1.29357144],[.01661392,.83516991],[.63765822,.30560102],[.11471518,.47514679],[.20015822,.80167939],[.24367088,.34327785],[.3045886,.75981623],[-.1329113,1.2558946],[.52373417,1.19309987],[.53164556,.26792418],[.00870253,.43746995],[.09414556,.76400255],[.13765822,.30560102],[.15506329,1.18054093],[-.2998417,.80167939],[-.2143987,1.12821199],[-.238924,1.21821777],[.41772151,1.15542304],[.42563291,.23024734],[-.011867,.72632571],[-.449367,1.22240408],[.64477848,.66353098],[-.3449367,1.18054093],[.21518987,.23443366],[.87183544,.17163892],[.27610759,.65097203],[.84731012,.26164471],[-.1178797,.68864887],[.49525316,1.08425567],[.53876582,.62585414],[.62420886,.95238674],[.59968354,1.04239252],[.10917721,.19675682],[.08465189,.2867626],[.76582278,.13396209],[.17009493,.6132952],[-.267405,1.10937357],[-.2238924,.65097203],[.3892405,1.04657884],[-.1384493,.97750463],[-.0047468,1.08425567],[.39715189,.12140314],[.00316455,.15907998],[.61629746,.55468678],[.65981012,.09628525],[.72072784,.51282363],[-.3734177,1.07169673],[.30775316,.91889622],[.28322784,1.008902],[.29113924,.0837263],[.94778481,.02093157],[-.1463607,.57980467],[.51028481,.51700994],[.55379746,.05860841],[.11629746,.55468678],[.2017405,.88121938],[.17721518,.97122516],[.26265822,1.29775776],[.73734177,.02511789],[.40427215,.4793331],[.46518987,.89587148],[.09572784,.84354254],[.07120253,.93354832],[.15664556,1.26008092],[.69224683,.40397943],[-.2373417,1.29775776],[.23734177,.02511789],[.32278481,.35165049],[.29825949,.44165627],[.38370253,.76818886],[-.1392405,.93773464],[-.4477848,1.30194407],[.58623417,.36630259],[.19224683,.40397943],[.27768987,.73051203],[-.2452531,.9000578],[-.1598101,1.2265904],[.49683544,1.16379567],[.47231012,1.25380145],[.50474683,.23861997],[-.0181962,.40816574],[.69936708,.76190939],[-.2658227,1.18891356],[.39082278,1.12611883],[.39873417,.20094313],[-.1242088,.3704889],[-.0387658,.6970215],[.5324367,.30769417],[-.0632911,.78702728],[.61787974,.63422677],[.02215189,1.11355988],[.59335443,.72423255],[-.3718354,1.15123672],[.28481012,1.08844199],[.16376582,.29513523],[.82041139,.2323405],[-.1447784,.65934467],[-.1693037,.74935045],[.51186708,.59654993],[.57278481,1.01308831],[.08227848,.16745261],[.17879746,1.05076515],[.05775316,.25745839],[.73892405,.10465788],[.1431962,.58399099],[.71439873,.19466366],[.79984177,.52119626],[.36234177,1.01727463],[.40585443,.5588731],[-.0316455,1.05495147],[-.0237341,.12977577],[-.0482594,.21978155],[.63291139,.06698104],[.69382911,.48351942],[.17088607,.65306519],[.25632911,.97959779],[.29984177,.52119626],[-.1376582,1.01727463],[.2642405,.05442209],[.39794303,.16117314],[.48338607,.48770574],[.52689873,.0293042],[.54430379,.90424411],[.58781645,.44584258],[.15031645,.94192095],[-.2436708,.97959779],[.29193037,.1234963],[.37737341,.4500289],[.43829113,.86656728],[-.0166139,.48770574],[.04430379,.90424411],[.12974683,1.23077671],[.6653481,.37467522],[.27136075,.41235206],[-.1661392,.90843043],[-.1226265,.4500289],[-.0617088,.86656728],[.02373417,1.19309987],[.4738924,.01046578],[.1574367,1.29985092],[.55933544,.33699838],[.12183544,.83307675],[.1653481,.37467522],[.25079113,.70120782],[-.2721518,.87075359],[.82199367,.31188049],[-.2112341,1.28729197],[.4699367,1.13449146],[.44541139,1.22449724],[-.0450949,.37886154],[.01582278,.79539991],[.05933544,.33699838],[.67246835,.73260518],[.14477848,.66353098],[-.2927215,1.15960935],[.27848101,.77028202],[-.3172468,1.24961513],[.36392405,1.09681462],[.24287974,.30350786],[.33939873,1.1868204],[.89952531,.24071313],[-.0901898,.75772308],[.59098101,.60492257],[.56645569,.69492835],[.12895569,1.19100672],[-.3987341,1.12193251],[.25791139,1.05913778],[.13686708,.26583102],[.79351265,.20303629],[-.1716772,.63004046],[.39952531,.24071313],[-.1962025,.72004624],[.48496835,.56724573],[.46044303,.65725151],[.54588607,.98378411],[.02294303,1.15332988],[.15189873,1.02146094],[.03085443,.22815418],[.71202531,.07535367],[.6875,.16535945],[.77294303,.49189205],[.25,.66143782],[.43987341,.94610727],[-.0830696,1.11565304],[.01028481,.51700994],[.58148734,.12768261],[.66693037,.45421521],[.14398734,.62376098],[.22943037,.95029358],[-.1645569,.98797042],[.86946202,.05232894],[.56091772,.41653837],[.03797468,.58608415],[.12341772,.91261674],[.0988924,1.00262253],[-.2705696,.95029358],[.26503164,.09419209],[.44699367,1.30403723],[.35047468,.42072469],[.32594936,.51073047],[.4113924,.83726307],[-.0435126,.45840153],[.01740506,.87493991],[.67405063,.81214518],[.55300632,.01883841],[.15901898,.05651525],[.24446202,.38304785],[.2199367,.47305363],[.30537974,.79958623],[-.1321202,1.2956646],[-.0886075,.83726307],[.52452531,1.23286987],[.56803797,.77446834],[.13053797,1.27054671],[.13844936,.34537101],[.79509493,.28257628],[-.2990506,.84144938],[-.2381329,1.25798776],[-.1946202,.79958623],[.41851265,1.19519303],[.02452531,1.23286987],[.42642405,.27001734],[-.0110759,.76609571],[.56012658,.37676838],[.0324367,.30769417],[.64556962,.70330098],[.68908227,.24489944],[.25158227,.74097781],[-.3441455,1.22031092],[.33702531,1.06751041],[.3125,1.15751619],[.87262658,.21140892],[-.1170886,.72841887],[-.0735759,.27001734],[.53955696,.66562414],[.14556962,.70330098],[.20648734,1.11983936],[.76661392,.17373208],[.37262658,.21140892],[-.2231012,.69074203],[.4335443,.6279473],[.51898734,.9544799],[-.0039556,1.12402567],[.00395569,.19884997],[.66060126,.13605524],[.63607594,.22606102],[.72151898,.55259362],[.26661392,.17373208],[.32753164,.59027046],[.41297468,.91680306],[-.1099683,1.08634883],[.54667721,1.0235541],[.94857594,.06070157],[.5545886,.09837841],[.1170886,.59445678],[.17800632,1.01099516],[-.215981,1.04867199],[.84256329,.02302473],[.40506329,.5191031],[.44857594,.06070157],[.53401898,.38723417],[.01107594,.55677994],[.09651898,.88331254],[.66772151,.49398521],[.07199367,.97331832],[.23813291,.06488788],[.42009493,1.27473302],[.29905063,.48142626],[.34256329,.02302473],[-.0949367,.5191031],[-.0094936,.8456357],[-.0340189,.93564148],[.64715189,.78284097],[-.3425632,1.29985092],[.13212025,.02721104],[.31408227,1.23705619],[.19303797,.44374942],[.87420886,.29094891],[.84968354,.38095469],[.41218354,.87703306],[-.1155063,.80795886],[.49762658,1.20356566],[.54113924,.74516413],[-.017405,.44793574],[.11155063,.31606681],[.08702531,.40607259],[.74367088,.34327785],[.30617088,.83935623],[-.2215189,.77028202],[.39161392,1.16588882],[-.0023734,1.20356566],[-.1234177,.4102589],[.53322784,.34746417],[.00553797,.27838997],[-.3710443,1.19100672],[.72310126,.63213362],[.28560126,1.12821199],[.26107594,1.21821777],[-.108386,1.16588882],[.42721518,.30978733],[.51265822,.63631993],[.48813291,.72632571],[.57357594,1.05285831],[.11867088,.67399677],[.1795886,1.09053515],[.71518987,.23443366],[-.25,.66143782],[.84414556,.10256472],[.32120253,.27211049],[.40664556,.59864309],[.38212025,.68864887],[-.0308544,1.09472146],[.01265822,.63631993],[.07357594,1.05285831],[-.0474683,.25955155],[.63370253,.10675104],[.60917721,.19675682],[.69462025,.52328942],[.30063291,.56096625],[-.136867,1.05704462],[-.0324367,1.01518147],[.52768987,.0690742],[.50316455,.15907998],[.15110759,.98169095],[.72231012,.59236362],[.19462025,.52328942],[-.2428797,1.01936779],[.41376582,.95657306],[.49920886,1.28310565],[.94936708,.10047156],[.42167721,.03139736],[-.0158227,.52747573],[-.0403481,.61748151],[.04509493,.94401411],[.08860759,.48561258],[-.3488924,.98169095],[-.2634493,1.30822355],[.18670886,.12558946],[.27215189,.45212205],[.84335443,.06279473],[-.1218354,.48979889],[.53481012,.42700416],[-.0609177,.90633727],[.59572784,.84354254],[-.369462,1.27054671],[.0806962,.08791262],[.16613924,.41444522],[-.2713607,.91052359],[.82278481,.35165049],[.42879746,.38932732],[.48971518,.8058657],[.05221518,1.30194407],[.06012658,.37676838],[.71677215,.31397365],[.27927215,.81005202],[.34018987,1.2265904],[-.0292721,1.17426146],[-.0537974,1.26426724],[.56724683,.73469834],[.61075949,.27629681],[.69620253,.60282941],[.17325949,.77237518],[.25870253,1.09890778],[.23417721,1.18891356],[.79430379,.24280629],[.92325949,.11093735],[.40031645,.28048312],[-.1954113,.75981623],[.46123417,.6970215],[.06724683,.73469834],[.15268987,1.06123094],[-.3702531,1.23077671],[.03164556,.26792418],[.68829113,.20512945],[.29430379,.24280629],[.37974683,.56933888],[.35522151,.65934467],[.44066455,.98587726],[.57436708,1.09262831],[.04667721,1.0235541],[-.074367,.23024734],[.58227848,.16745261],[.18829113,.20512945],[.27373417,.53166205],[.24920886,.62166783],[-.1637658,1.02774042],[-.1882911,1.1177462],[.46835443,1.05495147],[-.0593354,.98587726],[.50079113,.03976999],[.47626582,.12977577],[.56170886,.45630837],[.03876582,.62585414],[.69541139,.56305941],[.16772151,.49398521],[-.2697784,.99006358],[-.2943037,1.08006936],[.38686708,.92726885],[.26582278,.13396209],[.39477848,.00209315],[.37025316,.09209893],[-.0427215,.49817152],[-.0672468,.5881773],[.0181962,.9147099],[.58939873,.52538257],[.67484177,.85191517],[.28085443,.88959201],[.15981012,.09628525],[.34177215,1.30613039],[.81645569,.03349052],[-.1487341,.46049469],[-.1732594,.55050047],[-.0878164,.87703306],[.56882911,.81423833],[.13132911,1.3103167],[.17484177,.85191517],[.05379746,.05860841],[.23575949,1.26845355],[.1392405,.38514101],[.79588607,.32234628],[.77136075,.41235206],[.40189873,.36002312],[-.1938291,.83935623],[.41930379,1.23496303],[.46281645,.7765615],[.54825949,1.10309409],[.02531645,1.27263987],[-.3686708,1.3103167],[.03322784,.34746417],[.68987341,.28466944],[.25237341,.78074781],[-.3433544,1.26008092],[.31329113,1.19728619],[.35680379,.73888466],[-.0806962,1.23496303],[-.0727848,.30978733],[.5403481,.70539413],[.58386075,.2469926],[.14636075,.74307097],[.20727848,1.15960935],[-.2476265,.78074781],[-.1867088,1.19728619],[.37341772,.25117892],[-.2223101,.73051203],[.3488924,.3411847],[.43433544,.6677173],[.4778481,.20931576],[-.0031645,1.16379567],[.0403481,.70539413],[.12579113,1.03192673],[.69699367,.6425994],[.10126582,1.12193251],[.6613924,.17582524],[.26740506,.21350208],[.32832278,.63004046],[-.1091772,1.12611883],[-.0656645,.6677173],[.54746835,1.0633241],[.01977848,.99424989],[.55537974,.1381484],[.11787974,.63422677],[.1613924,.17582524],[.81803797,.11303051],[.22231012,.59236362],[-.2151898,1.08844199],[.44145569,1.02564726],[.44936708,.10047156],[.01186708,.59654993],[.05537974,.1381484],[.66851265,.5337552],[-.2966772,.96075937],[-.3212025,1.05076515],[.23892405,.10465788],[.33544303,.98797042],[.42088607,1.31450302],[.34335443,.06279473],[-.0941455,.5588731],[.5625,.49607837],[-.0332278,.97541148],[.64794303,.82261096],[.62341772,.91261674],[.13291139,.06698104],[.31487341,1.27682618],[.19382911,.48351942],[-.1147151,.84772886],[.45648734,.45840153],[.54193037,.78493413],[.51740506,.87493991],[.02689873,.0293042],[.20886075,1.23914934],[.08781645,.44584258],[.76898734,.29304207],[.74446202,.38304785],[-.2207278,.81005202],[.43591772,.74725729],[-.0870253,.91680306],[-.0015822,1.24333566],[.1028481,1.2014725],[.66297468,.25536523],[.63844936,.34537101],[.7238924,.67190361],[.20094936,.84144938],[.2863924,1.16798198],[.32990506,.70958045],[-.1075949,1.20565882],[.54905063,1.14286409],[.42800632,.34955733],[-.0996835,.28048312],[.55696202,.21768839],[.03401898,.38723417],[.11946202,.71376676],[.0949367,.80377255],[.18037974,1.13030514],[-.2136075,1.16798198],[.44303797,1.10518725],[.8449367,.14233472],[.32199367,.31188049],[.01344936,.67608993],[.67009493,.6132952],[.07436708,1.09262831],[-.3196202,1.13030514],[.24050632,.18419787],[.21598101,.27420365],[.30142405,.60073625],[-.1360759,1.09681462],[-.0925632,.63841309],[.56408227,.57561836],[.50395569,.19884997],[.13449367,.14652103],[.10996835,.23652681],[.79113924,.0837263],[.19541139,.56305941],[-.2420886,1.05913778],[-.1985759,.60073625],[.41455696,.99634305],[.42246835,.07116736],[.02848101,.10884419],[.08939873,.52538257],[-.3481012,1.02146094],[.7460443,.46258784],[.3085443,.95866621],[.39398734,1.28519881],[.31645569,.03349052],[-.1210443,.52956889],[.53560126,.46677416],[-.0601265,.94610727],[.51107594,.55677994],[.59651898,.88331254],[.64003164,.424911],[.20253164,.92098938],[.28797468,1.24752197],[.73813291,.06488788],[.82357594,.39142048],[.4295886,.42909732],[.49050632,.8456357],[-.4746835,1.27263987],[0,0],[.18196202,1.20984514],[-.0245253,.09000578],[.06091772,.41653837],[.63212025,.02721104],[.71756329,.35374364],[.28006329,.84982201],[.32357594,.39142048],[.40901898,.71795308],[.38449367,.80795886],[-.028481,1.21403145],[-.0530063,1.30403723],[.61155063,.31606681],[.17405063,.81214518],[.21756329,.35374364],[-.2199367,.84982201],[-.1344936,1.17635461],[-.1590189,1.26636039],[.40110759,.32025312],[.50553797,.27838997],[.06803797,.77446834],[.72468354,.71167361],[-.2405063,1.13867777],[-.2650316,1.22868355],[.41613924,1.07588304],[.29509493,.28257628],[.35601265,.69911466],[-.0988924,.32025312],[-.0134493,.64678572],[-.0379746,.7367915],[.04746835,1.0633241],[.61867088,.67399677],[.58306962,.20722261],[-.3465189,1.10100094],[.18908227,.24489944],[.84572784,.18210471],[-.119462,.60910888],[-.1439873,.69911466],[-.0585443,1.02564726],[.59810126,.96285253],[.47705696,.16954577],[.08306962,.20722261],[.16851265,.5337552],[.73971518,.14442788],[.38765822,.96703884],[.36313291,1.05704462],[.4920886,.92517569],[.3710443,.13186893],[-.022943,.16954577],[.59018987,.56515257],[.0625,.49607837],[-.375,.99215674],[.71914556,.43328364],[.19620253,.60282941],[-.3995253,1.08216252],[.28164556,.92936201],[.25712025,1.01936779],[.81724683,.07326051],[.28955696,.00418631],[.92167721,.03139736],[-.1724683,.59027046],[.48417721,.52747573],[.56962025,.85400833],[.17563291,.89168517],[.0545886,.09837841],[.23655063,1.30822355],[.71123417,.03558368],[.31724683,.07326051],[.40268987,.39979311],[-.1930379,.87912622],[.37816455,.48979889],[.46360759,.81633149],[.02610759,1.31240986],[.06962025,.85400833],[.69066455,.32443944],[.29667721,.36211627],[.35759493,.77865465],[-.1653481,.94820043],[-.079905,1.27473302],[-.0363924,.81633149],[-.4738924,1.31240986],[-.0719936,.34955733],[.58465189,.2867626],[.06170886,.45630837],[.14715189,.78284097],[.19066455,.32443944],[.20806962,1.19937935],[-.2468354,.82051781],[-.1859177,1.23705619],[.47072784,1.17426146],[.47863924,.24908576],[-.0443037,.41863153],[.04113924,.74516413],[.69778481,.6823694],[.10205696,1.16170251],[-.2919303,1.19937935],[.36471518,1.13658462],[.2681962,.25327207],[.32911392,.66981045],[-.0648734,.70748729],[.59177215,.64469256],[-.397943,1.16170251],[.16218354,.21559524],[.81882911,.15280051],[.22310126,.63213362],[-.170886,.66981045],[.44224683,1.06541726],[-.085443,.99634305],[.48575949,.60701572],[.57120253,.93354832],[.04825949,1.10309409],[.45015822,.14024156],[.05617088,.1779184],[.66930379,.5735252],[.71281645,.11512367],[.79825949,.44165627],[-.3204113,1.09053515],[.77373417,.53166205],[.33623417,1.02774042],[-.1914556,.95866621],[-.0577531,1.06541726],[.34414556,.10256472],[-.0933544,.59864309],[-.0498417,.14024156],[.56329113,.53584836],[.03560126,.46677416],[.60680379,.07744683],[.25474683,.9000578],[.23022151,.99006358],[.31566455,1.31659618],[.7903481,.04395631],[-.199367,.56096625],[.89477848,.00209315],[.45727848,.49817152],[.5181962,.9147099],[.06329113,.53584836],[.14873417,.86238096],[.12420886,.95238674],[.02768987,.0690742],[.20965189,1.27891934],[.68433544,.00627947],[.74525316,.42281785],[-.1843354,1.31659618],[.37579113,.3704889],[.35126582,.46049469],[.43670886,.78702728],[-.0862341,.95657306],[.04272151,.82470412],[.10363924,1.2412425],[.6392405,.38514101],[.18433544,.00627947],[.26977848,.33281207],[.24525316,.42281785],[.3306962,.74935045],[-.1922468,.91889622],[-.1068037,1.24542882],[.54984177,1.18263409],[.55775316,.25745839],[.03481012,.42700416],[.22468354,.71167361],[-.2982594,.88121938],[-.2128164,1.20775198],[.44382911,1.14495725],[.04984177,1.18263409],[.4517405,.21978155],[-.0712025,.38932732],[.0142405,.71585992],[-.0102848,.8058657],[.67088607,.65306519],[.07515822,1.1323983],[.64636075,.74307097],[-.3188291,1.17007514],[.33781645,1.10728041],[.21677215,.31397365],[.87341772,.25117892],[.34572784,.18210471],[-.0917721,.67818308],[-.1162974,.76818886],[.56487341,.61538835],[-.4248417,1.1323983],[.23180379,1.06960357],[.13528481,.18629103],[.11075949,.27629681],[.79193037,.1234963],[.76740506,.21350208],[-.1977848,.64050625],[.4153481,1.03611305],[.45886075,.57771152],[.51977848,.99424989],[.02927215,.14861419],[.00474683,.23861997],[.68591772,.08581946],[.09018987,.56515257],[.74683544,.50235784],[-.3473101,1.06123094],[.2238924,.67190361],[.30933544,.99843621],[.3528481,.54003468],[-.0846518,1.03611305],[.9738924,.01046578],[.5363924,.50654415],[.57990506,.04814262],[.64082278,.464681],[.20332278,.96075937],[-.1906645,.99843621],[.21123417,.03558368],[.3449367,.14233472],[.43037974,.46886732],[.49129746,.88540569],[.0363924,.50654415],[.09731012,.92308253],[.18275316,1.24961513],[.32436708,.43119048],[.38528481,.84772886],[-.0696202,.46886732],[-.0087025,.88540569],[.0767405,1.21193829],[.21044303,1.31868934],[.61234177,.3558368],[.21835443,.39351364],[-.2191455,.88959201],[-.1582278,1.30613039],[.49841772,1.24333566],[.50632911,.31815996],[.06882911,.81423833],[.11234177,.3558368],[.19778481,.6823694],[-.2397151,1.17844777],[.33148734,.78912044],[-.2642405,1.26845355],[.41693037,1.11565304],[.39240506,1.20565882],[-.0981012,.36002312],[-.0371835,.7765615],[.00632911,.31815996],[.61946202,.71376676],[-.3457278,1.14077093],[.31091772,1.0779762],[.18987341,.28466944],[.84651898,.22187471],[.45253164,.25955155],[-.1431962,.73888466],[.53797468,.58608415],[.51344936,.67608993],[.5988924,1.00262253],[.07594936,1.1721683],[.20490506,1.04029936],[.08386075,.2469926],[.74050632,.18419787],[-.2246835,.61120204],[-.2492088,.70120782],[.43196202,.54840731],[.4074367,.63841309],[.49287974,.96494569],[-.0300632,1.13449146],[.37183544,.17163892],[-.0221518,.20931576],[.65901898,.05651525],[.63449367,.14652103],[.7199367,.47305363],[.19699367,.6425994],[.92246835,.07116736],[.52848101,.10884419],[.61392405,.43537679],[.09098101,.60492257],[.17642405,.93145516],[-.2175632,.969132],[.31803797,.11303051],[.37895569,.52956889],[.50791139,.39769995],[-.0150316,.56724573],[.07041139,.89377833],[.04588607,.98378411],[.60601265,.03767683],[-.3235759,.93145516],[.21202531,.07535367],[.29746835,.40188627],[.27294303,.49189205],[.35838607,.81842465],[-.0965189,.43956311],[-.0356012,.85610149],[.6210443,.79330676],[.5,0],[.10601265,.03767683],[.19145569,.36420943],[.16693037,.45421521],[-.2460443,.8602878],[.84810126,.3014147],[-.1851265,1.27682618],[.38607594,.88749885],[-.1416139,.81842465],[.47151898,1.21403145],[.51503164,.75562992],[.07753164,1.25170829],[.47943037,.28885576],[.61313291,.3956068],[.08544303,.32653259],[.69857594,.7221394],[.7420886,.26373786],[-.2911392,1.23914934],[.36550632,1.17635461],[-.125,.33071891],[-.1495253,.42072469],[-.0640822,.74725729],[.50712025,.35792996],[-.0205696,.28885576],[.59256329,.68446256],[.19857594,.7221394],[-.3971518,1.2014725],[.28401898,1.04867199],[.25949367,1.13867777],[.81962025,.1925705],[-.1700949,.70958045],[.92405063,.15070735],[.48655063,.64678572],[.04905063,1.14286409],[.09256329,.68446256],[.15348101,1.10100094],[.05696202,.21768839],[.71360759,.15489366],[.77452531,.57143204],[.31962025,.1925705],[.38053797,.60910888],[.46598101,.93564148],[-.056962,1.10518725],[-.0490506,.18001156],[.60759493,.11721683],[.21360759,.15489366],[.23101265,1.02983357],[.27452531,.57143204],[.35996835,.89796464],[-.1629746,1.06751041],[.49367088,1.00471568],[.89556962,.04186315],[.45806962,.53794152],[.50158227,.07953999],[.58702531,.40607259],[.06408227,.57561836],[.125,.99215674],[-.244462,.93982779],[-.2689873,1.02983357],[.78955696,.00418631],[.47310126,1.29357144],[.35205696,.50026468],[.39556962,.04186315],[-.0419303,.53794152],[.04351265,.86447412],[.61471518,.47514679],[.01898734,.9544799],[.10443037,1.2810125],[.57911392,.00837263],[-.2895569,1.31868934],[.18512658,.04604946],[.3670886,1.2558946],[.2460443,.46258784],[-.147943,.50026468],[-.0625,.82679728],[.59414556,.76400255],[-.3955696,1.2810125],[.07911392,.00837263],[.16455696,.33490522],[.14003164,.424911],[.82120253,.27211049],[.22547468,.7514436],[-.2974683,.92098938],[.79667721,.36211627],[.35917721,.85819464],[-.1685126,.78912044],[.44462025,1.18472724],[.05063291,1.22240408],[-.0704113,.42909732],[.0585443,.29722839],[-.3180379,1.20984514],[.25316455,.82051781],[.33860759,1.14705041],[-.0553797,1.18472724],[.34651898,.22187471],[.48022151,.32862575],[.56566455,.65515835],[.17167721,.69283519],[-.4240506,1.1721683],[.23259493,1.10937357],[-.2903481,1.27891934],[.7681962,.25327207],[-.1613924,1.14705041],[-.1969936,.68027624],[.89715189,.12140314],[.37420886,.29094891],[.45965189,.61748151],[.43512658,.70748729],[.52056962,1.03401989],[.06566455,.65515835],[.12658227,1.07169673],[.68670886,.12558946],[.66218354,.21559524],[.74762658,.54212783],[.29272151,.16326629],[.35363924,.57980467],[-.0838607,1.07588304],[.02056962,1.03401989],[.5806962,.08791262],[.55617088,.1779184],[.64161392,.504451],[.20411392,1.00052937],[.24762658,.54212783],[-.1898734,1.03820621],[.46677215,.97541148],[.47468354,.05023578],[.03718354,.54631415],[.09810126,.96285253],[.14161392,.504451],[-.295886,1.00052937],[.36075949,.93773464],[.44620253,1.26426724],[.23971518,.14442788],[.32515822,.47096047],[.89636075,.08163314],[.36867088,.01255894],[-.0688291,.50863731],[-.0079113,.92517569],[.67325949,.77237518],[.64873417,.86238096],[-.3164556,1.28938513],[.15822784,.01674526],[.13370253,.10675104],[.21914556,.43328364],[-.2183544,.92936201],[-.1748417,.47096047],[-.0893987,.79749307],[.48180379,.40816574],[-.113924,.88749885],[.54272151,.82470412],[.10522151,1.32078249],[.11313291,.3956068],[-.324367,.89168517],[.76977848,.33281207],[.33227848,.82889044],[.3931962,1.24542882],[.52215189,1.11355988],[-7911e-7,1.28310565],[-.0973101,.39979311],[.00712025,.35792996],[.62025316,.75353676],[.66376582,.29513523],[.74920886,.62166783],[.22626582,.7912136],[.31170886,1.1177462],[.28718354,1.20775198],[-.0822784,1.15542304],[.45332278,.29932154],[-.142405,.77865465],[.5142405,.71585992],[.12025316,.75353676],[.2056962,1.08006936],[.18117088,1.17007514],[.74129746,.22396787],[.34731012,.26164471],[-.2484177,.74097781],[.43275316,.5881773],[.40822784,.67818308],[.09968354,1.04239252],[-.4232594,1.21193829],[-.0213607,.24908576],[.63528481,.18629103],[.24129746,.22396787],[.3267405,.55050047],[.30221518,.64050625],[-.1107594,1.04657884],[-.1352848,1.13658462],[.52136075,1.07378989],[-.0063291,1.00471568],[.52927215,.14861419],[.09177215,.64469256],[.74841772,.58189783],[.22072784,.51282363],[-.2167721,1.008902],[-.2412974,1.09890778],[.31882911,.15280051],[-.1123417,.96703884],[.44778481,.02093157],[.42325949,.11093735],[.50870253,.43746995],[-.0142405,.60701572],[.64240506,.54422099],[-.3227848,.97122516],[.33386075,.90843043],[.21281645,.11512367],[-.0957278,.4793331],[-.1202531,.56933888],[-.0348101,.89587148],[.62183544,.83307675],[.59731012,.92308253],[.2278481,.87075359],[.10680379,.07744683],[.28876582,1.28729197],[.76344936,.0146521],[.8488924,.3411847],[.82436708,.43119048],[.45490506,.37886154],[-.1408227,.85819464],[.51582278,.79539991],[.07832278,1.29147829],[79113e-8,.03976999],[.08623417,.36630259],[.74287974,.30350786],[.71835443,.39351364],[.36629746,1.21612461],[.40981012,.75772308],[-.0276898,1.25380145],[-.0197784,.32862575],[.63686708,.26583102],[.19936708,.76190939],[-.3963607,1.2412425],[.26028481,1.17844777],[.30379746,.72004624],[-.1337025,1.21612461],[.92484177,.19047734],[.48734177,.68655571],[.53085443,.22815418],[.09335443,.72423255],[.15427215,1.14077093],[.32041139,.2323405],[.29588607,.32234628],[.38132911,.64887888],[.42484177,.19047734],[-.0561708,1.14495725],[-.0126582,.68655571],[.07278481,1.01308831],[.60838607,.15698682],[.21439873,.19466366],[.8710443,.13186893],[.27531645,.61120204],[-.1621835,1.10728041],[-.1186708,.64887888],[.49446202,1.04448568],[.50237341,.11930998],[.06487341,.61538835],[.10838607,.15698682],[.76503164,.09419209],[.16930379,.5735252],[-.2681962,1.06960357],[.38844936,1.00680884],[.39636075,.08163314],[-.0411392,.57771152],[.00237341,.11930998],[.61550632,.51491678],[-.3496835,.94192095],[-.3742088,1.03192673],[.30696202,.87912622],[.2824367,.969132],[.18591772,.08581946],[.36787974,1.2956646],[.24683544,.50235784],[.2903481,.04395631],[-.1471518,.54003468],[.50949367,.47723995],[.5949367,.80377255],[.57041139,.89377833],[-.3947784,1.32078249],[.07990506,.04814262],[.26186708,1.25798776],[.14082278,.464681],[.79746835,.40188627],[-.1677215,.82889044],[.40348101,.43956311],[.48892405,.76609571],[.46439873,.85610149],[.05142405,1.26217408],[.15585443,1.22031092],[.71598101,.27420365],[.69145569,.36420943],[.25395569,.8602878],[-.2737341,.7912136],[.38291139,.72841887],[-.1400316,.89796464],[-.0545886,1.22449724],[-.0791139,1.31450302],[.48101265,.36839575],[-.4485759,1.26217408],[-.0466772,.29932154],[.60996835,.23652681],[.58544303,.32653259],[.17246835,.73260518],[.14794303,.82261096],[.23338607,1.14914356],[.27689873,.69074203],[-.1606012,1.1868204],[.4960443,1.12402567],[.89794303,.16117314],[.375,.33071891],[-.0189873,.36839575],[.06645569,.69492835],[.04193037,.78493413],[.12737341,1.11146672],[-.2666139,1.14914356],[.39003164,1.08634883],[.29351265,.20303629],[.26898734,.29304207],[.35443037,.61957467],[-.0395569,.65725151],[.6170886,.59445678],[.02136075,1.07378989],[-.3726265,1.11146672],[.1875,.16535945],[.16297468,.25536523],[.24841772,.58189783],[-.2745253,.7514436],[-.1890822,1.0779762],[-.1455696,.61957467],[.46756329,1.01518147],[.57199367,.97331832],[.47547468,.09000578],[.45094936,.18001156],[.08148734,.12768261],[.14240506,.54422099],[.79905063,.48142626],[-.2950949,1.04029936],[.36155063,.97750463],[.36946202,.05232894],[-.0680379,.54840731],[.58860759,.48561258]],kn=new ku;let sl=new yx(Sx,Ex),wx=sl.getSurface(16777215,!0);kn.add(wx);let ph=new ts;kn.add(ph);for(let i=0;i<vu.length;i++){let t=sl.fromTauCoords(vu[i]);ph.add(sl.getPoint(t,vx.medium,.035))}let ke=new lx(16777215);ke.position.set(2,6,0);ke.angle=Math.PI/2;ke.decay=0;ke.penumbra=1;ke.distance=0;ke.intensity=5;ke.radius=.5;ke.shadow.mapSize.width=512;ke.shadow.mapSize.height=512;ke.shadow.camera.near=.1;ke.shadow.camera.far=10;ke.shadow.focus=1;ke.castShadow=!0;kn.add(ke);const aa=ke.target;aa.position.x=1;aa.position.y=0;aa.position.z=.05;kn.add(aa);const mh=new Ae(new ys(100,.1,100),new Vu({color:16777215,clearcoat:1,roughness:.5,metalness:0}));mh.position.set(-1,-4,-1);kn.add(mh);const Xs=new dh;Xs.bottomColor.set(16777215);Xs.bottomColor.set(6710886);Xs.update();kn.environment=Xs;kn.background=Xs;const Mi=new Le;Mi.position.set(.1,10,-.1);Mi.lookAt(0,0,0);let bi=new t_({preserveDrawingBuffer:!0});bi.toneMapping=Mu;document.body.appendChild(bi.domElement);let Ti=new ox(bi);Ti.setScene(kn,Mi);Ti.renderScale=Math.max(1/window.devicePixelRatio,.5);Ti.tiles.setScalar(3);Ti.bounces=30;function Ax(i){const t=new Date;let e=t.getDate(),n=t.getMonth()+1,s=t.getHours(),r=t.getMinutes(),a=document.createElement("a");a.download=`pathtrace ${n}-${e}-${s}${r}.png`,a.href=i.toDataURL("image/png"),a.click()}const Rx=new Sl().close();let Cx={saveit:()=>Ax(bi.domElement)};Rx.add(Cx,"saveit");let El=new n_(Mi,bi.domElement);El.target.set(0,.33,-.08);El.addEventListener("change",()=>Ti.updateCamera());El.update();_h();gh();window.addEventListener("resize",_h);function gh(){requestAnimationFrame(gh),Ti.renderSample()}function _h(){const i=window.innerWidth,t=window.innerHeight;bi.setSize(i,t),bi.setPixelRatio(window.devicePixelRatio);const e=i/t;Mi.aspect=e,Mi.updateProjectionMatrix(),Ti.setScene(kn,Mi)}
