...
`;class e1 extends Ml{onBeforeRender(){this.setDefine("FEATURE_DOF",this.physicalCamera.bokehSize===0?0:1),this.setDefine("FEATURE_BACKGROUND_MAP",this.backgroundMap?1:0),this.setDefine("FEATURE_FOG",this.materials.features.isUsed("FOG")?1:0)}constructor(t){super({transparent:!0,depthWrite:!1,defines:{FEATURE_MIS:1,FEATURE_RUSSIAN_ROULETTE:1,FEATURE_DOF:1,FEATURE_BACKGROUND_MAP:0,FEATURE_FOG:1,RANDOM_TYPE:2,CAMERA_TYPE:0,DEBUG_MODE:0,ATTR_NORMAL:0,ATTR_TANGENT:1,ATTR_UV:2,ATTR_COLOR:3},uniforms:{resolution:{value:new ft},opacity:{value:1},bounces:{value:10},transmissiveBounces:{value:10},filterGlossyFactor:{value:0},physicalCamera:{value:new Zv},cameraWorldMatrix:{value:new Ut},invProjectionMatrix:{value:new Ut},bvh:{value:new _v},attributesArray:{value:new cx},materialIndexAttribute:{value:new rh},materials:{value:new mx},textures:{value:new ru().texture},lights:{value:new ox},iesProfiles:{value:new ru(360,180,{type:Fe,wrapS:Ne,wrapT:Ne}).texture},environmentIntensity:{value:1},environmentRotation:{value:new Ut},envMapInfo:{value:new tx},backgroundBlur:{value:0},backgroundMap:{value:null},backgroundAlpha:{value:1},backgroundIntensity:{value:1},backgroundRotation:{value:new Ut},seed:{value:0},sobolTexture:{value:null},stratifiedTexture:{value:new Sx},stratifiedOffsetTexture:{value:new Cx(64,1)}},vertexShader:`
			...
			`}),this.setValues(t)}}class r1 extends un{constructor(){super({uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:`
				varying vec2 vUv;
				void main() {
				...
				}`}),this.depthWrite=!1,this.depthTest=!1}}class fu{constructor(t){this._renderer=t,this._quad=new vs(new r1)}generate(t,e=null,n=null){if(!t.isCubeTexture)throw new Error("CubeToEquirectMaterial: Source can only be cube textures.");const s=t.images[0],r=this._renderer,a=this._quad;e===null&&(e=4*s.height),n===null&&(n=2*s.height);const o=new Ze(e,n,{type:ne,colorSpace:s.colorSpace}),l=s.height,u=Math.log2(l)-2,h=1/l,f=1/(3*Math.max(Math.pow(2,u),7*16));a.material.defines.CUBEUV_MAX_MIP=`${u}.0`,a.material.defines.CUBEUV_TEXEL_WIDTH=f,a.material.defines.CUBEUV_TEXEL_HEIGHT=h,a.material.uniforms.envMap.value=t,a.material.uniforms.flipEnvMap.value=t.isRenderTargetTexture?1:-1,a.material.needsUpdate=!0;const c=r.getRenderTarget(),m=r.autoClear;r.autoClear=!0,r.setRenderTarget(o),a.render(r),r.setRenderTarget(c),r.autoClear=m;const g=new Uint16Array(e*n*4),_=new Float32Array(e*n*4);r.readRenderTargetPixels(o,0,0,e,n,_),o.dispose();for(let p=0,x=_.length;p<x;p++)g[p]=Fn.toHalfFloat(_[p]);const d=new ln(g,e,n,Zt,Fe);return d.minFilter=tf,d.magFilter=fe,d.wrapS=vn,d.wrapT=vn,d.mapping=Hs,d.needsUpdate=!0,d}dispose(){this._quad.dispose()}}function a1(i){return i.extensions.get("EXT_float_blend")}const ji=new ft;class o1{get multipleImportanceSampling(){return!!this._pathTracer.material.defines.FEATURE_MIS}set multipleImportanceSampling(t){this._pathTracer.material.setDefine("FEATURE_MIS",t?1:0)}get transmissiveBounces(){return this._pathTracer.material.transmissiveBounces}set transmissiveBounces(t){this._pathTracer.material.transmissiveBounces=t}get bounces(){return this._pathTracer.material.bounces}set bounces(t){this._pathTracer.material.bounces=t}get filterGlossyFactor(){return this._pathTracer.material.filterGlossyFactor}set filterGlossyFactor(t){this._pathTracer.material.filterGlossyFactor=t}get samples(){return this._pathTracer.samples}get target(){return this._pathTracer.target}get tiles(){return this._pathTracer.tiles}get stableNoise(){return this._pathTracer.stableNoise}set stableNoise(t){this._pathTracer.stableNoise=t}get isCompiling(){return!!this._pathTracer.isCompiling}constructor(t){this._renderer=t,this._generator=new Hv,this._pathTracer=new cu(t),this._queueReset=!1,this._clock=new gd,this._compilePromise=null,this._lowResPathTracer=new cu(t),this._lowResPathTracer.tiles.set(1,1),this._quad=new vs(new s1({map:null,transparent:!0,blending:Ke,premultipliedAlpha:t.getContextAttributes().premultipliedAlpha})),this._materials=null,this._previousEnvironment=null,this._previousBackground=null,this._internalBackground=null,this.renderDelay=100,this.minSamples=5,this.fadeDuration=500,this.enablePathTracing=!0,this.pausePathTracing=!1,this.dynamicLowRes=!1,this.lowResScale=.25,this.renderScale=1,this.synchronizeRenderSize=!0,this.rasterizeScene=!0,this.renderToCanvas=!0,this.textureSize=new ft(1024,1024),this.rasterizeSceneCallback=(e,n)=>{this._renderer.render(e,n)},this.renderToCanvasCallback=(e,n,s)=>{const r=n.autoClear;n.autoClear=!1,s.render(n),n.autoClear=r},this.setScene(new ku,new Le)}setBVHWorker(t){this._generator.setBVHWorker(t)}setScene(t,e,n={}){t.updateMatrixWorld(!0),e.updateMatrixWorld();const s=this._generator;if(s.setObjects(t),this._buildAsync)return s.generateAsync(n.onProgress).then(r=>this._updateFromResults(t,e,r));{const r=s.generate();return this._updateFromResults(t,e,r)}}setSceneAsync(...t){this._buildAsync=!0;const e=this.setScene(...t);return this._buildAsync=!1,e}setCamera(t){this.camera=t,this.updateCamera()}updateCamera(){const t=this.camera;t.updateMatrixWorld(),this._pathTracer.setCamera(t),this._lowResPathTracer.setCamera(t),this.reset()}updateMaterials(){const t=this._pathTracer.material,e=this._renderer,n=this._materials,s=this.textureSize,r=fx(n);t.textures.setTextures(e,r,s.x,s.y),t.materials.updateFrom(n,r),this.reset()}updateLights(){const t=this.scene,e=this._renderer,n=this._pathTracer.material,s=dx(t),r=hx(s);n.lights.updateFrom(s,r),n.iesProfiles.setTextures(e,r),this.reset()}updateEnvironment(){const t=this.scene,e=this._pathTracer.material;if(this._internalBackground&&(this._internalBackground.dispose(),this._internalBackground=null),e.backgroundBlur=t.backgroundBlurriness,e.backgroundIntensity=t.backgroundIntensity??1,e.backgroundRotation.makeRotationFromEuler(t.backgroundRotation).invert(),t.background===null)e.backgroundMap=null,e.backgroundAlpha=0;else if(t.background.isColor){this._colorBackground=this._colorBackground||new dh(16);const n=this._colorBackground;n.topColor.equals(t.background)||(n.topColor.set(t.background),n.bottomColor.set(t.background),n.update()),e.backgroundMap=n,e.backgroundAlpha=1}else if(t.background.isCubeTexture){if(t.background!==this._previousBackground){const n=new fu(this._renderer).generate(t.background);this._internalBackground=n,e.backgroundMap=n,e.backgroundAlpha=1}}else e.backgroundMap=t.background,e.backgroundAlpha=1;if(e.environmentIntensity=t.environmentIntensity??1,e.environmentRotation.makeRotationFromEuler(t.environmentRotation).invert(),this._previousEnvironment!==t.environment)if(t.environment!==null)if(t.environment.isCubeTexture){const n=new fu(this._renderer).generate(t.environment);e.envMapInfo.updateFrom(n)}else e.envMapInfo.updateFrom(t.environment);else e.environmentIntensity=0;this._previousEnvironment=t.environment,this._previousBackground=t.background,this.reset()}_updateFromResults(t,e,n){const{materials:s,geometry:r,bvh:a,bvhChanged:o}=n;this._materials=s;const u=this._pathTracer.material;return o&&(u.bvh.updateFrom(a),u.attributesArray.updateFrom(r.attributes.normal,r.attributes.tangent,r.attributes.uv,r.attributes.color),u.materialIndexAttribute.updateFrom(r.attributes.materialIndex)),this._previousScene=t,this.scene=t,this.camera=e,this.updateCamera(),this.updateMaterials(),this.updateEnvironment(),this.updateLights(),n}renderSample(){const t=this._lowResPathTracer,e=this._pathTracer,n=this._renderer,s=this._clock,r=this._quad;this._updateScale(),this._queueReset&&(e.reset(),t.reset(),this._queueReset=!1,r.material.opacity=0,s.start());const a=s.getDelta()*1e3,o=s.getElapsedTime()*1e3;if(!this.pausePathTracing&&this.enablePathTracing&&this.renderDelay<=o&&!this.isCompiling&&e.update(),e.alpha=e.material.backgroundAlpha!==1||!a1(n),t.alpha=e.alpha,this.renderToCanvas){const l=this._renderer,u=this.minSamples;if(o>=this.renderDelay&&this.samples>=this.minSamples&&(this.fadeDuration!==0?r.material.opacity=Math.min(r.material.opacity+a/this.fadeDuration,1):r.material.opacity=1),!this.enablePathTracing||this.samples<u||r.material.opacity<1){if(this.dynamicLowRes&&!this.isCompiling){t.samples<1&&(t.material=e.material,t.update());const h=r.material.opacity;r.material.opacity=1-r.material.opacity,r.material.map=t.target.texture,r.render(l),r.material.opacity=h}(!this.dynamicLowRes&&this.rasterizeScene||this.dynamicLowRes&&this.isCompiling)&&this.rasterizeSceneCallback(this.scene,this.camera)}this.enablePathTracing&&r.material.opacity>0&&(r.material.opacity<1&&(r.material.blending=this.dynamicLowRes?so:Jn),r.material.map=e.target.texture,this.renderToCanvasCallback(e.target,l,r),r.material.blending=Ke)}}reset(){this._queueReset=!0,this._pathTracer.samples=0}dispose(){this._renderQuad.dispose(),this._renderQuad.material.dispose(),this._pathTracer.dispose()}_updateScale(){if(this.synchronizeRenderSize){this._renderer.getDrawingBufferSize(ji);const t=Math.floor(this.renderScale*ji.x),e=Math.floor(this.renderScale*ji.y);if(this._pathTracer.getSize(ji),ji.x!==t||ji.y!==e){const n=this.lowResScale;this._pathTracer.setSize(t,e),this._lowResPathTracer.setSize(Math.floor(t*n),Math.floor(e*n))}}}}class l1 extends pd{constructor(...t){super(...t),this.iesMap=null,this.radius=0}copy(t,e){return super.copy(t,e),this.iesMap=t.iesMap,this.radius=t.radius,this}}/**
 * lil-gui
 * https://lil-gui.georgealways.com
 * @version 0.17.0
 * @author George Michael Brower
 * @license MIT
 */class Sn{constructor(t,e,n,s,r="div"){this.parent=t,this.object=e,this.property=n,this._disabled=!1,this._hidden=!1,this.initialValue=this.getValue(),this.domElement=document.createElement("div"),this.domElement.classList.add("controller"),this.domElement.classList.add(s),this.$name=document.createElement("div"),this.$name.classList.add("name"),Sn.nextNameID=Sn.nextNameID||0,this.$name.id="lil-gui-name-"+ ++Sn.nextNameID,this.$widget=document.createElement(r),this.$widget.classList.add("widget"),this.$disable=this.$widget,this.domElement.appendChild(this.$name),this.domElement.appendChild(this.$widget),this.parent.children.push(this),this.parent.controllers.push(this),this.parent.$children.appendChild(this.domElement),this._listenCallback=this._listenCallback.bind(this),this.name(n)}name(t){return this._name=t,this.$name.innerHTML=t,this}onChange(t){return this._onChange=t,this}_callOnChange(){this.parent._callOnChange(this),this._onChange!==void 0&&this._onChange.call(this,this.getValue()),this._changed=!0}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(){this._changed&&(this.parent._callOnFinishChange(this),this._onFinishChange!==void 0&&this._onFinishChange.call(this,this.getValue())),this._changed=!1}reset(){return this.setValue(this.initialValue),this._callOnFinishChange(),this}enable(t=!0){return this.disable(!t)}disable(t=!0){return t===this._disabled||(this._disabled=t,this.domElement.classList.toggle("disabled",t),this.$disable.toggleAttribute("disabled",t)),this}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}options(t){const e=this.parent.add(this.object,this.property,t);return e.name(this._name),this.destroy(),e}min(t){return this}max(t){return this}step(t){return this}decimals(t){return this}listen(t=!0){return this._listening=t,this._listenCallbackID!==void 0&&(cancelAnimationFrame(this._listenCallbackID),this._listenCallbackID=void 0),this._listening&&this._listenCallback(),this}_listenCallback(){this._listenCallbackID=requestAnimationFrame(this._listenCallback);const t=this.save();t!==this._listenPrevValue&&this.updateDisplay(),this._listenPrevValue=t}getValue(){return this.object[this.property]}setValue(t){return this.object[this.property]=t,this._callOnChange(),this.updateDisplay(),this}updateDisplay(){return this}load(t){return this.setValue(t),this._callOnFinishChange(),this}save(){return this.getValue()}destroy(){this.listen(!1),this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.controllers.splice(this.parent.controllers.indexOf(this),1),this.parent.$children.removeChild(this.domElement)}}class c1 extends Sn{constructor(t,e,n){super(t,e,n,"boolean","label"),this.$input=document.createElement("input"),this.$input.setAttribute("type","checkbox"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$input.addEventListener("change",()=>{this.setValue(this.$input.checked),this._callOnFinishChange()}),this.$disable=this.$input,this.updateDisplay()}updateDisplay(){return this.$input.checked=this.getValue(),this}}function il(i){let t,e;return(t=i.match(/(#|0x)?([a-f0-9]{6})/i))?e=t[2]:(t=i.match(/rgb\(\s*(\d*)\s*,\s*(\d*)\s*,\s*(\d*)\s*\)/))?e=parseInt(t[1]).toString(16).padStart(2,0)+parseInt(t[2]).toString(16).padStart(2,0)+parseInt(t[3]).toString(16).padStart(2,0):(t=i.match(/^#?([a-f0-9])([a-f0-9])([a-f0-9])$/i))&&(e=t[1]+t[1]+t[2]+t[2]+t[3]+t[3]),!!e&&"#"+e}const u1={isPrimitive:!0,match:i=>typeof i=="string",fromHexString:il,toHexString:il},Vs={isPrimitive:!0,match:i=>typeof i=="number",fromHexString:i=>parseInt(i.substring(1),16),toHexString:i=>"#"+i.toString(16).padStart(6,0)},h1={isPrimitive:!1,match:Array.isArray,fromHexString(i,t,e=1){const n=Vs.fromHexString(i);t[0]=(n>>16&255)/255*e,t[1]=(n>>8&255)/255*e,t[2]=(255&n)/255*e},toHexString:([i,t,e],n=1)=>Vs.toHexString(i*(n=255/n)<<16^t*n<<8^e*n<<0)},f1={isPrimitive:!1,match:i=>Object(i)===i,fromHexString(i,t,e=1){const n=Vs.fromHexString(i);t.r=(n>>16&255)/255*e,t.g=(n>>8&255)/255*e,t.b=(255&n)/255*e},toHexString:({r:i,g:t,b:e},n=1)=>Vs.toHexString(i*(n=255/n)<<16^t*n<<8^e*n<<0)},d1=[u1,Vs,h1,f1];class p1 extends Sn{constructor(t,e,n,s){var r;super(t,e,n,"color"),this.$input=document.createElement("input"),this.$input.setAttribute("type","color"),this.$input.setAttribute("tabindex",-1),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$text=document.createElement("input"),this.$text.setAttribute("type","text"),this.$text.setAttribute("spellcheck","false"),this.$text.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$display.appendChild(this.$input),this.$widget.appendChild(this.$display),this.$widget.appendChild(this.$text),this._format=(r=this.initialValue,d1.find(a=>a.match(r))),this._rgbScale=s,this._initialValueHexString=this.save(),this._textFocused=!1,this.$input.addEventListener("input",()=>{this._setValueFromHexString(this.$input.value)}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$text.addEventListener("input",()=>{const a=il(this.$text.value);a&&this._setValueFromHexString(a)}),this.$text.addEventListener("focus",()=>{this._textFocused=!0,this.$text.select()}),this.$text.addEventListener("blur",()=>{this._textFocused=!1,this.updateDisplay(),this._callOnFinishChange()}),this.$disable=this.$text,this.updateDisplay()}reset(){return this._setValueFromHexString(this._initialValueHexString),this}_setValueFromHexString(t){if(this._format.isPrimitive){const e=this._format.fromHexString(t);this.setValue(e)}else this._format.fromHexString(t,this.getValue(),this._rgbScale),this._callOnChange(),this.updateDisplay()}save(){return this._format.toHexString(this.getValue(),this._rgbScale)}load(t){return this._setValueFromHexString(t),this._callOnFinishChange(),this}updateDisplay(){return this.$input.value=this._format.toHexString(this.getValue(),this._rgbScale),this._textFocused||(this.$text.value=this.$input.value.substring(1)),this.$display.style.backgroundColor=this.$input.value,this}}class io extends Sn{constructor(t,e,n){super(t,e,n,"function"),this.$button=document.createElement("button"),this.$button.appendChild(this.$name),this.$widget.appendChild(this.$button),this.$button.addEventListener("click",s=>{s.preventDefault(),this.getValue().call(this.object)}),this.$button.addEventListener("touchstart",()=>{},{passive:!0}),this.$disable=this.$button}}class m1 extends Sn{constructor(t,e,n,s,r,a){super(t,e,n,"number"),this._initInput(),this.min(s),this.max(r);const o=a!==void 0;this.step(o?a:this._getImplicitStep(),o),this.updateDisplay()}decimals(t){return this._decimals=t,this.updateDisplay(),this}min(t){return this._min=t,this._onUpdateMinMax(),this}max(t){return this._max=t,this._onUpdateMinMax(),this}step(t,e=!0){return this._step=t,this._stepExplicit=e,this}updateDisplay(){const t=this.getValue();if(this._hasSlider){let e=(t-this._min)/(this._max-this._min);e=Math.max(0,Math.min(e,1)),this.$fill.style.width=100*e+"%"}return this._inputFocused||(this.$input.value=this._decimals===void 0?t:t.toFixed(this._decimals)),this}_initInput(){this.$input=document.createElement("input"),this.$input.setAttribute("type","number"),this.$input.setAttribute("step","any"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$disable=this.$input;const t=h=>{const f=parseFloat(this.$input.value);isNaN(f)||(this._snapClampSetValue(f+h),this.$input.value=this.getValue())};let e,n,s,r,a,o=!1;const l=h=>{if(o){const f=h.clientX-e,c=h.clientY-n;Math.abs(c)>5?(h.preventDefault(),this.$input.blur(),o=!1,this._setDraggingStyle(!0,"vertical")):Math.abs(f)>5&&u()}if(!o){const f=h.clientY-s;a-=f*this._step*this._arrowKeyMultiplier(h),r+a>this._max?a=this._max-r:r+a<this._min&&(a=this._min-r),this._snapClampSetValue(r+a)}s=h.clientY},u=()=>{this._setDraggingStyle(!1,"vertical"),this._callOnFinishChange(),window.removeEventListener("mousemove",l),window.removeEventListener("mouseup",u)};this.$input.addEventListener("input",()=>{let h=parseFloat(this.$input.value);isNaN(h)||(this._stepExplicit&&(h=this._snap(h)),this.setValue(this._clamp(h)))}),this.$input.addEventListener("keydown",h=>{h.code==="Enter"&&this.$input.blur(),h.code==="ArrowUp"&&(h.preventDefault(),t(this._step*this._arrowKeyMultiplier(h))),h.code==="ArrowDown"&&(h.preventDefault(),t(this._step*this._arrowKeyMultiplier(h)*-1))}),this.$input.addEventListener("wheel",h=>{this._inputFocused&&(h.preventDefault(),t(this._step*this._normalizeMouseWheel(h)))},{passive:!1}),this.$input.addEventListener("mousedown",h=>{e=h.clientX,n=s=h.clientY,o=!0,r=this.getValue(),a=0,window.addEventListener("mousemove",l),window.addEventListener("mouseup",u)}),this.$input.addEventListener("focus",()=>{this._inputFocused=!0}),this.$input.addEventListener("blur",()=>{this._inputFocused=!1,this.updateDisplay(),this._callOnFinishChange()})}_initSlider(){this._hasSlider=!0,this.$slider=document.createElement("div"),this.$slider.classList.add("slider"),this.$fill=document.createElement("div"),this.$fill.classList.add("fill"),this.$slider.appendChild(this.$fill),this.$widget.insertBefore(this.$slider,this.$input),this.domElement.classList.add("hasSlider");const t=c=>{const m=this.$slider.getBoundingClientRect();let g=(_=c,d=m.left,p=m.right,x=this._min,y=this._max,(_-d)/(p-d)*(y-x)+x);var _,d,p,x,y;this._snapClampSetValue(g)},e=c=>{t(c.clientX)},n=()=>{this._callOnFinishChange(),this._setDraggingStyle(!1),window.removeEventListener("mousemove",e),window.removeEventListener("mouseup",n)};let s,r,a=!1;const o=c=>{c.preventDefault(),this._setDraggingStyle(!0),t(c.touches[0].clientX),a=!1},l=c=>{if(a){const m=c.touches[0].clientX-s,g=c.touches[0].clientY-r;Math.abs(m)>Math.abs(g)?o(c):(window.removeEventListener("touchmove",l),window.removeEventListener("touchend",u))}else c.preventDefault(),t(c.touches[0].clientX)},u=()=>{this._callOnFinishChange(),this._setDraggingStyle(!1),window.removeEventListener("touchmove",l),window.removeEventListener("touchend",u)},h=this._callOnFinishChange.bind(this);let f;this.$slider.addEventListener("mousedown",c=>{this._setDraggingStyle(!0),t(c.clientX),window.addEventListener("mousemove",e),window.addEventListener("mouseup",n)}),this.$slider.addEventListener("touchstart",c=>{c.touches.length>1||(this._hasScrollBar?(s=c.touches[0].clientX,r=c.touches[0].clientY,a=!0):o(c),window.addEventListener("touchmove",l,{passive:!1}),window.addEventListener("touchend",u))},{passive:!1}),this.$slider.addEventListener("wheel",c=>{if(Math.abs(c.deltaX)<Math.abs(c.deltaY)&&this._hasScrollBar)return;c.preventDefault();const m=this._normalizeMouseWheel(c)*this._step;this._snapClampSetValue(this.getValue()+m),this.$input.value=this.getValue(),clearTimeout(f),f=setTimeout(h,400)},{passive:!1})}_setDraggingStyle(t,e="horizontal"){this.$slider&&this.$slider.classList.toggle("active",t),document.body.classList.toggle("lil-gui-dragging",t),document.body.classList.toggle("lil-gui-"+e,t)}_getImplicitStep(){return this._hasMin&&this._hasMax?(this._max-this._min)/1e3:.1}_onUpdateMinMax(){!this._hasSlider&&this._hasMin&&this._hasMax&&(this._stepExplicit||this.step(this._getImplicitStep(),!1),this._initSlider(),this.updateDisplay())}_normalizeMouseWheel(t){let{deltaX:e,deltaY:n}=t;return Math.floor(t.deltaY)!==t.deltaY&&t.wheelDelta&&(e=0,n=-t.wheelDelta/120,n*=this._stepExplicit?1:10),e+-n}_arrowKeyMultiplier(t){let e=this._stepExplicit?1:10;return t.shiftKey?e*=10:t.altKey&&(e/=10),e}_snap(t){const e=Math.round(t/this._step)*this._step;return parseFloat(e.toPrecision(15))}_clamp(t){return t<this._min&&(t=this._min),t>this._max&&(t=this._max),t}_snapClampSetValue(t){this.setValue(this._clamp(this._snap(t)))}get _hasScrollBar(){const t=this.parent.root.$children;return t.scrollHeight>t.clientHeight}get _hasMin(){return this._min!==void 0}get _hasMax(){return this._max!==void 0}}class g1 extends Sn{constructor(t,e,n,s){super(t,e,n,"option"),this.$select=document.createElement("select"),this.$select.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this._values=Array.isArray(s)?s:Object.values(s),this._names=Array.isArray(s)?s:Object.keys(s),this._names.forEach(r=>{const a=document.createElement("option");a.innerHTML=r,this.$select.appendChild(a)}),this.$select.addEventListener("change",()=>{this.setValue(this._values[this.$select.selectedIndex]),this._callOnFinishChange()}),this.$select.addEventListener("focus",()=>{this.$display.classList.add("focus")}),this.$select.addEventListener("blur",()=>{this.$display.classList.remove("focus")}),this.$widget.appendChild(this.$select),this.$widget.appendChild(this.$display),this.$disable=this.$select,this.updateDisplay()}updateDisplay(){const t=this.getValue(),e=this._values.indexOf(t);return this.$select.selectedIndex=e,this.$display.innerHTML=e===-1?t:this._names[e],this}}class _1 extends Sn{constructor(t,e,n){super(t,e,n,"string"),this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$input.addEventListener("input",()=>{this.setValue(this.$input.value)}),this.$input.addEventListener("keydown",s=>{s.code==="Enter"&&this.$input.blur()}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$widget.appendChild(this.$input),this.$disable=this.$input,this.updateDisplay()}updateDisplay(){return this.$input.value=this.getValue(),this}}let du=!1;class Sl{constructor({parent:t,autoPlace:e=t===void 0,container:n,width:s,title:r="Controls",injectStyles:a=!0,touchStyles:o=!0}={}){if(this.parent=t,this.root=t?t.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",l=>{l.code!=="Enter"&&l.code!=="Space"||(l.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(r),o&&this.domElement.classList.add("allow-touch-styles"),this.parent)return this.parent.children.push(this),this.parent.folders.push(this),void this.parent.$children.appendChild(this.domElement);this.domElement.classList.add("root"),!du&&a&&(function(l){const u=document.createElement("style");u.innerHTML=l;const h=document.querySelector("head link[rel=stylesheet], head style");h?document.head.insertBefore(u,h):document.head.appendChild(u)}('.lil-gui{--background-color:#1f1f1f;--text-color:#ebebeb;--title-background-color:#111;--title-text-color:#ebebeb;--widget-color:#424242;--hover-color:#4f4f4f;--focus-color:#595959;--number-color:#2cc9ff;--string-color:#a2db3c;--font-size:11px;--input-font-size:11px;--font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Arial,sans-serif;--font-family-mono:Menlo,Monaco,Consolas,"Droid Sans Mono",monospace;--padding:4px;--spacing:4px;--widget-height:20px;--name-width:45%;--slider-knob-width:2px;--slider-input-width:27%;--color-input-width:27%;--slider-input-min-width:45px;--color-input-min-width:45px;--folder-indent:7px;--widget-padding:0 0 0 3px;--widget-border-radius:2px;--checkbox-size:calc(var(--widget-height)*0.75);--scrollbar-width:5px;background-color:var(--background-color);color:var(--text-color);font-family:var(--font-family);font-size:var(--font-size);font-style:normal;font-weight:400;line-height:1;text-align:left;touch-action:manipulation;user-select:none;-webkit-user-select:none}.lil-gui,.lil-gui *{box-sizing:border-box;margin:0;padding:0}.lil-gui.root{display:flex;flex-direction:column;width:var(--width,245px)}.lil-gui.root>.title{background:var(--title-background-color);color:var(--title-text-color)}.lil-gui.root>.children{overflow-x:hidden;overflow-y:auto}.lil-gui.root>.children::-webkit-scrollbar{background:var(--background-color);height:var(--scrollbar-width);width:var(--scrollbar-width)}.lil-gui.root>.children::-webkit-scrollbar-thumb{background:var(--focus-color);border-radius:var(--scrollbar-width)}.lil-gui.force-touch-styles{--widget-height:28px;--padding:6px;--spacing:6px;--font-size:13px;--input-font-size:16px;--folder-indent:10px;--scrollbar-width:7px;--slider-input-min-width:50px;--color-input-min-width:65px}.lil-gui.autoPlace{max-height:100%;position:fixed;right:15px;top:0;z-index:1001}.lil-gui .controller{align-items:center;display:flex;margin:var(--spacing) 0;padding:0 var(--padding)}.lil-gui .controller.disabled{opacity:.5}.lil-gui .controller.disabled,.lil-gui .controller.disabled *{pointer-events:none!important}.lil-gui .controller>.name{flex-shrink:0;line-height:var(--widget-height);min-width:var(--name-width);padding-right:var(--spacing);white-space:pre}.lil-gui .controller .widget{align-items:center;display:flex;min-height:var(--widget-height);position:relative;width:100%}.lil-gui .controller.string input{color:var(--string-color)}.lil-gui .controller.boolean .widget{cursor:pointer}.lil-gui .controller.color .display{border-radius:var(--widget-border-radius);height:var(--widget-height);position:relative;width:100%}.lil-gui .controller.color input[type=color]{cursor:pointer;height:100%;opacity:0;width:100%}.lil-gui .controller.color input[type=text]{flex-shrink:0;font-family:var(--font-family-mono);margin-left:var(--spacing);min-width:var(--color-input-min-width);width:var(--color-input-width)}.lil-gui .controller.option select{max-width:100%;opacity:0;position:absolute;width:100%}.lil-gui .controller.option .display{background:var(--widget-color);border-radius:var(--widget-border-radius);height:var(--widget-height);line-height:var(--widget-height);max-width:100%;overflow:hidden;padding-left:.55em;padding-right:1.75em;pointer-events:none;position:relative;word-break:break-all}.lil-gui .controller.option .display.active{background:var(--focus-color)}.lil-gui .controller.option .display:after{bottom:0;content:"↕";font-family:lil-gui;padding-right:.375em;position:absolute;right:0;top:0}.lil-gui .controller.option .widget,.lil-gui .controller.option select{cursor:pointer}.lil-gui .controller.number input{color:var(--number-color)}.lil-gui .controller.number.hasSlider input{flex-shrink:0;margin-left:var(--spacing);min-width:var(--slider-input-min-width);width:var(--slider-input-width)}.lil-gui .controller.number .slider{background-color:var(--widget-color);border-radius:var(--widget-border-radius);cursor:ew-resize;height:var(--widget-height);overflow:hidden;padding-right:var(--slider-knob-width);touch-action:pan-y;width:100%}.lil-gui .controller.number .slider.active{background-color:var(--focus-color)}.lil-gui .controller.number .slider.active .fill{opacity:.95}.lil-gui .controller.number .fill{border-right:var(--slider-knob-width) solid var(--number-color);box-sizing:content-box;height:100%}.lil-gui-dragging .lil-gui{--hover-color:var(--widget-color)}.lil-gui-dragging *{cursor:ew-resize!important}.lil-gui-dragging.lil-gui-vertical *{cursor:ns-resize!important}.lil-gui .title{--title-height:calc(var(--widget-height) + var(--spacing)*1.25);-webkit-tap-highlight-color:transparent;text-decoration-skip:objects;cursor:pointer;font-weight:600;height:var(--title-height);line-height:calc(var(--title-height) - 4px);outline:none;padding:0 var(--padding)}.lil-gui .title:before{content:"▾";display:inline-block;font-family:lil-gui;padding-right:2px}.lil-gui .title:active{background:var(--title-background-color);opacity:.75}.lil-gui.root>.title:focus{text-decoration:none!important}.lil-gui.closed>.title:before{content:"▸"}.lil-gui.closed>.children{opacity:0;transform:translateY(-7px)}.lil-gui.closed:not(.transition)>.children{display:none}.lil-gui.transition>.children{overflow:hidden;pointer-events:none;transition-duration:.3s;transition-property:height,opacity,transform;transition-timing-function:cubic-bezier(.2,.6,.35,1)}.lil-gui .children:empty:before{content:"Empty";display:block;font-style:italic;height:var(--widget-height);line-height:var(--widget-height);margin:var(--spacing) 0;opacity:.5;padding:0 var(--padding)}.lil-gui.root>.children>.lil-gui>.title{border-width:0;border-bottom:1px solid var(--widget-color);border-left:0 solid var(--widget-color);border-right:0 solid var(--widget-color);border-top:1px solid var(--widget-color);transition:border-color .3s}.lil-gui.root>.children>.lil-gui.closed>.title{border-bottom-color:transparent}.lil-gui+.controller{border-top:1px solid var(--widget-color);margin-top:0;padding-top:var(--spacing)}.lil-gui .lil-gui .lil-gui>.title{border:none}.lil-gui .lil-gui .lil-gui>.children{border:none;border-left:2px solid var(--widget-color);margin-left:var(--folder-indent)}.lil-gui .lil-gui .controller{border:none}.lil-gui input{-webkit-tap-highlight-color:transparent;background:var(--widget-color);border:0;border-radius:var(--widget-border-radius);color:var(--text-color);font-family:var(--font-family);font-size:var(--input-font-size);height:var(--widget-height);outline:none;width:100%}.lil-gui input:disabled{opacity:1}.lil-gui input[type=number],.lil-gui input[type=text]{padding:var(--widget-padding)}.lil-gui input[type=number]:focus,.lil-gui input[type=text]:focus{background:var(--focus-color)}.lil-gui input::-webkit-inner-spin-button,.lil-gui input::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}.lil-gui input[type=number]{-moz-appearance:textfield}.lil-gui input[type=checkbox]{appearance:none;-webkit-appearance:none;border-radius:var(--widget-border-radius);cursor:pointer;height:var(--checkbox-size);text-align:center;width:var(--checkbox-size)}.lil-gui input[type=checkbox]:checked:before{content:"✓";font-family:lil-gui;font-size:var(--checkbox-size);line-height:var(--checkbox-size)}.lil-gui button{-webkit-tap-highlight-color:transparent;background:var(--widget-color);border:1px solid var(--widget-color);border-radius:var(--widget-border-radius);color:var(--text-color);cursor:pointer;font-family:var(--font-family);font-size:var(--font-size);height:var(--widget-height);line-height:calc(var(--widget-height) - 4px);outline:none;text-align:center;text-transform:none;width:100%}.lil-gui button:active{background:var(--focus-color)}@font-face{font-family:lil-gui;src:url("data:application/font-woff;charset=utf-8;base64,") format("woff")}@media (pointer:coarse){.lil-gui.allow-touch-styles{--widget-height:28px;--padding:6px;--spacing:6px;--font-size:13px;--input-font-size:16px;--folder-indent:10px;--scrollbar-width:7px;--slider-input-min-width:50px;--color-input-min-width:65px}}@media (hover:hover){.lil-gui .controller.color .display:hover:before{border:1px solid #fff9;border-radius:var(--widget-border-radius);bottom:0;content:" ";display:block;left:0;position:absolute;right:0;top:0}.lil-gui .controller.option .display.focus{background:var(--focus-color)}.lil-gui .controller.option .widget:hover .display{background:var(--hover-color)}.lil-gui .controller.number .slider:hover{background-color:var(--hover-color)}body:not(.lil-gui-dragging) .lil-gui .title:hover{background:var(--title-background-color);opacity:.85}.lil-gui .title:focus{text-decoration:underline var(--focus-color)}.lil-gui input:hover{background:var(--hover-color)}.lil-gui input:active{background:var(--focus-color)}.lil-gui input[type=checkbox]:focus{box-shadow:inset 0 0 0 1px var(--focus-color)}.lil-gui button:hover{background:var(--hover-color);border-color:var(--hover-color)}.lil-gui button:focus{border-color:var(--focus-color)}}'),du=!0),n?n.appendChild(this.domElement):e&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),s&&this.domElement.style.setProperty("--width",s+"px"),this.domElement.addEventListener("keydown",l=>l.stopPropagation()),this.domElement.addEventListener("keyup",l=>l.stopPropagation())}add(t,e,n,s,r){if(Object(n)===n)return new g1(this,t,e,n);const a=t[e];switch(typeof a){case"number":return new m1(this,t,e,n,s,r);case"boolean":return new c1(this,t,e);case"string":return new _1(this,t,e);case"function":return new io(this,t,e)}console.error(`gui.add failed
	property:`,e,`
	object:`,t,`
	value:`,a)}addColor(t,e,n=1){return new p1(this,t,e,n)}addFolder(t){return new Sl({parent:this,title:t})}load(t,e=!0){return t.controllers&&this.controllers.forEach(n=>{n instanceof io||n._name in t.controllers&&n.load(t.controllers[n._name])}),e&&t.folders&&this.folders.forEach(n=>{n._title in t.folders&&n.load(t.folders[n._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof io)){if(n._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);e.controllers[n._name]=n.save()}}),t&&this.folders.forEach(n=>{if(n._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);e.folders[n._title]=n.save()}),e}open(t=!0){return this._closed=!t,this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._closed=!t,this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const n=r=>{r.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const s=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=s+"px"})}),this}title(t){return this._title=t,this.$title.innerHTML=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(e=>e.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}let pu=function(i,t,e){let n=Math.cos(i)*Math.sin(e),s=Math.sin(i)*Math.sin(e),r=Math.cos(t)*Math.cos(e),a=Math.sin(t)*Math.cos(e);return new Kt(n,r,-s,a)},mu=function(i){return new D(i.y,-i.x,i.w).divideScalar(1-i.z)},Or=function(i=glassColor,t=!1){let e={color:i,clearcoat:1,roughness:.1,metalness:0};return t&&(e.transparent=!0,e.opacity=1,e.transmission=.5,e.ior=1.05,e.thickness=.2),new Vu(e)},$n={red:13908795,orange:12737323,yellow:15248426,green:4432699,blue:4360181,purple:8210109,pink:13584575,glass:13232895};class gu extends Se{constructor(t=(s,r,a)=>a.set(s,r,Math.cos(s)*Math.sin(r)),e=8,n=8){super(),this.type="ParametricGeometry",this.parameters={func:t,slices:e,stacks:n};const s=[],r=[],a=[],o=[],l=1e-5,u=new D,h=new D,f=new D,c=new D,m=new D,g=e+1;for(let _=0;_<=n;_++){const d=_/n;for(let p=0;p<=e;p++){const x=p/e;t(x,d,h),r.push(h.x,h.y,h.z),x-l>=0?(t(x-l,d,f),c.subVectors(h,f)):(t(x+l,d,f),c.subVectors(f,h)),d-l>=0?(t(x,d-l,f),m.subVectors(h,f)):(t(x,d+l,f),m.subVectors(f,h)),u.crossVectors(c,m).normalize(),a.push(u.x,u.y,u.z),o.push(x,d)}}for(let _=0;_<n;_++)for(let d=0;d<e;d++){const p=_*g+d,x=_*g+d+1,y=(_+1)*g+d+1,v=(_+1)*g+d;s.push(p,x,v),s.push(x,y,v)}this.setIndex(s),this.setAttribute("position",new ye(r,3)),this.setAttribute("normal",new ye(a,3)),this.setAttribute("uv",new ye(o,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}}const _u=new Go([new D(-1,-1,0),new D(-1,1,0),new D(1,1,0)]);class v1 extends Se{constructor(t=_u,e=_u,n=64,s=8,r=!1){super(),this.type="TubeGeometry",this.parameters={path:t,tubularSegments:n,radii:e,radialSegments:s,closed:r};const a=t.computeFrenetFrames(n,r);this.tangents=a.tangents,this.normals=a.normals,this.binormals=a.binormals;const o=new D,l=new D,u=new ft;let h=new D,f;const c=[],m=[],g=[],_=[];d(),this.setIndex(_),this.setAttribute("position",new ye(c,3)),this.setAttribute("normal",new ye(m,3)),this.setAttribute("uv",new ye(g,2));function d(){for(let v=0;v<n;v++)p(v);p(r===!1?n:0),y(),x()}function p(v){h=t.getPointAt(v/n,h),f=e.getPointAt(v/n,f);const T=a.normals[v],A=a.binormals[v];for(let w=0;w<=s;w++){const P=w/s*Math.PI*2,b=Math.sin(P),M=-Math.cos(P);l.x=M*T.x+b*A.x,l.y=M*T.y+b*A.y,l.z=M*T.z+b*A.z,l.normalize(),m.push(l.x,l.y,l.z),o.x=h.x+f.x*l.x,o.y=h.y+f.x*l.y,o.z=h.z+f.x*l.z,c.push(o.x,o.y,o.z)}}function x(){for(let v=1;v<=n;v++)for(let T=1;T<=s;T++){const A=(s+1)*(v-1)+(T-1),w=(s+1)*v+(T-1),P=(s+1)*v+T,b=(s+1)*(v-1)+T;_.push(A,w,b),_.push(w,P,b)}}function y(){for(let v=0;v<=n;v++)for(let T=0;T<=s;T++)u.x=v/n,u.y=T/s,g.push(u.x,u.y)}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}}class x1{constructor(t,e){this.coordCurve=t,this.length=e.length,this.area=e.area,this.tau=e.tau,this.fromTauCoords=e.fromTauCoords,this.res=256;let n=function(o){let l=25e-5,u=Math.floor(o/l),h=0,f=0;for(let c=0;c<u;c++){let m=t(f),g=t(f+l),_=Math.sin(m.phi/2),d=g.theta-m.theta;h+=_*_*d,f+=l}return h},s=function(o){let l=0,u=0,h=3e3,f=2*Math.PI/h;for(let c=0;c<h;c++){let m=t(l),g=t(l+f),_=Math.sin(m.phi),d=g.theta-m.theta,p=g.phi-m.phi,x=_*_*d*d+p*p,y=Math.sqrt(x);if(u+=y,u>o)break;l+=f}return l},r=function(o){let l=new ft(e.area/2,e.length/2);for(;o.y>e.length/2;)o=o.sub(l);return o};this.toFundamentalDomain=r;let a=function(o){o=r(o);let l=o.x,u=o.y,h=s(2*u),f=t(h),c=f.phi,m=f.theta,g=n(h),_=pu(m+l-g,l-g,c/2);return mu(_)};this.isometricImage=a}getSurface(t=$n.glass,e=!1){let n=this.coordCurve,s=function(o,l,u){let h=2*Math.PI*o,f=2*Math.PI*l,c=n(f),m=c.phi,g=c.theta,_=pu(g+h,h,m/2),d=mu(_);u.set(d.x,d.y,d.z)},r=new gu(s,this.res,this.res),a=Or(t,e);return new Ae(r,a)}getSubSurface(t,e=$n.glass,n=!1){let s=this.isometricImage,r=function(l,u,h){let f=t(l,u),c=s(f);h.set(c.x,c.y,c.z)},a=new gu(r,512,512);a.computeVertexNormals();let o=Or(e,n);return o.side=sn,new Ae(a,o)}getLift(t,e=$n.red,n=.05,s=!1){let r=[],a=[];for(let f=0;f<this.res+1;f++){let c=f/this.res,m=t(c),g=this.isometricImage(m);r.push(g);let _=n*(1+g.lengthSq());a.push(new D(_,_,_))}console.log(r);let o=new Go(r),l=new Go(a),u=new v1(o,l,2*this.res,16,closed),h=Or(e,s);return new Ae(u,h)}getFiberAt(t,e=$n.blue,n=.025,s=!1){let a=new ft(this.area/2,this.length/2).multiplyScalar(t),o=new ft(2*Math.PI,0),l=function(u){return a.clone().add(o.clone().multiplyScalar(u))};return this.getLift(l,e,n,s)}getEdgeAt(t,e=$n.blue,n=.025,s=!1){let r=new ft(this.area/2,this.length/2),a=new ft(2*Math.PI,0).multiplyScalar(t),o=function(l){return a.clone().add(r.clone().multiplyScalar(l))};return this.getLift(o,e,n,s)}getGridlines(t,e=$n.blue,n=.025,s=!1){let r=new ts;for(let a=0;a<t+1;a++){let o=this.getFiberAt(a/t,e,n,s),l=this.getEdgeAt(a/t,e,n,s);r.add(o),r.add(l)}return r}getPoint(t,e=$n.red,n=.05,s=!1){let r=this.isometricImage(t),a=1+r.lengthSq(),o=new dl(n*a),l=Or(e,s),u=new Ae(o,l);return u.position.set(r.x,r.y,r.z),u}}const Tl=new ft(1/2,Math.sqrt(11)/2);let y1=4*Math.PI*Tl,M1=4*Math.PI*Tl.y,b1=function(i){let t=.07,e=5.705,n=11;return{phi:Math.PI/2+t*e*Math.cos(n*i),theta:i+t*Math.sin(2*n*i)}},S1=function(i){let t=i[0],e=i[1];return new ft(t,e).multiplyScalar(2*Math.PI)},T1={area:y1,length:M1,tau:Tl,fromTauCoords:S1};const vu=[[.51555555,1.07606048],[.5,.55277079],[.48,.35377331],[.38666666,1.63620156],[.37111111,1.11291187],[.30222222,1.16450381],[.26666666,.44221663],[.15777777,1.2013552],[.72444444,.20636776],[.13777777,1.00235771],[.05333333,.53065996],[.00888888,1.56249879],[.51111111,.29481109],[-.0755555,1.09080104],[.38222222,.85495216],[.36666666,.33166247],[-.16,.61910329],[-.2044444,1.65094211],[.34666666,.13266499],[.25333333,1.41509324],[.29777777,.38325442],[-.2888888,1.17924436],[.16888888,.94339549],[.13333333,.22110831],[.04,1.50353657],[.08444444,.47169774],[.82666666,.4864383],[.00444444,.78124939],[-.0444444,1.03183882],[-.08,.30955164],[-.1244444,1.34139047],[.37777777,.07370277],[-.1733333,1.59197989],[-.2088888,.86969272],[.24888888,.63384384],[.48444444,1.1350227],[-.3377777,1.42983379],[.16444444,.1621461],[.90666666,.17688665],[.03555555,.72228717],[0,0],[-.0488888,.25058942],[.69333333,.26532998],[-.1288888,.56014107],[-.1777777,.8107305],[.58,1.34876074],[.56444444,.82547105],[.43555555,1.38561213],[.35111111,.91391438],[.22222222,1.47405546],[.78888888,.47906802],[.64444444,.51591941],[.57555555,.56751135],[.56,.04422166],[.44666666,1.12765242],[.43111111,.60436273],[.36222222,.65595468],[.23333333,1.21609575],[.21777777,.69280606],[.08888888,1.25294714],[.65555555,.2579597],[.02,1.30453908],[.44222222,.34640303],[-.1933333,1.39298241],[.31333333,.9065441],[.27777777,.18425693],[.22888888,.43484636],[.1,.99498743],[.06444444,.27270026],[-.0288888,1.55512851],[.52222222,.03685138],[.01555555,.52328968],[.75777777,.53803024],[-.0644444,.83284133],[-.1133333,1.08343076],[.62888888,1.09817131],[-.1333333,.88443327],[-.2422222,1.64357184],[.30888888,.12529471],[-.3266666,1.17187409],[-.2777777,.92128466],[.18,.68543579],[.41555555,1.18661464],[-.4066666,1.48142573],[.09555555,.21373804],[.83777777,.22847859],[.07555555,.01474055],[-.0333333,.77387911],[.70888888,.78861967],[.66,1.0392091],[-.1622222,1.33402019],[.62444444,.31692192],[-.2466666,.86232244],[.51111111,1.40035268],[.49555555,.877063],[-.3755555,1.42246352],[.36666666,1.43720407],[.86888888,.16951637],[.29777777,1.48879601],[.28222222,.96550632],[.04666666,.46432747],[.74,.72965745],[.15333333,1.5256474],[.70444444,.00737027],[.72,.53065996],[-.1666666,.55277079],[.63555555,.05896221],[.08444444,1.57723934],[.52666666,.81810078],[-.2955555,1.11291187],[.50666666,.61910329],[.49111111,.0958136],[-.06,1.61409073],[.37777777,1.17924436],[.29333333,.70754662],[.18444444,1.46668518],[.16444444,1.26768769],[.14888888,.744398],[.08,.79598994],[.58666666,.30955164],[-.0488888,1.35613102],[.37333333,.39799497],[-.2622222,1.44457435],[.24444444,.95813605],[.16,.4864383],[.03111111,1.04657937],[-.0533333,.57488163],[-.0977777,1.60672045],[.45333333,.08844332],[-.1822222,1.1350227],[-.2022222,.93602521],[.24,.17688665],[.11111111,.73702773],[.91333333,.24321915],[.02666666,.26532998],[.76888888,.28007053],[-.1022222,.82547105],[.64,.84021161],[.59111111,1.09080104],[-.2311111,1.38561213],[.57111111,.89180355],[.55555555,.36851386],[.46222222,1.65094211],[-.3,1.43720407],[.44222222,1.45194463],[.42666666,.92865494],[-.4444444,1.47405546],[.35777777,.98024688],[.8,.22110831],[.22888888,1.54038795],[.78,.02211083],[.21333333,1.01709826],[.67111111,.78124939],[-.0911111,.56751135],[.54222222,1.34139047],[.01555555,1.62883128],[.56666666,.11055415],[.45777777,.86969272],[.43777777,.67069523],[.42222222,.14740554],[.32888888,1.42983379],[.35333333,.19899748],[.30888888,1.23083631],[.75111111,.47169774],[.22444444,.75913856],[.11555555,1.51827712],[.66666666,0],[.14,.28744081],[.09555555,1.31927963],[.53777777,.56014107],[.01111111,.84758189],[-.1177777,1.40772296],[.32444444,.6485844],[.30444444,.44958691],[-.3311111,1.49616629],[.17555555,1.00972799],[.09111111,.53803024],[-.0177777,1.2971688],[.00666666,.06633249],[-.0377777,1.09817131],[-.1222222,.62647357],[-.2511111,1.18661464],[.17111111,.22847859],[.04222222,.78861967],[.84444444,.29481109],[-.0422222,.31692192],[.65111111,.5822519],[-.1711111,.877063],[.63111111,.38325442],[.52222222,1.14239298],[.50222222,.94339549],[-.3688888,1.48879601],[.41777777,.47169774],[.03777777,.00737027],[.28888888,1.03183882],[.74666666,.79598994],[.73111111,.27270026],[.16,1.59197989],[.71111111,.07370277],[.60222222,.83284133],[.07555555,1.12028215],[.51777777,.36114358],[.47333333,1.39298241],[.49777777,.1621461],[.40444444,1.44457435],[.38888888,.92128466],[-.1377777,1.20872547],[.36888888,.72228717],[.26,1.48142573],[.28444444,.25058942],[.19111111,1.53301768],[.74222222,.01474055],[.15555555,.8107305],[.61333333,.57488163],[.59777777,.05159194],[.04666666,1.56986906],[.07111111,.33903275],[.02666666,1.37087158],[.52888888,.10318388],[-.0577777,.89917383],[.4,.66332495],[.38444444,.14003526],[-.1866666,1.4593149],[.27111111,1.22346603],[.25555555,.70017634],[-.2711111,.98761715],[.18666666,.75176828],[.23555555,.50117885],[-.4,1.54775823],[.15111111,.0294811],[.05777777,1.31190936],[.02222222,.58962218],[-.0266666,.84021161],[.71555555,.85495216],[-.1066666,1.14976326],[-.1555555,1.40035268],[-.1911111,.67806551],[-.32,1.23820658],[.37333333,1.50353657],[.10222222,.28007053],[.79555555,.54540052],[.03333333,.33166247],[-.1111111,.36851386],[.58222222,.63384384],[-.24,.92865494],[.45333333,1.19398492],[.87555555,.23584887],[.24,1.28242825],[.67777777,.84758189],[.66222222,.3242922],[.64222222,.12529471],[.53333333,.88443327],[.46444444,.93602521],[.44888888,.41273552],[.42888888,.21373804],[.33555555,1.49616629],[.32,.9728766],[.3,.77387911],[.25111111,1.02446854],[.21555555,.30218136],[.12222222,1.58460962],[.67333333,.06633249],[.10666666,1.06131993],[.08666666,.86232244],[.54444444,.62647357],[-.0222222,1.621461],[.00222222,.39062469],[-.0422222,1.42246352],[.46,.15477582],[-.1266666,.95076577],[.33111111,.71491689],[.31555555,.19162721],[-.2555555,1.51090684],[.24666666,.24321915],[.20222222,1.27505797],[.16666666,.55277079],[.11777777,.80336022],[-.4688888,1.59935017],[.08222222,.08107305],[-.0111111,1.3635013],[-.0466666,.64121412],[-.0955555,.89180355],[.41111111,.40536525],[.64666666,.9065441],[-.1755555,1.2013552],[-.2244444,1.45194463],[.51777777,1.46668518],[-.2444444,1.25294714],[.19777777,.49380857],[-.3888888,1.28979852],[.11333333,.02211083],[-.4377777,1.54038795],[.30444444,1.55512851],[.85555555,.03685138],[.06888888,1.05394965],[-.0155555,.5822519],[.72666666,.59699246],[-.0355555,.38325442],[-.1444444,1.14239298],[.59777777,1.15713353],[.54888888,1.40772296],[.51333333,.68543579],[-.3577777,1.23083631],[.38444444,1.24557686],[.80666666,.28744081],[.17111111,1.33402019],[.73777777,.33903275],[.60888888,.89917383],[.59333333,.37588414],[.52444444,.42747608],[.39555555,.98761715],[.38,.46432747],[.26666666,1.54775823],[.18222222,1.07606048],[.05333333,1.63620156],[.03777777,1.11291187],[.60444444,.11792443],[-.0311111,1.16450381],[.47555555,.67806551],[.39111111,.20636776],[.26222222,.76650884],[.17777777,.29481109],[.13333333,1.32664991],[.09777777,.60436273],[.04888888,.85495216],[-.08,1.41509324],[-.1155555,.69280606],[-.1644444,.94339549],[.34222222,.45695719],[.57777777,.95813605],[-.2933333,1.50353657],[.44888888,1.51827712],[-.3133333,1.30453908],[.12888888,.54540052],[.04444444,.07370277],[0,1.10554159],[.80222222,.61173301],[.78666666,.08844332],[.23555555,1.60672045],[-.0844444,.63384384],[.65777777,.6485844],[-.2133333,1.19398492],[.57333333,.17688665],[.52888888,1.20872547],[.48,1.4593149],[.46,1.26031742],[.44444444,.73702773],[.20888888,.23584887],[.31555555,1.2971688],[.81777777,.0294811],[.24666666,1.34876074],[-.0044444,.3242922],[.68888888,.58962218],[.10222222,1.38561213],[.66888888,.39062469],[.56,1.14976326],[.45555555,.47906802],[.34666666,1.23820658],[.32666666,1.0392091],[.31111111,.51591941],[.24222222,.56751135],[.19777777,1.59935017],[.11333333,1.12765242],[.02888888,.65595468],[.53555555,.16951637],[-.1,1.21609575],[.32222222,.2579597],[.19333333,.81810078],[.10888888,.34640303],[.06444444,1.37824185],[-.02,.9065441],[-.1044444,.43484636],[-.1488888,1.46668518],[-.2333333,.99498743],[.52444444,1.53301768],[-.3622222,1.55512851],[.18888888,.03685138],[.88222222,.30218136],[.06,.59699246],[-.0244444,.12529471],[-.0688888,1.15713353],[.73333333,.66332495],[-.1533333,.68543579],[.58888888,.70017634],[.54,.95076577],[-.2822222,1.24557686],[.52,.75176828],[.41111111,1.51090684],[.39111111,1.31190936],[.37555555,.78861967],[.30666666,.84021161],[.74888888,.08107305],[.17777777,1.40035268],[.16222222,.877063],[.63555555,1.16450381],[.62,.64121412],[-.0733333,.37588414],[.03333333,1.43720407],[.6,.44221663],[.49111111,1.2013552],[-.0355555,1.48879601],[.40666666,.72965745],[.38666666,.53065996],[.37111111,.00737027],[.27777777,1.28979852],[-.2488888,1.57723934],[.30222222,.05896221],[.25777777,1.09080104],[.7,.33166247],[.17333333,.61910329],[.04444444,1.17924436],[.48666666,.4201058],[-.04,.70754662],[.46666666,.22110831],[-.1688888,1.26768769],[.27333333,.50854913],[.25333333,.30955164],[.14444444,1.06869021],[-.3822222,1.35613102],[.12444444,.86969272],[.04,.39799497],[-.0888888,.95813605],[.60444444,1.22346603],[-.2177777,1.51827712],[.33333333,0],[-.3022222,1.04657937],[-.4311111,1.60672045],[.12,.08844332],[.81333333,.35377331],[-.0088888,.6485844],[.68444444,.91391438],[-.0777777,.70017634],[-.2222222,.73702773],[.47111111,1.00235771],[-.3511111,1.2971688],[.34222222,1.56249879],[.89333333,.04422166],[.32222222,1.3635013],[.76444444,.60436273],[.12888888,1.65094211],[.68,.13266499],[.10888888,1.45194463],[.56666666,1.21609575],[.55111111,.69280606],[.53111111,.49380857],[.42222222,1.25294714],[-.1044444,1.54038795],[.44666666,.02211083],[.35333333,1.30453908],[.33777777,.78124939],[.31777777,.5822519],[.20888888,1.34139047],[.77555555,.34640303],[-.3177777,1.62883128],[.23333333,.11055415],[.18888888,1.14239298],[.14,1.39298241],[.10444444,.67069523],[-.0044444,1.42983379],[.56222222,.43484636],[-.0244444,1.23083631],[.43333333,.99498743],[-.1088888,.75913856],[.39777777,.27270026],[.34888888,.52328968],[-.2377777,1.31927963],[.22,1.08343076],[.20444444,.56014107],[.13555555,.61173301],[.18444444,.36114358],[.09111111,1.64357184],[.00666666,1.17187409],[.05555555,.92128466],[-.0288888,.44958691],[-.2066666,1.26031742],[-.1577777,1.00972799],[.53555555,1.27505797],[-.2866666,1.56986906],[.26444444,.05159194],[-.3555555,1.621461],[.05111111,.14003526],[.74444444,.40536525],[.61555555,.96550632],[-.1466666,.75176828],[.48666666,1.5256474],[.96888888,.05896221],[.40222222,1.05394965],[.27333333,1.61409073],[.82444444,.0958136],[.69555555,.65595468],[.62666666,.70754662],[.61111111,.18425693],[.49777777,1.26768769],[.48222222,.744398],[.41333333,.79598994],[.28444444,1.35613102],[.26888888,.83284133],[.12,1.19398492],[.07111111,1.44457435],[-.0733333,1.48142573],[.49333333,.4864383],[-.0933333,1.28242825],[.40888888,.01474055],[-.1422222,1.53301768],[.36444444,1.04657937],[.28,.57488163],[-.3066666,1.37087158],[.19555555,.10318388],[.15111111,1.1350227],[.93777777,.11792443],[.06666666,.66332495],[.11555555,.41273552],[-.0622222,1.22346603],[-.0133333,.9728766],[-.0977777,.50117885],[.36,.26532998],[.59555555,.76650884],[-.2755555,1.31190936],[-.2266666,1.06131993],[.23111111,.82547105],[.46666666,1.32664991],[.14666666,.35377331],[.01777777,.91391438],[-.0177777,.19162721],[-.1111111,1.47405546],[.69111111,.98024688],[-.0666666,.44221663],[.67555555,.45695719],[-.1955555,1.00235771],[.54666666,1.01709826],[-.3244444,1.56249879],[.22666666,.04422166],[.46222222,.54540052],[.41777777,1.57723934],[.34888888,1.62883128],[.33333333,1.10554159],[.9,.11055415],[.01333333,.13266499],[.75555555,.14740554],[.70666666,.39799497],[.68666666,.19899748],[.55777777,.75913856],[.54222222,.23584887],[.47333333,.28744081],[.34444444,.84758189],[.32888888,.3242922],[.21555555,1.40772296],[.2,.88443327],[.13111111,.93602521],[.00222222,1.49616629],[-.0822222,1.02446854],[.42444444,.53803024],[-.2111111,1.58460962],[.34,.06633249],[.21111111,.62647357],[.12666666,.15477582],[.08222222,1.18661464],[-.0022222,.71491689],[-.0222222,.51591941],[-.1311111,1.27505797],[-.2155555,.80336022],[.29111111,.31692192],[-.3444444,1.3635013],[.39777777,1.37824185],[.07777777,.40536525],[.77111111,.67069523],[.82,.4201058],[-.0511111,.96550632],[-.1355555,.49380857],[-.18,1.5256474],[.62222222,1.03183882],[.60666666,.50854913],[-.2644444,1.05394965],[.42888888,1.31927963],[.47777777,1.06869021],[-.3933333,1.61409073],[.40888888,1.12028215],[.39333333,.59699246],[.15777777,.0958136],[.85111111,.36114358],[.08888888,.14740554],[.26444444,1.15713353],[.83111111,.1621461],[.19555555,1.20872547],[-.0555555,.18425693],[.63777777,.44958691],[-.1844444,.744398],[.05111111,1.24557686],[.61777777,.25058942],[.50888888,1.00972799],[.48888888,.8107305],[.38,1.56986906],[.93111111,.05159194],[.40444444,.33903275],[.29555555,1.09817131],[.27555555,.89917383],[.26,.37588414],[.71777777,.14003526],[.19111111,.42747608],[.14666666,1.4593149],[.06222222,.98761715],[.50444444,.22847859],[-.0666666,1.54775823],[.48444444,.0294811],[-.1511111,1.07606048],[.35555555,.58962218],[-.28,1.63620156],[.27111111,.11792443],[.14222222,.67806551],[.05777777,.20636776],[.01333333,1.23820658],[-.0711111,.76650884],[-.2,1.32664991],[.49333333,1.59197989],[.22222222,.36851386],[-.4133333,1.41509324],[.00888888,.45695719],[.70222222,.72228717],[-.12,1.01709826],[.68222222,.52328968],[.57333333,1.28242825],[-.1888888,1.06869021],[.55333333,1.08343076],[-.3333333,1.10554159],[.46888888,.61173301],[.36,1.37087158],[.34,1.17187409],[.78222222,.41273552],[.02,.19899748],[.65333333,.9728766],[.12666666,1.26031742],[.56888888,.50117885],[.54888888,.30218136],[.45555555,1.58460962],[.44,1.06131993],[-.0866666,1.34876074],[.42,.86232244],[.31111111,1.621461],[.86222222,.10318388],[.33555555,.39062469],[.22666666,1.14976326],[.79333333,.15477582],[.20666666,.95076577],[.66444444,.71491689],[.64888888,.19162721],[.12222222,.47906802],[.07777777,1.51090684],[.58,.24321915],[-.0066666,1.0392091],[.45111111,.80336022],[.43555555,.28007053],[-.1355555,1.59935017],[.41555555,.08107305],[-.22,1.12765242],[.28666666,.64121412],[.23777777,.89180355],[.20222222,.16951637],[.09333333,.92865494],[.07333333,.72965745],[.02444444,.98024688],[-.0111111,.2579597],[-.0555555,1.28979852],[-.14,.81810078],[-.2688888,1.37824185],[.42444444,1.64357184],[.15333333,.4201058],[.76222222,.21373804],[-.06,.50854913],[.63333333,.77387911],[.50444444,1.33402019],[-.2577777,1.12028215],[.29111111,1.42246352],[.85777777,.42747608],[.71333333,.46432747],[.58444444,1.02446854]],kn=new ku;let sl=new x1(b1,T1),E1=sl.getSurface();kn.add(E1);let ph=new ts;kn.add(ph);for(let i=0;i<vu.length;i++){let t=sl.fromTauCoords(vu[i]);ph.add(sl.getPoint(t,$n.purple,.03))}let ke=new l1(16777215);ke.position.set(2,6,0);ke.angle=Math.PI/2;ke.decay=0;ke.penumbra=1;ke.distance=0;ke.intensity=5;ke.radius=.5;ke.shadow.mapSize.width=512;ke.shadow.mapSize.height=512;ke.shadow.camera.near=.1;ke.shadow.camera.far=10;ke.shadow.focus=1;ke.castShadow=!0;kn.add(ke);const aa=ke.target;aa.position.x=1;aa.position.y=0;aa.position.z=.05;kn.add(aa);const mh=new Ae(new ys(100,.1,100),new Vu({color:16777215,clearcoat:1,roughness:.5,metalness:0}));mh.position.set(-1,-4,-1);kn.add(mh);const Xs=new dh;Xs.bottomColor.set(16777215);Xs.bottomColor.set(6710886);Xs.update();kn.environment=Xs;kn.background=Xs;const Mi=new Le;Mi.position.set(.1,10,-.1);Mi.lookAt(0,0,0);let bi=new t_({preserveDrawingBuffer:!0});bi.toneMapping=Mu;document.body.appendChild(bi.domElement);let Ti=new o1(bi);Ti.setScene(kn,Mi);Ti.renderScale=Math.max(1/window.devicePixelRatio,.5);Ti.tiles.setScalar(3);Ti.bounces=30;function w1(i){const t=new Date;let e=t.getDate(),n=t.getMonth()+1,s=t.getHours(),r=t.getMinutes(),a=document.createElement("a");a.download=`pathtrace ${n}-${e}-${s}${r}.png`,a.href=i.toDataURL("image/png"),a.click()}const A1=new Sl().close();let R1={saveit:()=>w1(bi.domElement)};A1.add(R1,"saveit");let El=new n_(Mi,bi.domElement);El.target.set(0,.33,-.08);El.addEventListener("change",()=>Ti.updateCamera());El.update();_h();gh();window.addEventListener("resize",_h);function gh(){requestAnimationFrame(gh),Ti.renderSample()}function _h(){const i=window.innerWidth,t=window.innerHeight;bi.setSize(i,t),bi.setPixelRatio(window.devicePixelRatio);const e=i/t;Mi.aspect=e,Mi.updateProjectionMatrix(),Ti.setScene(kn,Mi)}
