...
`;class Yv extends Ml{constructor(){super({blending:Ke,uniforms:{resolution:{value:new ut}},vertexShader:`
			...
			`})}}function v1(i,t=Math.random()){for(let e=i.length-1;e>0;e--){const n=Math.floor(t()*(e+1)),s=i[e];i[e]=i[n],i[n]=s}return i}class x1{constructor(t,e,n=Math.random){const s=t**e,r=new Uint16Array(s);let a=s;for(let o=0;o<s;o++)r[o]=o;this.samples=new Float32Array(e),this.strataCount=t,this.reset=function(){for(let o=0;o<s;o++)r[o]=o;a=0},this.reshuffle=function(){a=0},this.next=function(){const{samples:o}=this;a>=r.length&&(v1(r,n),this.reshuffle());let l=r[a++];for(let u=0;u<e;u++)o[u]=(l%t+n())/t,l=Math.floor(l/t);return o}}}class y1{constructor(t,e,n=Math.random){let s=0;for(const l of e)s+=l;const r=new Float32Array(s),a=[];let o=0;for(const l of e){const u=new x1(t,l,n);u.samples=new Float32Array(r.buffer,o,u.samples.length),o+=u.samples.length*4,a.push(u)}this.samples=r,this.strataCount=t,this.next=function(){for(const l of a)l.next();return r},this.reshuffle=function(){for(const l of a)l.reshuffle()},this.reset=function(){for(const l of a)l.reset()}}}class M1{constructor(t=0){this.m=2147483648,this.a=1103515245,this.c=12345,this.seed=t}nextInt(){return this.seed=(this.a*this.seed+this.c)%this.m,this.seed}nextFloat(){return this.nextInt()/(this.m-1)}}class b1 extends ln{constructor(t=1,e=1,n=8){super(new Float32Array(1),1,1,Zt,ne),this.minFilter=Bt,this.magFilter=Bt,this.strata=n,this.sampler=null,this.generator=new M1,this.stableNoise=!1,this.random=()=>this.stableNoise?this.generator.nextFloat():Math.random(),this.init(t,e,n)}init(t=this.image.height,e=this.image.width,n=this.strata){const{image:s}=this;if(s.width===e&&s.height===t&&this.sampler!==null)return;const r=new Array(t*e).fill(4),a=new y1(n,r,this.random);s.width=e,s.height=t,s.data=a.samples,this.sampler=a,this.dispose(),this.next()}next(){this.sampler.next(),this.needsUpdate=!0}reset(){this.sampler.reset(),this.generator.seed=0}}function S1(i,t=Math.random){for(let e=i.length-1;e>0;e--){const n=~~((t()-1e-6)*e),s=i[e];i[e]=i[n],i[n]=s}}function T1(i,t){i.fill(0);for(let e=0;e<t;e++)i[e]=1}class ru{constructor(t){this.count=0,this.size=-1,this.sigma=-1,this.radius=-1,this.lookupTable=null,this.score=null,this.binaryPattern=null,this.resize(t),this.setSigma(1.5)}findVoid(){const{score:t,binaryPattern:e}=this;let n=1/0,s=-1;for(let r=0,a=e.length;r<a;r++){if(e[r]!==0)continue;const o=t[r];o<n&&(n=o,s=r)}return s}findCluster(){const{score:t,binaryPattern:e}=this;let n=-1/0,s=-1;for(let r=0,a=e.length;r<a;r++){if(e[r]!==1)continue;const o=t[r];o>n&&(n=o,s=r)}return s}setSigma(t){if(t===this.sigma)return;const e=~~(Math.sqrt(10*2*t**2)+1),n=2*e+1,s=new Float32Array(n*n),r=t*t;for(let a=-e;a<=e;a++)for(let o=-e;o<=e;o++){const l=(e+o)*n+a+e,u=a*a+o*o;s[l]=Math.E**(-u/(2*r))}this.lookupTable=s,this.sigma=t,this.radius=e}resize(t){this.size!==t&&(this.size=t,this.score=new Float32Array(t*t),this.binaryPattern=new Uint8Array(t*t))}invert(){const{binaryPattern:t,score:e,size:n}=this;e.fill(0);for(let s=0,r=t.length;s<r;s++)if(t[s]===0){const a=~~(s/n),o=s-a*n;this.updateScore(o,a,1),t[s]=1}else t[s]=0}updateScore(t,e,n){const{size:s,score:r,lookupTable:a}=this,o=this.radius,l=2*o+1;for(let u=-o;u<=o;u++)for(let h=-o;h<=o;h++){const f=(o+h)*l+u+o,c=a[f];let m=t+u;m=m<0?s+m:m%s;let g=e+h;g=g<0?s+g:g%s;const _=g*s+m;r[_]+=n*c}}addPointIndex(t){this.binaryPattern[t]=1;const e=this.size,n=~~(t/e),s=t-n*e;this.updateScore(s,n,1),this.count++}removePointIndex(t){this.binaryPattern[t]=0;const e=this.size,n=~~(t/e),s=t-n*e;this.updateScore(s,n,-1),this.count--}copy(t){this.resize(t.size),this.score.set(t.score),this.binaryPattern.set(t.binaryPattern),this.setSigma(t.sigma),this.count=t.count}}class E1{constructor(){this.random=Math.random,this.sigma=1.5,this.size=64,this.majorityPointsRatio=.1,this.samples=new ru(1),this.savedSamples=new ru(1)}generate(){const{samples:t,savedSamples:e,sigma:n,majorityPointsRatio:s,size:r}=this;t.resize(r),t.setSigma(n);const a=Math.floor(r*r*s),o=t.binaryPattern;T1(o,a),S1(o,this.random);for(let f=0,c=o.length;f<c;f++)o[f]===1&&t.addPointIndex(f);for(;;){const f=t.findCluster();t.removePointIndex(f);const c=t.findVoid();if(f===c){t.addPointIndex(f);break}t.addPointIndex(c)}const l=new Uint32Array(r*r);e.copy(t);let u;for(u=t.count-1;u>=0;){const f=t.findCluster();t.removePointIndex(f),l[f]=u,u--}const h=r*r;for(u=e.count;u<h/2;){const f=e.findVoid();e.addPointIndex(f),l[f]=u,u++}for(e.invert();u<h;){const f=e.findCluster();e.removePointIndex(f),l[f]=u,u++}return{data:l,maxValue:h}}}function w1(i){return i>=3?4:i}function A1(i){switch(i){case 1:return ds;case 2:return Qr;default:return Zt}}class R1 extends ln{constructor(t=64,e=1){super(new Float32Array(4),1,1,Zt,ne),this.minFilter=Bt,this.magFilter=Bt,this.size=t,this.channels=e,this.update()}update(){const t=this.channels,e=this.size,n=new E1;n.channels=t,n.size=e;const s=w1(t),r=A1(s);(this.image.width!==e||r!==this.format)&&(this.image.width=e,this.image.height=e,this.image.data=new Float32Array(e**2*s),this.format=r,this.dispose());const a=this.image.data;for(let o=0,l=t;o<l;o++){const u=n.generate(),h=u.data,f=u.maxValue;for(let c=0,m=h.length;c<m;c++){const g=h[c]/f;a[c*s+o]=g}}this.needsUpdate=!0}}const C1=`
...
`;class tx extends Ml{onBeforeRender(){this.setDefine("FEATURE_DOF",this.physicalCamera.bokehSize===0?0:1),this.setDefine("FEATURE_BACKGROUND_MAP",this.backgroundMap?1:0),this.setDefine("FEATURE_FOG",this.materials.features.isUsed("FOG")?1:0)}constructor(t){super({transparent:!0,depthWrite:!1,defines:{FEATURE_MIS:1,FEATURE_RUSSIAN_ROULETTE:1,FEATURE_DOF:1,FEATURE_BACKGROUND_MAP:0,FEATURE_FOG:1,RANDOM_TYPE:2,CAMERA_TYPE:0,DEBUG_MODE:0,ATTR_NORMAL:0,ATTR_TANGENT:1,ATTR_UV:2,ATTR_COLOR:3},uniforms:{resolution:{value:new ut},opacity:{value:1},bounces:{value:10},transmissiveBounces:{value:10},filterGlossyFactor:{value:0},physicalCamera:{value:new Kv},cameraWorldMatrix:{value:new Ut},invProjectionMatrix:{value:new Ut},bvh:{value:new gv},attributesArray:{value:new l1},materialIndexAttribute:{value:new sh},materials:{value:new p1},textures:{value:new su().texture},lights:{value:new a1},iesProfiles:{value:new su(360,180,{type:Fe,wrapS:Ne,wrapT:Ne}).texture},environmentIntensity:{value:1},environmentRotation:{value:new Ut},envMapInfo:{value:new Qv},backgroundBlur:{value:0},backgroundMap:{value:null},backgroundAlpha:{value:1},backgroundIntensity:{value:1},backgroundRotation:{value:new Ut},seed:{value:0},sobolTexture:{value:null},stratifiedTexture:{value:new b1},stratifiedOffsetTexture:{value:new R1(64,1)}},vertexShader:`
			...
			`}),this.setValues(t)}}class sx extends un{constructor(){super({uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:`
				varying vec2 vUv;
				void main() {
				...
				}`}),this.depthWrite=!1,this.depthTest=!1}}class hu{constructor(t){this._renderer=t,this._quad=new vs(new sx)}generate(t,e=null,n=null){if(!t.isCubeTexture)throw new Error("CubeToEquirectMaterial: Source can only be cube textures.");const s=t.images[0],r=this._renderer,a=this._quad;e===null&&(e=4*s.height),n===null&&(n=2*s.height);const o=new Ze(e,n,{type:ne,colorSpace:s.colorSpace}),l=s.height,u=Math.log2(l)-2,h=1/l,f=1/(3*Math.max(Math.pow(2,u),7*16));a.material.defines.CUBEUV_MAX_MIP=`${u}.0`,a.material.defines.CUBEUV_TEXEL_WIDTH=f,a.material.defines.CUBEUV_TEXEL_HEIGHT=h,a.material.uniforms.envMap.value=t,a.material.uniforms.flipEnvMap.value=t.isRenderTargetTexture?1:-1,a.material.needsUpdate=!0;const c=r.getRenderTarget(),m=r.autoClear;r.autoClear=!0,r.setRenderTarget(o),a.render(r),r.setRenderTarget(c),r.autoClear=m;const g=new Uint16Array(e*n*4),_=new Float32Array(e*n*4);r.readRenderTargetPixels(o,0,0,e,n,_),o.dispose();for(let p=0,x=_.length;p<x;p++)g[p]=Fn.toHalfFloat(_[p]);const d=new ln(g,e,n,Zt,Fe);return d.minFilter=Qh,d.magFilter=fe,d.wrapS=vn,d.wrapT=vn,d.mapping=Hs,d.needsUpdate=!0,d}dispose(){this._quad.dispose()}}function rx(i){return i.extensions.get("EXT_float_blend")}const ji=new ut;class ax{get multipleImportanceSampling(){return!!this._pathTracer.material.defines.FEATURE_MIS}set multipleImportanceSampling(t){this._pathTracer.material.setDefine("FEATURE_MIS",t?1:0)}get transmissiveBounces(){return this._pathTracer.material.transmissiveBounces}set transmissiveBounces(t){this._pathTracer.material.transmissiveBounces=t}get bounces(){return this._pathTracer.material.bounces}set bounces(t){this._pathTracer.material.bounces=t}get filterGlossyFactor(){return this._pathTracer.material.filterGlossyFactor}set filterGlossyFactor(t){this._pathTracer.material.filterGlossyFactor=t}get samples(){return this._pathTracer.samples}get target(){return this._pathTracer.target}get tiles(){return this._pathTracer.tiles}get stableNoise(){return this._pathTracer.stableNoise}set stableNoise(t){this._pathTracer.stableNoise=t}get isCompiling(){return!!this._pathTracer.isCompiling}constructor(t){this._renderer=t,this._generator=new kv,this._pathTracer=new lu(t),this._queueReset=!1,this._clock=new md,this._compilePromise=null,this._lowResPathTracer=new lu(t),this._lowResPathTracer.tiles.set(1,1),this._quad=new vs(new ix({map:null,transparent:!0,blending:Ke,premultipliedAlpha:t.getContextAttributes().premultipliedAlpha})),this._materials=null,this._previousEnvironment=null,this._previousBackground=null,this._internalBackground=null,this.renderDelay=100,this.minSamples=5,this.fadeDuration=500,this.enablePathTracing=!0,this.pausePathTracing=!1,this.dynamicLowRes=!1,this.lowResScale=.25,this.renderScale=1,this.synchronizeRenderSize=!0,this.rasterizeScene=!0,this.renderToCanvas=!0,this.textureSize=new ut(1024,1024),this.rasterizeSceneCallback=(e,n)=>{this._renderer.render(e,n)},this.renderToCanvasCallback=(e,n,s)=>{const r=n.autoClear;n.autoClear=!1,s.render(n),n.autoClear=r},this.setScene(new zu,new Le)}setBVHWorker(t){this._generator.setBVHWorker(t)}setScene(t,e,n={}){t.updateMatrixWorld(!0),e.updateMatrixWorld();const s=this._generator;if(s.setObjects(t),this._buildAsync)return s.generateAsync(n.onProgress).then(r=>this._updateFromResults(t,e,r));{const r=s.generate();return this._updateFromResults(t,e,r)}}setSceneAsync(...t){this._buildAsync=!0;const e=this.setScene(...t);return this._buildAsync=!1,e}setCamera(t){this.camera=t,this.updateCamera()}updateCamera(){const t=this.camera;t.updateMatrixWorld(),this._pathTracer.setCamera(t),this._lowResPathTracer.setCamera(t),this.reset()}updateMaterials(){const t=this._pathTracer.material,e=this._renderer,n=this._materials,s=this.textureSize,r=h1(n);t.textures.setTextures(e,r,s.x,s.y),t.materials.updateFrom(n,r),this.reset()}updateLights(){const t=this.scene,e=this._renderer,n=this._pathTracer.material,s=f1(t),r=u1(s);n.lights.updateFrom(s,r),n.iesProfiles.setTextures(e,r),this.reset()}updateEnvironment(){const t=this.scene,e=this._pathTracer.material;if(this._internalBackground&&(this._internalBackground.dispose(),this._internalBackground=null),e.backgroundBlur=t.backgroundBlurriness,e.backgroundIntensity=t.backgroundIntensity??1,e.backgroundRotation.makeRotationFromEuler(t.backgroundRotation).invert(),t.background===null)e.backgroundMap=null,e.backgroundAlpha=0;else if(t.background.isColor){this._colorBackground=this._colorBackground||new fh(16);const n=this._colorBackground;n.topColor.equals(t.background)||(n.topColor.set(t.background),n.bottomColor.set(t.background),n.update()),e.backgroundMap=n,e.backgroundAlpha=1}else if(t.background.isCubeTexture){if(t.background!==this._previousBackground){const n=new hu(this._renderer).generate(t.background);this._internalBackground=n,e.backgroundMap=n,e.backgroundAlpha=1}}else e.backgroundMap=t.background,e.backgroundAlpha=1;if(e.environmentIntensity=t.environmentIntensity??1,e.environmentRotation.makeRotationFromEuler(t.environmentRotation).invert(),this._previousEnvironment!==t.environment)if(t.environment!==null)if(t.environment.isCubeTexture){const n=new hu(this._renderer).generate(t.environment);e.envMapInfo.updateFrom(n)}else e.envMapInfo.updateFrom(t.environment);else e.environmentIntensity=0;this._previousEnvironment=t.environment,this._previousBackground=t.background,this.reset()}_updateFromResults(t,e,n){const{materials:s,geometry:r,bvh:a,bvhChanged:o}=n;this._materials=s;const u=this._pathTracer.material;return o&&(u.bvh.updateFrom(a),u.attributesArray.updateFrom(r.attributes.normal,r.attributes.tangent,r.attributes.uv,r.attributes.color),u.materialIndexAttribute.updateFrom(r.attributes.materialIndex)),this._previousScene=t,this.scene=t,this.camera=e,this.updateCamera(),this.updateMaterials(),this.updateEnvironment(),this.updateLights(),n}renderSample(){const t=this._lowResPathTracer,e=this._pathTracer,n=this._renderer,s=this._clock,r=this._quad;this._updateScale(),this._queueReset&&(e.reset(),t.reset(),this._queueReset=!1,r.material.opacity=0,s.start());const a=s.getDelta()*1e3,o=s.getElapsedTime()*1e3;if(!this.pausePathTracing&&this.enablePathTracing&&this.renderDelay<=o&&!this.isCompiling&&e.update(),e.alpha=e.material.backgroundAlpha!==1||!rx(n),t.alpha=e.alpha,this.renderToCanvas){const l=this._renderer,u=this.minSamples;if(o>=this.renderDelay&&this.samples>=this.minSamples&&(this.fadeDuration!==0?r.material.opacity=Math.min(r.material.opacity+a/this.fadeDuration,1):r.material.opacity=1),!this.enablePathTracing||this.samples<u||r.material.opacity<1){if(this.dynamicLowRes&&!this.isCompiling){t.samples<1&&(t.material=e.material,t.update());const h=r.material.opacity;r.material.opacity=1-r.material.opacity,r.material.map=t.target.texture,r.render(l),r.material.opacity=h}(!this.dynamicLowRes&&this.rasterizeScene||this.dynamicLowRes&&this.isCompiling)&&this.rasterizeSceneCallback(this.scene,this.camera)}this.enablePathTracing&&r.material.opacity>0&&(r.material.opacity<1&&(r.material.blending=this.dynamicLowRes?so:Jn),r.material.map=e.target.texture,this.renderToCanvasCallback(e.target,l,r),r.material.blending=Ke)}}reset(){this._queueReset=!0,this._pathTracer.samples=0}dispose(){this._renderQuad.dispose(),this._renderQuad.material.dispose(),this._pathTracer.dispose()}_updateScale(){if(this.synchronizeRenderSize){this._renderer.getDrawingBufferSize(ji);const t=Math.floor(this.renderScale*ji.x),e=Math.floor(this.renderScale*ji.y);if(this._pathTracer.getSize(ji),ji.x!==t||ji.y!==e){const n=this.lowResScale;this._pathTracer.setSize(t,e),this._lowResPathTracer.setSize(Math.floor(t*n),Math.floor(e*n))}}}}class ox extends dd{constructor(...t){super(...t),this.iesMap=null,this.radius=0}copy(t,e){return super.copy(t,e),this.iesMap=t.iesMap,this.radius=t.radius,this}}/**
 * lil-gui
 * https://lil-gui.georgealways.com
 * @version 0.17.0
 * @author George Michael Brower
 * @license MIT
 */class Sn{constructor(t,e,n,s,r="div"){this.parent=t,this.object=e,this.property=n,this._disabled=!1,this._hidden=!1,this.initialValue=this.getValue(),this.domElement=document.createElement("div"),this.domElement.classList.add("controller"),this.domElement.classList.add(s),this.$name=document.createElement("div"),this.$name.classList.add("name"),Sn.nextNameID=Sn.nextNameID||0,this.$name.id="lil-gui-name-"+ ++Sn.nextNameID,this.$widget=document.createElement(r),this.$widget.classList.add("widget"),this.$disable=this.$widget,this.domElement.appendChild(this.$name),this.domElement.appendChild(this.$widget),this.parent.children.push(this),this.parent.controllers.push(this),this.parent.$children.appendChild(this.domElement),this._listenCallback=this._listenCallback.bind(this),this.name(n)}name(t){return this._name=t,this.$name.innerHTML=t,this}onChange(t){return this._onChange=t,this}_callOnChange(){this.parent._callOnChange(this),this._onChange!==void 0&&this._onChange.call(this,this.getValue()),this._changed=!0}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(){this._changed&&(this.parent._callOnFinishChange(this),this._onFinishChange!==void 0&&this._onFinishChange.call(this,this.getValue())),this._changed=!1}reset(){return this.setValue(this.initialValue),this._callOnFinishChange(),this}enable(t=!0){return this.disable(!t)}disable(t=!0){return t===this._disabled||(this._disabled=t,this.domElement.classList.toggle("disabled",t),this.$disable.toggleAttribute("disabled",t)),this}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}options(t){const e=this.parent.add(this.object,this.property,t);return e.name(this._name),this.destroy(),e}min(t){return this}max(t){return this}step(t){return this}decimals(t){return this}listen(t=!0){return this._listening=t,this._listenCallbackID!==void 0&&(cancelAnimationFrame(this._listenCallbackID),this._listenCallbackID=void 0),this._listening&&this._listenCallback(),this}_listenCallback(){this._listenCallbackID=requestAnimationFrame(this._listenCallback);const t=this.save();t!==this._listenPrevValue&&this.updateDisplay(),this._listenPrevValue=t}getValue(){return this.object[this.property]}setValue(t){return this.object[this.property]=t,this._callOnChange(),this.updateDisplay(),this}updateDisplay(){return this}load(t){return this.setValue(t),this._callOnFinishChange(),this}save(){return this.getValue()}destroy(){this.listen(!1),this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.controllers.splice(this.parent.controllers.indexOf(this),1),this.parent.$children.removeChild(this.domElement)}}class lx extends Sn{constructor(t,e,n){super(t,e,n,"boolean","label"),this.$input=document.createElement("input"),this.$input.setAttribute("type","checkbox"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$input.addEventListener("change",()=>{this.setValue(this.$input.checked),this._callOnFinishChange()}),this.$disable=this.$input,this.updateDisplay()}updateDisplay(){return this.$input.checked=this.getValue(),this}}function il(i){let t,e;return(t=i.match(/(#|0x)?([a-f0-9]{6})/i))?e=t[2]:(t=i.match(/rgb\(\s*(\d*)\s*,\s*(\d*)\s*,\s*(\d*)\s*\)/))?e=parseInt(t[1]).toString(16).padStart(2,0)+parseInt(t[2]).toString(16).padStart(2,0)+parseInt(t[3]).toString(16).padStart(2,0):(t=i.match(/^#?([a-f0-9])([a-f0-9])([a-f0-9])$/i))&&(e=t[1]+t[1]+t[2]+t[2]+t[3]+t[3]),!!e&&"#"+e}const cx={isPrimitive:!0,match:i=>typeof i=="string",fromHexString:il,toHexString:il},Vs={isPrimitive:!0,match:i=>typeof i=="number",fromHexString:i=>parseInt(i.substring(1),16),toHexString:i=>"#"+i.toString(16).padStart(6,0)},ux={isPrimitive:!1,match:Array.isArray,fromHexString(i,t,e=1){const n=Vs.fromHexString(i);t[0]=(n>>16&255)/255*e,t[1]=(n>>8&255)/255*e,t[2]=(255&n)/255*e},toHexString:([i,t,e],n=1)=>Vs.toHexString(i*(n=255/n)<<16^t*n<<8^e*n<<0)},hx={isPrimitive:!1,match:i=>Object(i)===i,fromHexString(i,t,e=1){const n=Vs.fromHexString(i);t.r=(n>>16&255)/255*e,t.g=(n>>8&255)/255*e,t.b=(255&n)/255*e},toHexString:({r:i,g:t,b:e},n=1)=>Vs.toHexString(i*(n=255/n)<<16^t*n<<8^e*n<<0)},fx=[cx,Vs,ux,hx];class dx extends Sn{constructor(t,e,n,s){var r;super(t,e,n,"color"),this.$input=document.createElement("input"),this.$input.setAttribute("type","color"),this.$input.setAttribute("tabindex",-1),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$text=document.createElement("input"),this.$text.setAttribute("type","text"),this.$text.setAttribute("spellcheck","false"),this.$text.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$display.appendChild(this.$input),this.$widget.appendChild(this.$display),this.$widget.appendChild(this.$text),this._format=(r=this.initialValue,fx.find(a=>a.match(r))),this._rgbScale=s,this._initialValueHexString=this.save(),this._textFocused=!1,this.$input.addEventListener("input",()=>{this._setValueFromHexString(this.$input.value)}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$text.addEventListener("input",()=>{const a=il(this.$text.value);a&&this._setValueFromHexString(a)}),this.$text.addEventListener("focus",()=>{this._textFocused=!0,this.$text.select()}),this.$text.addEventListener("blur",()=>{this._textFocused=!1,this.updateDisplay(),this._callOnFinishChange()}),this.$disable=this.$text,this.updateDisplay()}reset(){return this._setValueFromHexString(this._initialValueHexString),this}_setValueFromHexString(t){if(this._format.isPrimitive){const e=this._format.fromHexString(t);this.setValue(e)}else this._format.fromHexString(t,this.getValue(),this._rgbScale),this._callOnChange(),this.updateDisplay()}save(){return this._format.toHexString(this.getValue(),this._rgbScale)}load(t){return this._setValueFromHexString(t),this._callOnFinishChange(),this}updateDisplay(){return this.$input.value=this._format.toHexString(this.getValue(),this._rgbScale),this._textFocused||(this.$text.value=this.$input.value.substring(1)),this.$display.style.backgroundColor=this.$input.value,this}}class io extends Sn{constructor(t,e,n){super(t,e,n,"function"),this.$button=document.createElement("button"),this.$button.appendChild(this.$name),this.$widget.appendChild(this.$button),this.$button.addEventListener("click",s=>{s.preventDefault(),this.getValue().call(this.object)}),this.$button.addEventListener("touchstart",()=>{},{passive:!0}),this.$disable=this.$button}}class px extends Sn{constructor(t,e,n,s,r,a){super(t,e,n,"number"),this._initInput(),this.min(s),this.max(r);const o=a!==void 0;this.step(o?a:this._getImplicitStep(),o),this.updateDisplay()}decimals(t){return this._decimals=t,this.updateDisplay(),this}min(t){return this._min=t,this._onUpdateMinMax(),this}max(t){return this._max=t,this._onUpdateMinMax(),this}step(t,e=!0){return this._step=t,this._stepExplicit=e,this}updateDisplay(){const t=this.getValue();if(this._hasSlider){let e=(t-this._min)/(this._max-this._min);e=Math.max(0,Math.min(e,1)),this.$fill.style.width=100*e+"%"}return this._inputFocused||(this.$input.value=this._decimals===void 0?t:t.toFixed(this._decimals)),this}_initInput(){this.$input=document.createElement("input"),this.$input.setAttribute("type","number"),this.$input.setAttribute("step","any"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$disable=this.$input;const t=h=>{const f=parseFloat(this.$input.value);isNaN(f)||(this._snapClampSetValue(f+h),this.$input.value=this.getValue())};let e,n,s,r,a,o=!1;const l=h=>{if(o){const f=h.clientX-e,c=h.clientY-n;Math.abs(c)>5?(h.preventDefault(),this.$input.blur(),o=!1,this._setDraggingStyle(!0,"vertical")):Math.abs(f)>5&&u()}if(!o){const f=h.clientY-s;a-=f*this._step*this._arrowKeyMultiplier(h),r+a>this._max?a=this._max-r:r+a<this._min&&(a=this._min-r),this._snapClampSetValue(r+a)}s=h.clientY},u=()=>{this._setDraggingStyle(!1,"vertical"),this._callOnFinishChange(),window.removeEventListener("mousemove",l),window.removeEventListener("mouseup",u)};this.$input.addEventListener("input",()=>{let h=parseFloat(this.$input.value);isNaN(h)||(this._stepExplicit&&(h=this._snap(h)),this.setValue(this._clamp(h)))}),this.$input.addEventListener("keydown",h=>{h.code==="Enter"&&this.$input.blur(),h.code==="ArrowUp"&&(h.preventDefault(),t(this._step*this._arrowKeyMultiplier(h))),h.code==="ArrowDown"&&(h.preventDefault(),t(this._step*this._arrowKeyMultiplier(h)*-1))}),this.$input.addEventListener("wheel",h=>{this._inputFocused&&(h.preventDefault(),t(this._step*this._normalizeMouseWheel(h)))},{passive:!1}),this.$input.addEventListener("mousedown",h=>{e=h.clientX,n=s=h.clientY,o=!0,r=this.getValue(),a=0,window.addEventListener("mousemove",l),window.addEventListener("mouseup",u)}),this.$input.addEventListener("focus",()=>{this._inputFocused=!0}),this.$input.addEventListener("blur",()=>{this._inputFocused=!1,this.updateDisplay(),this._callOnFinishChange()})}_initSlider(){this._hasSlider=!0,this.$slider=document.createElement("div"),this.$slider.classList.add("slider"),this.$fill=document.createElement("div"),this.$fill.classList.add("fill"),this.$slider.appendChild(this.$fill),this.$widget.insertBefore(this.$slider,this.$input),this.domElement.classList.add("hasSlider");const t=c=>{const m=this.$slider.getBoundingClientRect();let g=(_=c,d=m.left,p=m.right,x=this._min,y=this._max,(_-d)/(p-d)*(y-x)+x);var _,d,p,x,y;this._snapClampSetValue(g)},e=c=>{t(c.clientX)},n=()=>{this._callOnFinishChange(),this._setDraggingStyle(!1),window.removeEventListener("mousemove",e),window.removeEventListener("mouseup",n)};let s,r,a=!1;const o=c=>{c.preventDefault(),this._setDraggingStyle(!0),t(c.touches[0].clientX),a=!1},l=c=>{if(a){const m=c.touches[0].clientX-s,g=c.touches[0].clientY-r;Math.abs(m)>Math.abs(g)?o(c):(window.removeEventListener("touchmove",l),window.removeEventListener("touchend",u))}else c.preventDefault(),t(c.touches[0].clientX)},u=()=>{this._callOnFinishChange(),this._setDraggingStyle(!1),window.removeEventListener("touchmove",l),window.removeEventListener("touchend",u)},h=this._callOnFinishChange.bind(this);let f;this.$slider.addEventListener("mousedown",c=>{this._setDraggingStyle(!0),t(c.clientX),window.addEventListener("mousemove",e),window.addEventListener("mouseup",n)}),this.$slider.addEventListener("touchstart",c=>{c.touches.length>1||(this._hasScrollBar?(s=c.touches[0].clientX,r=c.touches[0].clientY,a=!0):o(c),window.addEventListener("touchmove",l,{passive:!1}),window.addEventListener("touchend",u))},{passive:!1}),this.$slider.addEventListener("wheel",c=>{if(Math.abs(c.deltaX)<Math.abs(c.deltaY)&&this._hasScrollBar)return;c.preventDefault();const m=this._normalizeMouseWheel(c)*this._step;this._snapClampSetValue(this.getValue()+m),this.$input.value=this.getValue(),clearTimeout(f),f=setTimeout(h,400)},{passive:!1})}_setDraggingStyle(t,e="horizontal"){this.$slider&&this.$slider.classList.toggle("active",t),document.body.classList.toggle("lil-gui-dragging",t),document.body.classList.toggle("lil-gui-"+e,t)}_getImplicitStep(){return this._hasMin&&this._hasMax?(this._max-this._min)/1e3:.1}_onUpdateMinMax(){!this._hasSlider&&this._hasMin&&this._hasMax&&(this._stepExplicit||this.step(this._getImplicitStep(),!1),this._initSlider(),this.updateDisplay())}_normalizeMouseWheel(t){let{deltaX:e,deltaY:n}=t;return Math.floor(t.deltaY)!==t.deltaY&&t.wheelDelta&&(e=0,n=-t.wheelDelta/120,n*=this._stepExplicit?1:10),e+-n}_arrowKeyMultiplier(t){let e=this._stepExplicit?1:10;return t.shiftKey?e*=10:t.altKey&&(e/=10),e}_snap(t){const e=Math.round(t/this._step)*this._step;return parseFloat(e.toPrecision(15))}_clamp(t){return t<this._min&&(t=this._min),t>this._max&&(t=this._max),t}_snapClampSetValue(t){this.setValue(this._clamp(this._snap(t)))}get _hasScrollBar(){const t=this.parent.root.$children;return t.scrollHeight>t.clientHeight}get _hasMin(){return this._min!==void 0}get _hasMax(){return this._max!==void 0}}class mx extends Sn{constructor(t,e,n,s){super(t,e,n,"option"),this.$select=document.createElement("select"),this.$select.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this._values=Array.isArray(s)?s:Object.values(s),this._names=Array.isArray(s)?s:Object.keys(s),this._names.forEach(r=>{const a=document.createElement("option");a.innerHTML=r,this.$select.appendChild(a)}),this.$select.addEventListener("change",()=>{this.setValue(this._values[this.$select.selectedIndex]),this._callOnFinishChange()}),this.$select.addEventListener("focus",()=>{this.$display.classList.add("focus")}),this.$select.addEventListener("blur",()=>{this.$display.classList.remove("focus")}),this.$widget.appendChild(this.$select),this.$widget.appendChild(this.$display),this.$disable=this.$select,this.updateDisplay()}updateDisplay(){const t=this.getValue(),e=this._values.indexOf(t);return this.$select.selectedIndex=e,this.$display.innerHTML=e===-1?t:this._names[e],this}}class gx extends Sn{constructor(t,e,n){super(t,e,n,"string"),this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$input.addEventListener("input",()=>{this.setValue(this.$input.value)}),this.$input.addEventListener("keydown",s=>{s.code==="Enter"&&this.$input.blur()}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$widget.appendChild(this.$input),this.$disable=this.$input,this.updateDisplay()}updateDisplay(){return this.$input.value=this.getValue(),this}}let fu=!1;class Sl{constructor({parent:t,autoPlace:e=t===void 0,container:n,width:s,title:r="Controls",injectStyles:a=!0,touchStyles:o=!0}={}){if(this.parent=t,this.root=t?t.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",l=>{l.code!=="Enter"&&l.code!=="Space"||(l.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(r),o&&this.domElement.classList.add("allow-touch-styles"),this.parent)return this.parent.children.push(this),this.parent.folders.push(this),void this.parent.$children.appendChild(this.domElement);this.domElement.classList.add("root"),!fu&&a&&(function(l){const u=document.createElement("style");u.innerHTML=l;const h=document.querySelector("head link[rel=stylesheet], head style");h?document.head.insertBefore(u,h):document.head.appendChild(u)}('.lil-gui{--background-color:#1f1f1f;--text-color:#ebebeb;--title-background-color:#111;--title-text-color:#ebebeb;--widget-color:#424242;--hover-color:#4f4f4f;--focus-color:#595959;--number-color:#2cc9ff;--string-color:#a2db3c;--font-size:11px;--input-font-size:11px;--font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Arial,sans-serif;--font-family-mono:Menlo,Monaco,Consolas,"Droid Sans Mono",monospace;--padding:4px;--spacing:4px;--widget-height:20px;--name-width:45%;--slider-knob-width:2px;--slider-input-width:27%;--color-input-width:27%;--slider-input-min-width:45px;--color-input-min-width:45px;--folder-indent:7px;--widget-padding:0 0 0 3px;--widget-border-radius:2px;--checkbox-size:calc(var(--widget-height)*0.75);--scrollbar-width:5px;background-color:var(--background-color);color:var(--text-color);font-family:var(--font-family);font-size:var(--font-size);font-style:normal;font-weight:400;line-height:1;text-align:left;touch-action:manipulation;user-select:none;-webkit-user-select:none}.lil-gui,.lil-gui *{box-sizing:border-box;margin:0;padding:0}.lil-gui.root{display:flex;flex-direction:column;width:var(--width,245px)}.lil-gui.root>.title{background:var(--title-background-color);color:var(--title-text-color)}.lil-gui.root>.children{overflow-x:hidden;overflow-y:auto}.lil-gui.root>.children::-webkit-scrollbar{background:var(--background-color);height:var(--scrollbar-width);width:var(--scrollbar-width)}.lil-gui.root>.children::-webkit-scrollbar-thumb{background:var(--focus-color);border-radius:var(--scrollbar-width)}.lil-gui.force-touch-styles{--widget-height:28px;--padding:6px;--spacing:6px;--font-size:13px;--input-font-size:16px;--folder-indent:10px;--scrollbar-width:7px;--slider-input-min-width:50px;--color-input-min-width:65px}.lil-gui.autoPlace{max-height:100%;position:fixed;right:15px;top:0;z-index:1001}.lil-gui .controller{align-items:center;display:flex;margin:var(--spacing) 0;padding:0 var(--padding)}.lil-gui .controller.disabled{opacity:.5}.lil-gui .controller.disabled,.lil-gui .controller.disabled *{pointer-events:none!important}.lil-gui .controller>.name{flex-shrink:0;line-height:var(--widget-height);min-width:var(--name-width);padding-right:var(--spacing);white-space:pre}.lil-gui .controller .widget{align-items:center;display:flex;min-height:var(--widget-height);position:relative;width:100%}.lil-gui .controller.string input{color:var(--string-color)}.lil-gui .controller.boolean .widget{cursor:pointer}.lil-gui .controller.color .display{border-radius:var(--widget-border-radius);height:var(--widget-height);position:relative;width:100%}.lil-gui .controller.color input[type=color]{cursor:pointer;height:100%;opacity:0;width:100%}.lil-gui .controller.color input[type=text]{flex-shrink:0;font-family:var(--font-family-mono);margin-left:var(--spacing);min-width:var(--color-input-min-width);width:var(--color-input-width)}.lil-gui .controller.option select{max-width:100%;opacity:0;position:absolute;width:100%}.lil-gui .controller.option .display{background:var(--widget-color);border-radius:var(--widget-border-radius);height:var(--widget-height);line-height:var(--widget-height);max-width:100%;overflow:hidden;padding-left:.55em;padding-right:1.75em;pointer-events:none;position:relative;word-break:break-all}.lil-gui .controller.option .display.active{background:var(--focus-color)}.lil-gui .controller.option .display:after{bottom:0;content:"↕";font-family:lil-gui;padding-right:.375em;position:absolute;right:0;top:0}.lil-gui .controller.option .widget,.lil-gui .controller.option select{cursor:pointer}.lil-gui .controller.number input{color:var(--number-color)}.lil-gui .controller.number.hasSlider input{flex-shrink:0;margin-left:var(--spacing);min-width:var(--slider-input-min-width);width:var(--slider-input-width)}.lil-gui .controller.number .slider{background-color:var(--widget-color);border-radius:var(--widget-border-radius);cursor:ew-resize;height:var(--widget-height);overflow:hidden;padding-right:var(--slider-knob-width);touch-action:pan-y;width:100%}.lil-gui .controller.number .slider.active{background-color:var(--focus-color)}.lil-gui .controller.number .slider.active .fill{opacity:.95}.lil-gui .controller.number .fill{border-right:var(--slider-knob-width) solid var(--number-color);box-sizing:content-box;height:100%}.lil-gui-dragging .lil-gui{--hover-color:var(--widget-color)}.lil-gui-dragging *{cursor:ew-resize!important}.lil-gui-dragging.lil-gui-vertical *{cursor:ns-resize!important}.lil-gui .title{--title-height:calc(var(--widget-height) + var(--spacing)*1.25);-webkit-tap-highlight-color:transparent;text-decoration-skip:objects;cursor:pointer;font-weight:600;height:var(--title-height);line-height:calc(var(--title-height) - 4px);outline:none;padding:0 var(--padding)}.lil-gui .title:before{content:"▾";display:inline-block;font-family:lil-gui;padding-right:2px}.lil-gui .title:active{background:var(--title-background-color);opacity:.75}.lil-gui.root>.title:focus{text-decoration:none!important}.lil-gui.closed>.title:before{content:"▸"}.lil-gui.closed>.children{opacity:0;transform:translateY(-7px)}.lil-gui.closed:not(.transition)>.children{display:none}.lil-gui.transition>.children{overflow:hidden;pointer-events:none;transition-duration:.3s;transition-property:height,opacity,transform;transition-timing-function:cubic-bezier(.2,.6,.35,1)}.lil-gui .children:empty:before{content:"Empty";display:block;font-style:italic;height:var(--widget-height);line-height:var(--widget-height);margin:var(--spacing) 0;opacity:.5;padding:0 var(--padding)}.lil-gui.root>.children>.lil-gui>.title{border-width:0;border-bottom:1px solid var(--widget-color);border-left:0 solid var(--widget-color);border-right:0 solid var(--widget-color);border-top:1px solid var(--widget-color);transition:border-color .3s}.lil-gui.root>.children>.lil-gui.closed>.title{border-bottom-color:transparent}.lil-gui+.controller{border-top:1px solid var(--widget-color);margin-top:0;padding-top:var(--spacing)}.lil-gui .lil-gui .lil-gui>.title{border:none}.lil-gui .lil-gui .lil-gui>.children{border:none;border-left:2px solid var(--widget-color);margin-left:var(--folder-indent)}.lil-gui .lil-gui .controller{border:none}.lil-gui input{-webkit-tap-highlight-color:transparent;background:var(--widget-color);border:0;border-radius:var(--widget-border-radius);color:var(--text-color);font-family:var(--font-family);font-size:var(--input-font-size);height:var(--widget-height);outline:none;width:100%}.lil-gui input:disabled{opacity:1}.lil-gui input[type=number],.lil-gui input[type=text]{padding:var(--widget-padding)}.lil-gui input[type=number]:focus,.lil-gui input[type=text]:focus{background:var(--focus-color)}.lil-gui input::-webkit-inner-spin-button,.lil-gui input::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}.lil-gui input[type=number]{-moz-appearance:textfield}.lil-gui input[type=checkbox]{appearance:none;-webkit-appearance:none;border-radius:var(--widget-border-radius);cursor:pointer;height:var(--checkbox-size);text-align:center;width:var(--checkbox-size)}.lil-gui input[type=checkbox]:checked:before{content:"✓";font-family:lil-gui;font-size:var(--checkbox-size);line-height:var(--checkbox-size)}.lil-gui button{-webkit-tap-highlight-color:transparent;background:var(--widget-color);border:1px solid var(--widget-color);border-radius:var(--widget-border-radius);color:var(--text-color);cursor:pointer;font-family:var(--font-family);font-size:var(--font-size);height:var(--widget-height);line-height:calc(var(--widget-height) - 4px);outline:none;text-align:center;text-transform:none;width:100%}.lil-gui button:active{background:var(--focus-color)}@font-face{font-family:lil-gui;src:url("data:application/font-woff;charset=utf-8;base64,") format("woff")}@media (pointer:coarse){.lil-gui.allow-touch-styles{--widget-height:28px;--padding:6px;--spacing:6px;--font-size:13px;--input-font-size:16px;--folder-indent:10px;--scrollbar-width:7px;--slider-input-min-width:50px;--color-input-min-width:65px}}@media (hover:hover){.lil-gui .controller.color .display:hover:before{border:1px solid #fff9;border-radius:var(--widget-border-radius);bottom:0;content:" ";display:block;left:0;position:absolute;right:0;top:0}.lil-gui .controller.option .display.focus{background:var(--focus-color)}.lil-gui .controller.option .widget:hover .display{background:var(--hover-color)}.lil-gui .controller.number .slider:hover{background-color:var(--hover-color)}body:not(.lil-gui-dragging) .lil-gui .title:hover{background:var(--title-background-color);opacity:.85}.lil-gui .title:focus{text-decoration:underline var(--focus-color)}.lil-gui input:hover{background:var(--hover-color)}.lil-gui input:active{background:var(--focus-color)}.lil-gui input[type=checkbox]:focus{box-shadow:inset 0 0 0 1px var(--focus-color)}.lil-gui button:hover{background:var(--hover-color);border-color:var(--hover-color)}.lil-gui button:focus{border-color:var(--focus-color)}}'),fu=!0),n?n.appendChild(this.domElement):e&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),s&&this.domElement.style.setProperty("--width",s+"px"),this.domElement.addEventListener("keydown",l=>l.stopPropagation()),this.domElement.addEventListener("keyup",l=>l.stopPropagation())}add(t,e,n,s,r){if(Object(n)===n)return new mx(this,t,e,n);const a=t[e];switch(typeof a){case"number":return new px(this,t,e,n,s,r);case"boolean":return new lx(this,t,e);case"string":return new gx(this,t,e);case"function":return new io(this,t,e)}console.error(`gui.add failed
	property:`,e,`
	object:`,t,`
	value:`,a)}addColor(t,e,n=1){return new dx(this,t,e,n)}addFolder(t){return new Sl({parent:this,title:t})}load(t,e=!0){return t.controllers&&this.controllers.forEach(n=>{n instanceof io||n._name in t.controllers&&n.load(t.controllers[n._name])}),e&&t.folders&&this.folders.forEach(n=>{n._title in t.folders&&n.load(t.folders[n._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof io)){if(n._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);e.controllers[n._name]=n.save()}}),t&&this.folders.forEach(n=>{if(n._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);e.folders[n._title]=n.save()}),e}open(t=!0){return this._closed=!t,this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._closed=!t,this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const n=r=>{r.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const s=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=s+"px"})}),this}title(t){return this._title=t,this.$title.innerHTML=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(e=>e.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}let du=function(i,t,e){let n=Math.cos(i)*Math.sin(e),s=Math.sin(i)*Math.sin(e),r=Math.cos(t)*Math.cos(e),a=Math.sin(t)*Math.cos(e);return new Kt(n,r,-s,a)},pu=function(i){return new D(i.y,-i.x,i.w).divideScalar(1-i.z)},Or=function(i=glassColor,t=!1){let e={color:i,clearcoat:1,roughness:.1,metalness:0};return t&&(e.transparent=!0,e.opacity=1,e.transmission=.5,e.ior=1.05,e.thickness=.2),new Hu(e)},$n={red:13908795,orange:12737323,yellow:15248426,green:4432699,blue:4360181,purple:8210109,pink:13584575,glass:13232895},_x={medium:15248426,dark:13405444};class mu extends Se{constructor(t=(s,r,a)=>a.set(s,r,Math.cos(s)*Math.sin(r)),e=8,n=8){super(),this.type="ParametricGeometry",this.parameters={func:t,slices:e,stacks:n};const s=[],r=[],a=[],o=[],l=1e-5,u=new D,h=new D,f=new D,c=new D,m=new D,g=e+1;for(let _=0;_<=n;_++){const d=_/n;for(let p=0;p<=e;p++){const x=p/e;t(x,d,h),r.push(h.x,h.y,h.z),x-l>=0?(t(x-l,d,f),c.subVectors(h,f)):(t(x+l,d,f),c.subVectors(f,h)),d-l>=0?(t(x,d-l,f),m.subVectors(h,f)):(t(x,d+l,f),m.subVectors(f,h)),u.crossVectors(c,m).normalize(),a.push(u.x,u.y,u.z),o.push(x,d)}}for(let _=0;_<n;_++)for(let d=0;d<e;d++){const p=_*g+d,x=_*g+d+1,y=(_+1)*g+d+1,v=(_+1)*g+d;s.push(p,x,v),s.push(x,y,v)}this.setIndex(s),this.setAttribute("position",new ye(r,3)),this.setAttribute("normal",new ye(a,3)),this.setAttribute("uv",new ye(o,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}}const gu=new Go([new D(-1,-1,0),new D(-1,1,0),new D(1,1,0)]);class vx extends Se{constructor(t=gu,e=gu,n=64,s=8,r=!1){super(),this.type="TubeGeometry",this.parameters={path:t,tubularSegments:n,radii:e,radialSegments:s,closed:r};const a=t.computeFrenetFrames(n,r);this.tangents=a.tangents,this.normals=a.normals,this.binormals=a.binormals;const o=new D,l=new D,u=new ut;let h=new D,f;const c=[],m=[],g=[],_=[];d(),this.setIndex(_),this.setAttribute("position",new ye(c,3)),this.setAttribute("normal",new ye(m,3)),this.setAttribute("uv",new ye(g,2));function d(){for(let v=0;v<n;v++)p(v);p(r===!1?n:0),y(),x()}function p(v){h=t.getPointAt(v/n,h),f=e.getPointAt(v/n,f);const T=a.normals[v],A=a.binormals[v];for(let w=0;w<=s;w++){const P=w/s*Math.PI*2,b=Math.sin(P),M=-Math.cos(P);l.x=M*T.x+b*A.x,l.y=M*T.y+b*A.y,l.z=M*T.z+b*A.z,l.normalize(),m.push(l.x,l.y,l.z),o.x=h.x+f.x*l.x,o.y=h.y+f.x*l.y,o.z=h.z+f.x*l.z,c.push(o.x,o.y,o.z)}}function x(){for(let v=1;v<=n;v++)for(let T=1;T<=s;T++){const A=(s+1)*(v-1)+(T-1),w=(s+1)*v+(T-1),P=(s+1)*v+T,b=(s+1)*(v-1)+T;_.push(A,w,b),_.push(w,P,b)}}function y(){for(let v=0;v<=n;v++)for(let T=0;T<=s;T++)u.x=v/n,u.y=T/s,g.push(u.x,u.y)}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}}class xx{constructor(t,e){this.coordCurve=t,this.length=e.length,this.area=e.area,this.tau=e.tau,this.fromTauCoords=e.fromTauCoords,this.res=256;let n=function(o){let l=25e-5,u=Math.floor(o/l),h=0,f=0;for(let c=0;c<u;c++){let m=t(f),g=t(f+l),_=Math.sin(m.phi/2),d=g.theta-m.theta;h+=_*_*d,f+=l}return h},s=function(o){let l=0,u=0,h=3e3,f=2*Math.PI/h;for(let c=0;c<h;c++){let m=t(l),g=t(l+f),_=Math.sin(m.phi),d=g.theta-m.theta,p=g.phi-m.phi,x=_*_*d*d+p*p,y=Math.sqrt(x);if(u+=y,u>o)break;l+=f}return l},r=function(o){let l=new ut(e.area/2,e.length/2);for(;o.y>e.length/2;)o=o.sub(l);return o};this.toFundamentalDomain=r;let a=function(o){o=r(o);let l=o.x,u=o.y,h=s(2*u),f=t(h),c=f.phi,m=f.theta,g=n(h),_=du(m+l-g,l-g,c/2);return pu(_)};this.isometricImage=a}getSurface(t=$n.glass,e=!1){let n=this.coordCurve,s=function(o,l,u){let h=2*Math.PI*o,f=2*Math.PI*l,c=n(f),m=c.phi,g=c.theta,_=du(g+h,h,m/2),d=pu(_);u.set(d.x,d.y,d.z)},r=new mu(s,this.res,this.res),a=Or(t,e);return new Ae(r,a)}getSubSurface(t,e=$n.glass,n=!1){let s=this.isometricImage,r=function(l,u,h){let f=t(l,u),c=s(f);h.set(c.x,c.y,c.z)},a=new mu(r,512,512);a.computeVertexNormals();let o=Or(e,n);return o.side=sn,new Ae(a,o)}getLift(t,e=$n.red,n=.05,s=!1,r=!1){let a=[],o=[];for(let c=0;c<this.res+1;c++){let m=c/this.res,g=t(m),_=this.isometricImage(g);a.push(_);let d=n*(1+_.lengthSq());o.push(new D(d,d,d))}let l=new Go(a),u=new Go(o),h=new vx(l,u,2*this.res,16,r),f=Or(e,s);return new Ae(h,f)}getFiberAt(t,e=$n.blue,n=.025,s=!1){let a=new ut(this.area/2,this.length/2).multiplyScalar(t),o=new ut(2*Math.PI,0),l=function(u){return a.clone().add(o.clone().multiplyScalar(u))};return this.getLift(l,e,n,s)}getOppEdgeAt(t,e=$n.blue,n=.025,s=!1){let r=new ut(-this.area/2,this.length/2),a=new ut(2*Math.PI,0).multiplyScalar(t),o=function(l){return a.clone().add(r.clone().multiplyScalar(l))};return this.getLift(o,e,n,s)}getEdgeAt(t,e=$n.blue,n=.025,s=!1){let r=new ut(this.area/2,this.length/2),a=new ut(2*Math.PI,0).multiplyScalar(t),o=function(l){return a.clone().add(r.clone().multiplyScalar(l))};return this.getLift(o,e,n,s)}getGridlines(t,e=$n.blue,n=.025,s=!1){let r=new ts;for(let a=0;a<t+1;a++){let o=this.getFiberAt(a/t,e,n,s),l=this.getEdgeAt(a/t,e,n,s);r.add(o),r.add(l)}return r}getPoint(t,e=$n.red,n=.05,s=!1){let r=this.isometricImage(t),a=1+r.lengthSq(),o=new dl(n*a),l=Or(e,s),u=new Ae(o,l);return u.position.set(r.x,r.y,r.z),u}}const yx=new ut(0,Math.sqrt(2)),Mx=4*Math.PI/3,bx=4*Math.PI/3*Math.sqrt(2);let Sx=function(i){const t=Math.acos(2*Math.sqrt(2)/3);return{phi:Math.PI/2-t,theta:i}},Tx=function(i){let t=i[0],e=i[1],n=Math.sqrt(2/3),s=Math.sqrt(1/3),r=s*t-n*e,a=n*t+s*e;return r=r/Math.sqrt(3),a=a/Math.sqrt(3),new ut(r,a).multiplyScalar(2*Math.PI)},Ex={tau:yx,length:bx,area:Mx,fromTauCoords:Tx};const _u=[[.38518518,1.07899256],[.23703703,.69663112],[.92592592,.16237266],[.22962962,1.09470605],[.77037037,.17808615],[.16296296,1.00042514],[.61481481,.19379963],[.15555555,1.39850007],[.0074074,1.01613863],[.45925925,.20951312],[.39259259,.11523221],[.93333333,1.1785113],[.38518518,.51330714],[.23703703,.1309457],[.22962962,.52902062],[.08148148,.14665918],[.07407407,.54473411],[.63703703,.27236705],[.62962962,.67044198],[.4,.98994949],[.25185185,.60758804],[.85185185,.18332398],[.24444444,1.00566297],[.09629629,.62330153],[.08888888,1.02137646],[.62962962,.10475656],[.47407407,.12047004],[.01481481,1.32517048],[.31851851,.13618352],[.31111111,.53425845],[.94814814,1.08946822],[.25185185,.04190262],[.79259259,1.1051817],[.24444444,.43997755],[.09629629,.0576161],[.08888888,.45569103],[.48888888,.59711239],[.48148148,.99518732],[.86666666,.0942809],[.25925925,.9166199],[.11111111,.53425845],[.71111111,.10999438],[.1037037,.93233338],[.48888888,.03142696],[.48148148,.42950189],[.33333333,.04714045],[.32592592,.44521538],[.17777777,.06285393],[.17037037,.46092886],[.02222222,.07856742],[.8074074,1.01613863],[.49629629,.90614424],[.34814814,.5237828],[.26666666,1.36707311],[.34074074,.92185772],[.72592592,.02095131],[.57037037,.03666479],[.49629629,.34045882],[.88888888,1.02137646],[.34074074,.3561723],[.18518518,.37188578],[.02962962,.38759927],[.65925925,1.34088397],[.5037037,1.35659745],[.88888888,.45569103],[.88148148,.85376596],[.2074074,.4504532],[.2,.84852813],[.9037037,.93233338],[.89629629,1.33040831],[.74814814,.94804686],[.2,.28284271],[.74074074,1.34612179],[.04444444,.29855619],[.97777777,.06285393],[.51851851,1.26755437],[.36296296,1.28326786],[.91851851,1.40897573],[.74814814,.38236144],[.74074074,.78043637],[.06666666,.37712361],[.05925925,.77519854],[.99259259,.53949628],[.98518518,.93757121],[.91851851,.8432903],[.91111111,1.24136523],[.76296296,.85900379],[.12592592,.30379402],[.75555555,1.25707872],[.6074074,.87471727],[.05925925,.20951312],[.6,1.2727922],[.45185185,.89043076],[.98518518,.37188578],[.37777777,1.19422478],[.22222222,1.20993827],[.77777777,1.33564614],[.6074074,.30903185],[.62222222,1.35135962],[.6,.70710678],[.45185185,.32474533],[.84444444,.86424162],[.83703703,1.26231655],[.14074074,.21475094],[.77777777,.76996071],[.77037037,1.16803564],[.62222222,.7856742],[.61481481,1.18374912],[.46666666,.80138768],[.45925925,1.19946261],[.84444444,.29855619],[.23703703,1.12089519],[.83703703,.69663112],[.68888888,.31426968],[.08148148,1.13660867],[.63703703,1.26231655],[.85925925,.77519854],[.85185185,1.17327347],[.7037037,.79091202],[.15555555,.12570787],[.69629629,1.18898695],[0,.14142135],[.63703703,.69663112],[.62962962,1.09470605],[.47407407,1.11041953],[.31851851,1.12613302],[.85925925,.20951312],[.85185185,.60758804],[.7037037,.2252266],[.09629629,1.0475656],[.69629629,.62330153],[.54814814,.24094008],[.87407407,.68615546],[.86666666,1.08423039],[.71851851,.70186895],[.71111111,1.09994388],[.56296296,.71758243],[.01481481,.05237828],[.55555555,1.11565736],[.48888888,1.02137646],[.94074074,.21475094],[.33333333,1.03708994],[.78518518,.23046443],[.17777777,1.05280342],[.71851851,.13618352],[.02222222,1.06851691],[.71111111,.53425845],[.56296296,.15189701],[.55555555,.54997194],[.4074074,.16761049],[.96296296,.29331836],[.95555555,.69139329],[.02222222,.50283148],[.73333333,.61282587],[.72592592,1.0109008],[.57777777,.62853936],[.57037037,1.02661428],[.42222222,.64425284],[.41481481,1.04232777],[.95555555,.12570787],[.34814814,.94804686],[.8,.14142135],[.34074074,1.34612179],[.19259259,.96376035],[.64444444,.15713484],[.18518518,1.36183528],[.03703703,.97947383],[.57777777,.06285393],[.02962962,1.37754876],[.57037037,.46092886],[.42222222,.07856742],[.41481481,.47664234],[.26666666,.0942809],[.97037037,.60235022],[.82222222,.21998877],[.81481481,.6180637],[.59259259,.53949628],[.58518518,.93757121],[.43703703,.55520976],[.42962962,.95328469],[.28148148,.57092325],[.97037037,.03666479],[.27407407,.96899818],[.81481481,.05237828],[.11851851,.98471166],[.2074074,.87471727],[.65925925,.06809176],[.2,1.2727922],[.05185185,.89043076],[.65185185,.46616669],[.5037037,.08380524],[.04444444,1.28850569],[.97777777,1.05280342],[.42962962,.38759927],[.28148148,.00523782],[.27407407,.40331275],[.11851851,.41902624],[.82962962,.52902062],[.67407407,.54473411],[.06666666,1.36707311],[.66666666,.94280904],[.44444444,.86424162],[.29629629,.48188017],[.89629629,.0576161],[.28888888,.8799551],[.13333333,.89566858],[.12592592,1.29374351],[.06666666,.80138768],[.66666666,.37712361],[.05925925,1.19946261],[.51111111,.3928371],[.36296296,.01047565],[.35555555,.40855058],[.99259259,.96376035],[.98518518,1.36183528],[.3037037,1.35659745],[.13333333,.32998316],[.12592592,.72805809],[.68148148,.85376596],[.53333333,.47140452],[.45185185,1.31469483],[.52592592,.86947944],[.3037037,.79091202],[.14814814,.80662551],[.14074074,1.20470044],[.68148148,.28808054],[.52592592,.30379402],[.37037037,.3195075],[.21481481,.33522099],[.92592592,.44521538],[.84444444,1.28850569],[.68888888,1.30421917],[.16296296,1.28326786],[.54074074,.78043637],[.39259259,.39807492],[.38518518,.79614985],[.16296296,.71758243],[.15555555,1.11565736],[.0074074,.73329592],[0,1.13137084],[.54074074,.21475094],[.93333333,.89566858],[.38518518,.23046443],[.22962962,.24617791],[.07407407,.2618914],[.7037037,1.21517609],[.54814814,1.23088958],[.93333333,.32998316],[.4,.70710678],[.25185185,.32474533],[.24444444,.72282026],[.01481481,1.04232777],[.31111111,.25141574],[.94814814,.80662551],[.4,.14142135],[.94074074,1.20470044],[.79259259,.82233899],[.24444444,.15713484],[.78518518,1.22041392],[.08888888,.17284832],[.56296296,1.1418465],[.4074074,1.15755998],[.96296296,1.28326786],[.79259259,.25665357],[.8074074,1.29898134],[.25925925,.63377718],[.11111111,.25141574],[.1037037,.64949067],[.48148148,.14665918],[.32592592,.16237266],[.96296296,.71758243],[.95555555,1.11565736],[.8074074,.73329592],[.17037037,.17808615],[.8,1.13137084],[.1037037,.08380524],[.64444444,1.14708433],[.42222222,1.06851691],[.49629629,.62330153],[.26666666,1.08423039],[.82222222,1.20993827],[.49629629,.0576161],[.88888888,.73853374],[.34074074,.07332959],[.88148148,1.13660867],[.18518518,.08904307],[.82222222,.64425284],[.02962962,.10475656],[.81481481,1.04232777],[.65925925,1.05804125],[.5037037,1.07375474],[.88888888,.17284832],[.28148148,.99518732],[.88148148,.57092325],[.11851851,1.40897573],[.9037037,.64949067],[.89629629,1.0475656],[.74814814,.66520415],[.2,0],[.74074074,1.06327908],[.04444444,.01571348],[.67407407,.96899818],[.66666666,1.36707311],[.51851851,.98471166],[.51111111,1.38278659],[.36296296,1.00042514],[.9037037,.08380524],[.35555555,1.39850007],[.89629629,.48188017],[.74814814,.09951873],[.74074074,.49759366],[.91851851,.56044759],[.91111111,.95852252],[.76296296,.57616108],[.75555555,.974236],[.6074074,.59187456],[.6,.98994949],[.53333333,.89566858],[.98518518,.08904307],[.52592592,1.29374351],[.37777777,.91138207],[.37037037,1.309457],[.22222222,.92709555],[.76296296,.01047565],[.21481481,1.32517048],[.77777777,1.05280342],[.75555555,.40855058],[.6074074,.02618914],[.6,.42426406],[.45185185,.04190262],[.39259259,1.38802442],[.23703703,1.4037379],[.92592592,.86947944],[.77777777,.487118],[.77037037,.88519293],[.62222222,.50283148],[.61481481,.90090641],[.46666666,.51854497],[.45925925,.9166199],[.39259259,.82233899],[.84444444,.01571348],[.38518518,1.22041392],[.23703703,.83805248],[.83703703,.41378841],[.68888888,.03142696],[.22962962,1.23612741],[.08148148,.85376596],[.07407407,1.25184089],[.63703703,.97947383],[.62962962,1.37754876],[.45925925,.35093447],[.85925925,.49235583],[.25185185,1.31469483],[.85185185,.89043076],[.09629629,1.33040831],[.63703703,.41378841],[.62962962,.81186334],[.47407407,.82757682],[.31851851,.8432903],[.31111111,1.24136523],[.25185185,.7490094],[.85185185,.32474533],[.24444444,1.14708433],[.09629629,.76472288],[.69629629,.34045882],[.08888888,1.16279781],[.48888888,1.30421917],[.31851851,.27760488],[.31111111,.67567981],[.87407407,.40331275],[.86666666,.80138768],[.71851851,.41902624],[.11111111,1.24136523],[.71111111,.81710116],[.48888888,.73853374],[.48148148,1.13660867],[.33333333,.75424723],[.32592592,1.15232216],[.17777777,.76996071],[.86666666,.23570226],[.17037037,1.16803564],[.02222222,.7856742],[.71111111,.25141574],[.55555555,.26712922],[.34814814,1.23088958],[.17777777,.20427529],[.17037037,.60235022],[.02222222,.21998877],[.73333333,.32998316],[.72592592,.72805809],[.57777777,.34569664],[.57037037,.74377157],[.49629629,1.0475656],[.34814814,.66520415],[.34074074,1.06327908],[.19259259,.68091764],[.18518518,1.07899256],[.03703703,.69663112],[.72592592,.16237266],[.02962962,1.09470605],[.57037037,.17808615],[.41481481,.19379963],[.97037037,.3195075],[.88888888,1.16279781],[.2074074,1.15755998],[.03703703,.1309457],[.02962962,.52902062],[.59259259,.25665357],[.58518518,.6547285],[.43703703,.27236705],[.42962962,.67044198],[.27407407,.68615546],[.2074074,.59187456],[.2,.98994949],[.05185185,.60758804],[.65185185,.18332398],[.04444444,1.00566297],[.58518518,.08904307],[.97777777,.76996071],[.42962962,.10475656],[.27407407,.12047004],[.11851851,.13618352],[.82962962,.24617791],[.74814814,1.08946822],[.06666666,1.08423039],[.99259259,1.24660306],[.44444444,.5813989],[.29629629,.19903746],[.28888888,.59711239],[.13333333,.61282587],[.12592592,1.0109008],[.06666666,.51854497],[.66666666,.0942809],[.05925925,.9166199],[.51111111,.10999438],[.35555555,.12570787],[.99259259,.68091764],[.98518518,1.07899256],[.28888888,.03142696],[.13333333,.04714045],[.12592592,.44521538],[.6074074,1.01613863],[.68148148,.57092325],[.45185185,1.03185211],[.3037037,.50806931],[.14814814,.5237828],[.14074074,.92185772],[.68148148,.00523782],[.52592592,.02095131],[.37037037,.03666479],[.21481481,.05237828],[.84444444,1.00566297],[.83703703,1.4037379],[.68888888,1.02137646],[.14074074,.3561723],[.54074074,.49759366],[.16296296,.43473972],[.15555555,.83281465],[.0074074,.4504532],[0,.84852813],[.63703703,1.4037379],[.93333333,.61282587],[.85925925,.9166199],[.85185185,1.31469483],[.7037037,.93233338],[.69629629,1.33040831],[.54814814,.94804686],[0,.28284271],[.93333333,.04714045],[.4,.42426406],[.87407407,1.39326225],[.71851851,1.40897573],[.01481481,.75948506],[.94814814,.5237828],[.94074074,.92185772],[.79259259,.53949628],[.78518518,.93757121],[.71851851,.8432903],[.71111111,1.24136523],[.56296296,.85900379],[.55555555,1.25707872],[.4074074,.87471727],[.96296296,1.00042514],[.94074074,.3561723],[.95555555,1.39850007],[.78518518,.37188578],[.25925925,.35093447],[.1037037,.36664796],[.02222222,1.20993827],[.73333333,1.31993265],[.57777777,1.33564614],[.42222222,1.35135962],[.96296296,.43473972],[.95555555,.83281465],[.8074074,.4504532],[.8,.84852813],[.64444444,.86424162],[.57777777,.76996071],[.57037037,1.16803564],[.42222222,.7856742],[.41481481,1.18374912],[.26666666,.80138768],[.97037037,1.309457],[.82222222,.92709555],[.81481481,1.32517048],[.64444444,.29855619],[.59259259,1.24660306],[.43703703,1.26231655],[.28148148,1.27803003],[.97037037,.74377157],[.82222222,.36141013],[.81481481,.75948506],[.65925925,.77519854],[.65185185,1.17327347],[.5037037,.79091202],[.43703703,.69663112],[.28148148,.7123446],[.88148148,.28808054],[.27407407,1.11041953],[.11851851,1.12613302],[.82962962,1.23612741],[.67407407,1.25184089],[.5037037,.2252266],[.9037037,.36664796],[.29629629,1.18898695],[.89629629,.76472288],[.82962962,.67044198],[.67407407,.68615546],[.66666666,1.08423039],[.51851851,.70186895],[.51111111,1.09994388],[.36296296,.71758243],[.35555555,1.11565736],[.89629629,.19903746],[.74074074,.21475094],[.13333333,1.03708994],[.53333333,1.1785113],[.36296296,.15189701],[.35555555,.54997194],[.91851851,.27760488],[.91111111,.67567981],[.76296296,.29331836],[.75555555,.69139329],[.68148148,.99518732],[.53333333,.61282587],[.52592592,1.0109008],[.37777777,.62853936],[.37037037,1.02661428],[.22222222,.64425284],[.91111111,.10999438],[.21481481,1.04232777],[.92592592,1.15232216],[.75555555,.12570787],[.6,.14142135],[.39259259,1.1051817],[.22222222,.07856742],[.21481481,.47664234],[.92592592,.58663673],[.77777777,.20427529],[.77037037,.60235022],[.62222222,.21998877],[.61481481,.6180637],[.46666666,.23570226],[.45925925,.63377718],[.54074074,.92185772],[.39259259,.53949628],[.38518518,.93757121],[.23703703,.55520976],[.83703703,.1309457],[.22962962,.95328469],[.08148148,.57092325],[.07407407,.96899818],[.61481481,.05237828],[.45925925,.06809176],[.93333333,1.03708994],[.25185185,1.03185211],[.08148148,.00523782],[.07407407,.40331275],[.63703703,.1309457],[.62962962,.52902062],[.47407407,.54473411],[.31851851,.56044759],[.31111111,.95852252],[.4,.84852813],[.25185185,.46616669],[.85185185,.04190262],[.24444444,.86424162],[.09629629,.48188017],[.69629629,.0576161],[.08888888,.8799551],[.31111111,.3928371],[.87407407,.12047004],[.79259259,.96376035],[.86666666,.51854497],[.25925925,1.34088397],[.11111111,.95852252],[.1037037,1.35659745],[.48888888,.45569103],[.48148148,.85376596],[.33333333,.47140452],[.32592592,.86947944],[.17777777,.487118],[.17037037,.88519293],[.11111111,.3928371],[.1037037,.79091202],[.49629629,1.33040831],[.32592592,.30379402],[.17037037,.3195075],[.73333333,.04714045],[.72592592,.44521538],[.49629629,.76472288],[.34814814,.38236144],[.34074074,.78043637],[.19259259,.39807492],[.18518518,.79614985],[.03703703,.41378841],[.82222222,1.35135962],[.02962962,.81186334],[.88888888,.8799551],[.88148148,1.27803003],[.18518518,.23046443],[.02962962,.24617791],[.58518518,.37188578],[.9037037,1.35659745],[.2074074,.30903185],[.74814814,1.37231093],[.2,.70710678],[.05185185,.32474533],[.04444444,.72282026],[.97777777,.487118],[.9037037,.79091202],[.89629629,1.18898695],[.74814814,.80662551],[.74074074,1.20470044],[.04444444,.15713484],[.44444444,.29855619],[.28888888,.31426968],[.91851851,1.26755437],[.76296296,1.28326786],[.06666666,.23570226],[.6074074,1.29898134],[.05925925,.63377718],[.99259259,.39807492],[.98518518,.79614985],[.12592592,.16237266],[.76296296,.71758243],[.75555555,1.11565736],[.6074074,.73329592],[.6,1.13137084],[.45185185,.7490094],[.3037037,.2252266],[.14814814,.24094008],[.14074074,.63901501],[.77777777,1.19422478],[.62222222,1.20993827],[.46666666,1.22565175],[.84444444,.72282026],[.83703703,1.12089519],[.68888888,.73853374],[.14074074,.07332959],[.46666666,.65996632],[.45925925,1.05804125],[.85925925,1.19946261],[.68888888,.17284832],[.16296296,.15189701],[.15555555,.54997194],[.0074074,.16761049],[0,.56568542],[.63703703,1.12089519],[.85925925,.63377718],[.85185185,1.03185211],[.7037037,.64949067],[.69629629,1.0475656],[.54814814,.66520415],[0,0],[.31851851,.98471166],[.31111111,1.38278659],[.87407407,1.11041953],[.71851851,1.12613302],[.54814814,.09951873],[.01481481,.47664234],[.94814814,.24094008],[.94074074,.63901501],[.78518518,.6547285],[.87407407,.54473411],[.86666666,.94280904],[.71851851,.56044759],[.71111111,.95852252],[.56296296,.57616108],[.55555555,.974236],[.4074074,.59187456],[.94074074,.07332959],[.78518518,.08904307],[.25925925,.06809176],[.17777777,.91138207],[.17037037,1.309457],[.02222222,.92709555],[.73333333,1.03708994],[.57777777,1.05280342],[.4074074,.02618914],[.96296296,.15189701],[.95555555,.54997194],[.8074074,.16761049],[.34814814,1.37231093],[.8,.56568542],[.19259259,1.38802442],[.64444444,.5813989],[.73333333,.47140452],[.03703703,1.4037379],[.72592592,.86947944],[.57777777,.487118],[.57037037,.88519293],[.42222222,.50283148],[.41481481,.90090641],[.26666666,.51854497],[.97037037,1.02661428],[.8,0],[.64444444,.01571348],[.03703703,.83805248],[.02962962,1.23612741],[.59259259,.96376035],[.58518518,1.36183528],[.43703703,.97947383],[.42962962,1.37754876],[.97037037,.46092886],[.82222222,.07856742],[.27407407,1.39326225],[.81481481,.47664234],[.2074074,1.29898134],[.65925925,.49235583],[.05185185,1.31469483],[.65185185,.89043076],[.5037037,.50806931],[.59259259,.39807492],[.58518518,.79614985],[.43703703,.41378841],[.42962962,.81186334],[.28148148,.42950189],[.88148148,.00523782],[.27407407,.82757682],[.11851851,.8432903],[.82962962,.95328469],[.65185185,.32474533],[.44444444,1.28850569],[.29629629,.90614424],[.28888888,1.30421917],[.82962962,.38759927],[.13333333,1.31993265],[.67407407,.40331275],[.06666666,1.22565175],[.66666666,.80138768],[.51851851,.41902624],[.51111111,.81710116],[.36296296,.43473972],[.35555555,.83281465],[.99259259,1.38802442],[.29629629,.34045882],[.28888888,.73853374],[.13333333,.75424723],[.12592592,1.15232216],[.68148148,1.27803003],[.51111111,.25141574],[.35555555,.26712922],[.91111111,.3928371],[.3037037,1.21517609],[.14814814,1.23088958],[.68148148,.7123446],[.53333333,.32998316],[.52592592,.72805809],[.37777777,.34569664],[.37037037,.74377157],[.22222222,.36141013],[.21481481,.75948506],[.14814814,.66520415],[.14074074,1.06327908],[.54074074,1.20470044],[.37037037,.17808615],[.21481481,.19379963],[.92592592,.30379402],[.77037037,.3195075],[.16296296,1.1418465],[.61481481,.33522099],[.0074074,1.15755998],[.54074074,.63901501],[.39259259,.25665357],[.93333333,1.31993265],[.38518518,.6547285],[.23703703,.27236705],[.22962962,.67044198],[.08148148,.28808054],[.07407407,.68615546],[.0074074,.59187456],[0,.98994949],[.93333333,.75424723],[.4,1.13137084],[.22962962,.10475656],[.07407407,.12047004],[.62962962,.24617791],[.47407407,.2618914],[.94814814,1.23088958],[.4,.56568542],[.25185185,.18332398],[.79259259,1.24660306],[.24444444,.5813989],[.09629629,.19903746],[.08888888,.59711239],[.31111111,.10999438],[.94814814,.66520415],[.79259259,.68091764],[.25925925,1.05804125],[.11111111,.67567981],[.08888888,.03142696],[.78518518,1.07899256],[.1037037,1.07375474],[.48888888,.17284832],[.48148148,.57092325],[.33333333,.1885618],[.32592592,.58663673],[.96296296,1.1418465],[.8074074,1.15755998],[.25925925,.49235583],[.11111111,.10999438],[.1037037,.50806931],[.48148148,.00523782],[.32592592,.02095131],[.17037037,.03666479],[.64444444,1.00566297],[.49629629,.48188017],[.34814814,.09951873],[.34074074,.49759366],[.19259259,.11523221],[.18518518,.51330714],[.82222222,1.06851691],[.43703703,1.4037379],[.88888888,.59711239],[.88148148,.99518732],[.5037037,.93233338],[.9037037,1.07375474],[.2074074,.02618914],[.2,.42426406],[.05185185,.04190262],[.04444444,.43997755],[.82962962,1.37754876],[.67407407,1.39326225],[.97777777,.20427529],[.51851851,1.40897573],[.9037037,.50806931],[.89629629,.90614424],[.74814814,.5237828],[.74074074,.92185772],[.44444444,.01571348],[.36296296,.85900379],[.35555555,1.25707872],[.91851851,.98471166],[.91111111,1.38278659],[.76296296,1.00042514],[.75555555,1.39850007],[.05925925,.35093447],[.99259259,.11523221],[.53333333,1.31993265],[.98518518,.51330714],[.37777777,1.33564614],[.91851851,.41902624],[.22222222,1.35135962],[.91111111,.81710116],[.76296296,.43473972],[.75555555,.83281465],[.6074074,.4504532],[.6,.84852813],[.45185185,.46616669],[.22222222,.7856742],[.21481481,1.18374912],[.92592592,1.29374351],[.77777777,.91138207],[.77037037,1.309457],[.62222222,.92709555],[.61481481,1.32517048],[.46666666,.94280904],[.45925925,1.34088397],[.39259259,1.24660306],[.84444444,.43997755],[.23703703,1.26231655],[.83703703,.83805248],[.68888888,.45569103],[.77777777,.34569664],[.08148148,1.27803003],[.62222222,.36141013],[.61481481,.75948506],[.46666666,.37712361],[.45925925,.77519854],[.83703703,.27236705],[.08148148,.7123446],[.15555555,.26712922],[.07407407,1.11041953],[.63703703,.83805248],[.62962962,1.23612741],[.47407407,1.25184089],[.31851851,1.26755437],[.85925925,.35093447],[.25185185,1.17327347],[.85185185,.7490094],[.7037037,.36664796],[.09629629,1.18898695],[.69629629,.76472288],[.54814814,.38236144],[.47407407,.68615546],[.31851851,.70186895],[.31111111,1.09994388],[.87407407,.82757682],[.86666666,1.22565175],[.69629629,.19903746],[.01481481,.19379963],[.48888888,1.16279781],[.33333333,1.1785113],[.87407407,.2618914],[.17777777,1.19422478],[.86666666,.65996632],[.71851851,.27760488],[.11111111,1.09994388],[.71111111,.67567981],[.56296296,.29331836],[.55555555,.69139329],[.4074074,.30903185],[.33333333,.61282587],[.32592592,1.0109008],[.17777777,.62853936],[.17037037,1.02661428],[.02222222,.64425284],[.73333333,.75424723],[.72592592,1.15232216],[.55555555,.12570787],[.95555555,.26712922],[.34814814,1.08946822],[.8,.28284271],[.19259259,1.1051817],[.73333333,.1885618],[.03703703,1.12089519],[.72592592,.58663673],[.57777777,.20427529],[.57037037,.60235022],[.42222222,.21998877],[.41481481,.6180637],[.26666666,.23570226],[.19259259,.53949628],[.18518518,.93757121],[.03703703,.55520976],[.02962962,.95328469],[.59259259,.68091764],[.58518518,1.07899256],[.41481481,.05237828],[.42962962,1.09470605],[.97037037,.17808615],[.81481481,.19379963],[.2074074,1.01613863],[.65925925,.20951312],[.05185185,1.03185211],[.65185185,.60758804],[.59259259,.11523221],[.58518518,.51330714],[.43703703,.1309457],[.97777777,1.19422478],[.42962962,.52902062],[.28148148,.14665918],[.27407407,.54473411],[.11851851,.56044759],[.05185185,.46616669],[.65185185,.04190262],[.04444444,.86424162],[.97777777,.62853936],[.44444444,1.00566297],[.29629629,.62330153],[.28888888,1.02137646],[.82962962,.10475656],[.67407407,.12047004],[.06666666,.94280904],[.66666666,.51854497],[.51851851,.13618352],[.05925925,1.34088397],[.51111111,.53425845],[.99259259,1.1051817],[.44444444,.43997755],[.29629629,.0576161],[.28888888,.45569103],[.13333333,.47140452],[.12592592,.86947944],[.3037037,.93233338],[.14814814,.94804686],[.14074074,1.34612179],[.68148148,.42950189],[.53333333,.04714045],[.52592592,.44521538],[.37777777,.06285393],[.37037037,.46092886],[.3037037,.36664796],[.14814814,.38236144],[.14074074,.78043637],[.46666666,1.36707311],[.92592592,.02095131],[.77037037,.03666479],[.68888888,.8799551],[.16296296,.85900379],[.15555555,1.25707872],[.0074074,.87471727],[0,1.2727922],[.54074074,.3561723],[.38518518,.37188578],[.22962962,.38759927],[.85925925,1.34088397],[.16296296,.29331836],[.7037037,1.35659745],[.15555555,.69139329],[.0074074,.30903185],[.54814814,1.37231093],[0,.70710678],[.93333333,.47140452],[.54814814,.80662551],[.01481481,1.18374912],[.94814814,.94804686],[.4,.28284271],[.94074074,1.34612179],[.24444444,.29855619],[.78518518,1.36183528],[.08888888,.31426968],[.87407407,1.25184089],[.71851851,1.26755437],[.56296296,1.28326786],[.01481481,.6180637],[.4074074,1.29898134],[.94814814,.38236144],[.94074074,.78043637],[.79259259,.39807492],[.25925925,.77519854],[.78518518,.79614985],[.4074074,.73329592],[.48148148,.28808054],[.96296296,.85900379],[.95555555,1.25707872],[.8074074,.87471727],[.25925925,.20951312],[.8,1.2727922],[.1037037,.2252266],[.64444444,1.28850569],[.73333333,1.1785113],[.57777777,1.19422478],[.42222222,1.20993827],[.26666666,1.22565175],[.8074074,.30903185],[.8,.70710678],[.64444444,.72282026],[.49629629,.19903746],[.26666666,.65996632],[.34074074,.21475094],[.97037037,1.16803564],[.82222222,.7856742],[.81481481,1.18374912],[.65925925,1.19946261],[.5037037,1.21517609],[.59259259,1.1051817],[.43703703,1.12089519],[.88888888,.31426968],[.28148148,1.13660867],[.88148148,.7123446],[.65925925,.63377718],[.65185185,1.03185211],[.5037037,.64949067],[.88148148,.14665918],[.2,.14142135],[.82962962,1.09470605],[.67407407,1.11041953],[.51851851,1.12613302],[.36296296,1.1418465],[.9037037,.2252266],[.29629629,1.0475656],[.89629629,.62330153],[.74814814,.24094008],[.74074074,.63901501],[.51851851,.56044759],[.51111111,.95852252],[.36296296,.57616108],[.35555555,.974236],[.91851851,.70186895],[.91111111,1.09994388],[.74074074,.07332959],[.05925925,.06809176],[.53333333,1.03708994],[.98518518,.23046443],[.37777777,1.05280342],[.91851851,.13618352],[.22222222,1.06851691],[.91111111,.53425845],[.76296296,.15189701],[.75555555,.54997194],[.6074074,.16761049],[.14814814,1.37231093],[.6,.56568542],[.45185185,.18332398],[.37777777,.487118],[.37037037,.88519293],[.22222222,.50283148],[.21481481,.90090641],[.92592592,1.0109008],[.77777777,.62853936],[.77037037,1.02661428],[.62222222,.64425284],[.6,0],[.61481481,1.04232777],[.54074074,1.34612179],[.39259259,.96376035],[.84444444,.15713484],[.38518518,1.36183528],[.23703703,.97947383],[.83703703,.55520976],[.77777777,.06285393],[.22962962,1.37754876],[.08148148,.99518732],[.77037037,.46092886],[.62222222,.07856742],[.07407407,1.39326225],[.61481481,.47664234],[.46666666,.0942809],[.0074074,1.29898134],[.45925925,.49235583],[.23703703,.41378841],[.22962962,.81186334],[.08148148,.42950189],[.07407407,.82757682],[.63703703,.55520976],[.62962962,.95328469],[.47407407,.96899818],[.85925925,.06809176],[.4,1.2727922],[.25185185,.89043076],[.85185185,.46616669],[.7037037,.08380524],[.24444444,1.28850569],[.09629629,.90614424],[.69629629,.48188017],[.08888888,1.30421917],[.62962962,.38759927],[.47407407,.40331275],[.31851851,.41902624],[.31111111,.81710116],[.94814814,1.37231093],[.79259259,1.38802442],[.09629629,.34045882],[.11111111,1.38278659],[.08888888,.73853374],[.48888888,.8799551],[.48148148,1.27803003],[.33333333,.89566858],[.32592592,1.29374351],[.86666666,.37712361],[.25925925,1.19946261],[.11111111,.81710116],[.71111111,.3928371],[.56296296,.01047565],[.1037037,1.21517609],[.55555555,.40855058],[.48888888,.31426968],[.48148148,.7123446],[.33333333,.32998316],[.32592592,.72805809],[.17777777,.34569664],[.17037037,.74377157],[.02222222,.36141013],[.49629629,1.18898695],[.34814814,.80662551],[.34074074,1.20470044],[.19259259,.82233899],[.18518518,1.22041392],[.72592592,.30379402],[.57037037,.3195075],[.41481481,.33522099],[.34814814,.24094008],[.88888888,1.30421917],[.34074074,.63901501],[.19259259,.25665357],[.18518518,.6547285],[.03703703,.27236705],[.02962962,.67044198],[.2074074,.73329592],[.2,1.13137084],[.05185185,.7490094],[.04444444,1.14708433],[.58518518,.23046443],[.97777777,.91138207],[.42962962,.24617791],[.27407407,.2618914],[.9037037,1.21517609],[.11851851,.27760488],[.2074074,.16761049],[.74814814,1.23088958],[.2,.56568542],[.05185185,.18332398],[.04444444,.5813989],[.97777777,.34569664],[.44444444,.72282026],[.06666666,.65996632],[.66666666,.23570226],[.05925925,1.05804125],[.99259259,.82233899],[.44444444,.15713484],[.98518518,1.22041392],[.28888888,.17284832],[.13333333,.1885618],[.91851851,1.12613302],[.12592592,.58663673],[.76296296,1.1418465],[.06666666,.0942809],[.6074074,1.15755998],[.05925925,.49235583],[.45185185,1.17327347],[.99259259,.25665357],[.98518518,.6547285],[.3037037,.64949067],[.12592592,.02095131],[.68148148,.14665918],[.45185185,.60758804],[.52592592,.16237266],[.3037037,.08380524],[.84444444,1.14708433],[.14814814,.09951873],[.68888888,1.16279781],[.14074074,.49759366],[.62222222,1.06851691],[.46666666,1.08423039],[.84444444,.5813989],[.83703703,.97947383],[.68888888,.59711239],[.16296296,.57616108],[.15555555,.974236],[.54074074,.07332959],[.38518518,.08904307],[.85925925,1.05804125],[.16296296,.01047565],[.7037037,1.07375474],[.15555555,.40855058],[.0074074,.02618914],[.54814814,1.08946822],[0,.42426406],[.93333333,.1885618],[.47407407,1.39326225],[.31851851,1.40897573],[.7037037,.50806931],[.69629629,.90614424],[.54814814,.5237828],[.01481481,.90090641],[.4,0],[.94074074,1.06327908],[.24444444,.01571348],[.87407407,.96899818],[.86666666,1.36707311],[.71851851,.98471166],[.71111111,1.38278659],[.56296296,1.00042514],[.01481481,.33522099],[.55555555,1.39850007],[.4074074,1.01613863],[.94814814,.09951873],[.94074074,.49759366],[.79259259,.11523221],[.33333333,1.31993265],[.78518518,.51330714],[.17777777,1.33564614],[.02222222,1.35135962],[.56296296,.43473972],[.55555555,.83281465],[.4074074,.4504532],[.96296296,.57616108],[.95555555,.974236],[.8074074,.59187456],[.8,.98994949],[.73333333,.89566858],[.72592592,1.29374351],[.57777777,.91138207],[.57037037,1.309457],[.42222222,.92709555],[.96296296,.01047565],[.41481481,1.32517048],[.26666666,.94280904],[.95555555,.40855058],[.8074074,.02618914],[.8,.42426406],[.19259259,1.24660306],[.64444444,.43997755],[.03703703,1.26231655],[.59259259,1.38802442],[.42222222,.36141013],[.41481481,.75948506],[.26666666,.37712361],[.97037037,.88519293],[.82222222,.50283148],[.81481481,.90090641],[.65925925,.9166199],[.65185185,1.31469483],[.59259259,.82233899],[.58518518,1.22041392],[.43703703,.83805248],[.88888888,.03142696],[.42962962,1.23612741],[.28148148,.85376596],[.88148148,.42950189],[.27407407,1.25184089],[.81481481,.33522099],[.11851851,1.26755437],[.65925925,.35093447],[.05185185,1.17327347],[.65185185,.7490094],[.5037037,.36664796],[.97777777,1.33564614],[.28148148,.28808054],[.29629629,1.33040831],[.11851851,.70186895],[.82962962,.81186334],[.67407407,.82757682],[.66666666,1.22565175],[.51851851,.8432903],[.51111111,1.24136523],[.44444444,1.14708433],[.29629629,.76472288],[.89629629,.34045882],[.28888888,1.16279781],[.74074074,.3561723],[.13333333,1.1785113],[.67407407,.2618914],[.66666666,.65996632],[.51851851,.27760488],[.51111111,.67567981],[.36296296,.29331836],[.35555555,.69139329],[.68148148,1.13660867],[.53333333,.75424723],[.52592592,1.15232216],[.37777777,.76996071],[.37037037,1.16803564],[.91111111,.25141574],[.3037037,1.07375474],[.75555555,.26712922],[.14814814,1.08946822],[.6,.28284271],[.53333333,.1885618],[.52592592,.58663673],[.37777777,.20427529],[.37037037,.60235022],[.22222222,.21998877],[.21481481,.6180637],[.92592592,.72805809],[.77037037,.74377157],[.54074074,1.06327908],[.39259259,.68091764]],kn=new zu;let sl=new xx(Sx,Ex),wx=sl.getSurface();kn.add(wx);let dh=new ts;kn.add(dh);for(let i=0;i<_u.length;i++){let t=sl.fromTauCoords(_u[i]);dh.add(sl.getPoint(t,_x.dark,.025))}let ke=new ox(16777215);ke.position.set(2,6,0);ke.angle=Math.PI/2;ke.decay=0;ke.penumbra=1;ke.distance=0;ke.intensity=5;ke.radius=.5;ke.shadow.mapSize.width=512;ke.shadow.mapSize.height=512;ke.shadow.camera.near=.1;ke.shadow.camera.far=10;ke.shadow.focus=1;ke.castShadow=!0;kn.add(ke);const aa=ke.target;aa.position.x=1;aa.position.y=0;aa.position.z=.05;kn.add(aa);const ph=new Ae(new ys(100,.1,100),new Hu({color:16777215,clearcoat:1,roughness:.5,metalness:0}));ph.position.set(-1,-4,-1);kn.add(ph);const Xs=new fh;Xs.bottomColor.set(16777215);Xs.bottomColor.set(6710886);Xs.update();kn.environment=Xs;kn.background=Xs;const Mi=new Le;Mi.position.set(.1,10,-.1);Mi.lookAt(0,0,0);let bi=new Qg({preserveDrawingBuffer:!0});bi.toneMapping=yu;document.body.appendChild(bi.domElement);let Ti=new ax(bi);Ti.setScene(kn,Mi);Ti.renderScale=Math.max(1/window.devicePixelRatio,.5);Ti.tiles.setScalar(3);Ti.bounces=30;function Ax(i){const t=new Date;let e=t.getDate(),n=t.getMonth()+1,s=t.getHours(),r=t.getMinutes(),a=document.createElement("a");a.download=`pathtrace ${n}-${e}-${s}${r}.png`,a.href=i.toDataURL("image/png"),a.click()}const Rx=new Sl().close();let Cx={saveit:()=>Ax(bi.domElement)};Rx.add(Cx,"saveit");let Tl=new e_(Mi,bi.domElement);Tl.target.set(0,.33,-.08);Tl.addEventListener("change",()=>Ti.updateCamera());Tl.update();gh();mh();window.addEventListener("resize",gh);function mh(){requestAnimationFrame(mh),Ti.renderSample()}function gh(){const i=window.innerWidth,t=window.innerHeight;bi.setSize(i,t),bi.setPixelRatio(window.devicePixelRatio);const e=i/t;Mi.aspect=e,Mi.updateProjectionMatrix(),Ti.setScene(kn,Mi)}
