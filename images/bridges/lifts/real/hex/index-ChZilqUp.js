...
`;class qv extends Ml{constructor(){super({blending:Ke,uniforms:{resolution:{value:new ut}},vertexShader:`
...
`;class Qx extends Ml{onBeforeRender(){this.setDefine("FEATURE_DOF",this.physicalCamera.bokehSize===0?0:1),this.setDefine("FEATURE_BACKGROUND_MAP",this.backgroundMap?1:0),this.setDefine("FEATURE_FOG",this.materials.features.isUsed("FOG")?1:0)}constructor(t){super({transparent:!0,depthWrite:!1,defines:{FEATURE_MIS:1,FEATURE_RUSSIAN_ROULETTE:1,FEATURE_DOF:1,FEATURE_BACKGROUND_MAP:0,FEATURE_FOG:1,RANDOM_TYPE:2,CAMERA_TYPE:0,DEBUG_MODE:0,ATTR_NORMAL:0,ATTR_TANGENT:1,ATTR_UV:2,ATTR_COLOR:3},uniforms:{resolution:{value:new ut},opacity:{value:1},bounces:{value:10},transmissiveBounces:{value:10},filterGlossyFactor:{value:0},physicalCamera:{value:new jv},cameraWorldMatrix:{value:new Ut},invProjectionMatrix:{value:new Ut},bvh:{value:new mv},attributesArray:{value:new ox},materialIndexAttribute:{value:new sh},materials:{value:new dx},textures:{value:new ru().texture},lights:{value:new rx},iesProfiles:{value:new ru(360,180,{type:Fe,wrapS:Ne,wrapT:Ne}).texture},environmentIntensity:{value:1},environmentRotation:{value:new Ut},envMapInfo:{value:new Jv},backgroundBlur:{value:0},backgroundMap:{value:null},backgroundAlpha:{value:1},backgroundIntensity:{value:1},backgroundRotation:{value:new Ut},seed:{value:0},sobolTexture:{value:null},stratifiedTexture:{value:new Mx},stratifiedOffsetTexture:{value:new Ax(64,1)}},vertexShader:`
