...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ke,depthTest:!1,depthWrite:!1})}function fc(){return new un({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:dl(),fragmentShader:`
		...
		`,blending:Ke,depthTest:!1,depthWrite:!1})}function dc(){return new un({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:dl(),fragmentShader:`
...
`;class Xv extends yl{constructor(){super({blending:Ke,uniforms:{resolution:{value:new ct}},vertexShader:`
